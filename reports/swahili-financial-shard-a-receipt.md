...
- Outcome: **21 accepted candidate / 25 blocked / 46 denominator**.
...
| 13 | `crypto-mining` | `/crypto/mining-calculator` | `/sw/zana/kikokotoo-margin-uchimbaji-crypto` | ACCEPTED | `sw/zana/kikokotoo-margin-uchimbaji-crypto/index.html` |
...
- PASS 21/21 — `npx playwright test tests/e2e/swahili-financial-shard-a.spec.js --config=playwright.sw-financial-shard-a.config.js --project=chromium --workers=1`.
