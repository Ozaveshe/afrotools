...
| Education | 43 | `reports/fr-education-ssce-parity-2026-09-13.md` | `node scripts/audit-fr-education-parity.js`<br>`node --test tests/ssce-practice-french.test.js`<br>`playwright test tests/e2e/fr-education-category-parity.spec.js tests/e2e/ssce-practice-fr.spec.js --project=chromium --workers=1` |
