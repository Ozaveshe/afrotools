...
- `sitemap-fr.xml` contains all 3,240 indexable French routes, up from 3,095; 142 previously omitted public widget parent pages are now included, while technical French iframe utilities remain excluded. The two-part sitemap contract test passes.
