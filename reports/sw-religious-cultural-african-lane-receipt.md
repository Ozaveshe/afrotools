...
Baseline: `6edacda8437e1fa9b9e5a512138cbdd3169e38be`. Exact denominator: **32** (19 Religious & Cultural, 13 Uniquely African). Candidate accepted: **32**. Blocked: **0**. The coordinator acceptance ledger was not edited.
...
- `scripts/build-mobile-money-fee-finder.js`
