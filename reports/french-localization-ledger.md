...
- English-backed route-mapping completion: 27.19%
- French registry coverage: 78.28% of registry-eligible French tool/money/PDF routes (364/465)
- French registry entries: 379
- English-backed French routes: 1636
- French-only routes: 61
- Generated output routes: 1290
- Hand-authored French pages: 417
- Unclear source-of-truth routes: 26

## Coverage By Section

| Section | English source pages | French pages | Unique English mapped | Raw coverage | Mapped coverage | Registry coverage |
|---|---:|---:|---:|---:|---:|---:|
| tools | 2524 | 359 | 327 | 14.22% | 12.96% | 76.07% |
| cars | 1584 | 170 | 166 | 10.73% | 10.48% | 100% |
| agriculture | 645 | 636 | 636 | 98.6% | 98.6% | n/a |
| blog | 193 | 156 | 153 | 80.83% | 79.27% | 100% |
| salary-tax | 66 | 96 | 64 | 145.45% | 96.97% | 88.52% |
| vat-business-tax | 56 | 91 | 57 | 162.5% | 101.79% | 82.46% |
| document-pdf | 1 | 1 | 1 | 100% | 100% | 100% |
| widgets | 225 | 11 | 11 | 4.89% | 4.89% | n/a |
...
1. French pages with no English-backed source mapping (61)
...
2. Unclear source-of-truth French routes (26)
   - Recommendation: Assign each route to lang/pages generation, registry, or a hand-authored canonical owner.
   - Examples: /fr/tools/editeur-pdf, /fr/tools/espace-pdf, /fr/tools/francais-africain, /fr/tools/generateur-business-plan, /fr/tools/generateur-memes, /fr/tools/guide-diaspora, /fr/tools/montant-lettres-gh, /fr/tools/montant-lettres-ke
3. French registry-eligible pages missing from tool-registry.js (101)
   - Recommendation: Add or repoint registry entries only after route/source truth is settled.
   - Examples: /fr/djibouti/dj-vat, /fr/docs/api/vat, /fr/docs/api/vat/calculate, /fr/seychelles/sc-paye, /fr/seychelles/sc-vat, /fr/sierra-leone/sl-paye, /fr/sierra-leone/sl-vat, /fr/somalia/so-paye
...
5. English source pages without a mapped French route (4223)
...
6. Generated French outputs with weak registry discovery (34)
   - Recommendation: For generated tool pages, connect generation output to registry discovery in the same small batch.
   - Examples: /fr/djibouti/dj-vat, /fr/seychelles/sc-paye, /fr/seychelles/sc-vat, /fr/sierra-leone/sl-paye, /fr/sierra-leone/sl-vat, /fr/somalia/so-paye, /fr/somalia/so-vat, /fr/south-sudan/ss-paye
7. Hand-authored French pages that need owner confirmation (417)
...
8. tools mapped French coverage is below 30% (2197)
...
9. cars mapped French coverage is below 30% (1418)
...
10. salary-tax raw French count materially exceeds mapped coverage (32)
...
12. widgets mapped French coverage is below 30% (214)
...
- Registry-eligible French pages not represented in registry: 101
