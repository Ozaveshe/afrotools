...
| Market interpretation | Free text, recognized country aliases normalized | Same, with country suggestions | Same | The initial French restriction was a capability gap. Follow-up now uses the shared grouping contract and preserves free text; see `mobile-money-market-parity-2026-09-16.md` for 13 passing browser cases. |
