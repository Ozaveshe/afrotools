...
| Market interpretation | Free text, recognized country aliases normalized | African country-list validation | Free text, recognized country aliases normalized | Existing unresolved capability difference, not identical capability; no documented product intent waives this parity gap. French rejects unknown market names; EN/SW retain them. No new restriction introduced. |
