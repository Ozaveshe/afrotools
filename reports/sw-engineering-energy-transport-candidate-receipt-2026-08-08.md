...
Accepted Engineering IDs: `solar-calculator`, `floor-plan`, `boq-generator`, `structural-calc`, `electrical-load`, `concrete-calc`, `paint-calc`, `tiles-calc`, `water-tank`, `rebar-calc`.

Blocked Engineering IDs: `afrodraft`, `afroplan-floor-planner`, `roofing-calc`, `borehole-cost`, `generator-sizing`, `boq-gen`, `home-renovation-cost`, `fence-cost`, `swimming-pool-cost`, `architectural-fee`.
