...
Accepted Engineering IDs: `solar-calculator`, `floor-plan`, `boq-generator`, `concrete-calc`, `tiles-calc`, `water-tank`, `rebar-calc`.

Blocked Engineering IDs: `afrodraft`, `afroplan-floor-planner`, `structural-calc`, `electrical-load`, `paint-calc`, `roofing-calc`, `borehole-cost`, `generator-sizing`, `boq-gen`, `home-renovation-cost`, `fence-cost`, `swimming-pool-cost`, `architectural-fee`.
