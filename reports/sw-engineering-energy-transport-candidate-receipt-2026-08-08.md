...
Accepted Engineering IDs: `solar-calculator`, `floor-plan`, `boq-generator`, `structural-calc`, `electrical-load`, `concrete-calc`, `paint-calc`, `tiles-calc`, `water-tank`, `roofing-calc`, `borehole-cost`, `rebar-calc`, `generator-sizing`, `boq-gen`, `home-renovation-cost`, `fence-cost`, `swimming-pool-cost`.

Blocked Engineering IDs: `afrodraft`, `afroplan-floor-planner`, `architectural-fee`.
