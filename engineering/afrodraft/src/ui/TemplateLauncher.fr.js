  ...
  overlay.innerHTML = `
    <div class="modal template-modal" role="dialog" aria-modal="true" aria-labelledby="template-modal-title">
      <div class="modal-header">
        <span class="modal-title" id="template-modal-title">Informations et hypothèses du calcul</span>
      ...
      <div class="modal-footer">
        <button class="modal-btn" id="template-modal-cancel" type="button">Annuler</button>
      </div>
    </div>
  `;
...
function installSidebarSection(app) {
  ...
  section.innerHTML = `
    <summary><span class="workspace-section__title">Informations et hypothèses du calcul</span><span class="workspace-section__chevron">v</span></summary>
    <div class="workspace-section__body">
      <button class="workspace-flow-card" data-action="template-library" type="button">
        <span class="workspace-flow-card__eyebrow">Informations et hypothèses du calcul</span>
        <strong>Boutique</strong>
        <span class="workspace-flow-card__copy">Charger</span>
      </button>
    </div>
  `;
