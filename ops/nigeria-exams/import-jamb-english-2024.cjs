...
// Replays eight owner-directed, short adapted revision items. Myschool's year
...
const manifestPath = 'ops/nigeria-exams/jamb-english-2024-curated.json';
const batchPath = 'ops/jamb/verification/english-2024-publishable-902.json';
const checkerPath = 'ops/jamb/verification/check-english-2024-902.cjs';
const reviewedAt = '2026-09-24';
const expectedItems = [1, 4, 5, 6, 7, 8, 11, 57];
...
function main() {
  ...
  console.log(JSON.stringify({ imported: result.batch.records.length, held: 6,
