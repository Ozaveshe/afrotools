...
const manifestPath = 'ops/nigeria-exams/jamb-english-2025-curated-batch-02.json';
const batchPath = 'ops/jamb/verification/english-2025-publishable-002.json';
const checkerPath = 'ops/jamb/verification/check-english-2025-002.cjs';
const reviewedAt = '2026-09-25';
const expectedItems = [196, 200, 205, 209, 210, 211, 212, 216, 217, 218, 219];
const auditedItems = Array.from({ length: 25 }, (_, i) => i + 196);
