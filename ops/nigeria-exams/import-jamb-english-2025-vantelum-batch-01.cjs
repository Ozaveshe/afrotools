...
const manifestPath = 'ops/nigeria-exams/jamb-english-2025-vantelum-batch-01.json';
const batchPath = 'ops/jamb/verification/english-2025-publishable-005.json';
const checkerPath = 'ops/jamb/verification/check-english-2025-005.cjs';
const reviewedAt = '2026-09-26';
const expectedItems = [3, 7, 10, 11, 12, 13, 14, 15, 18, 20, 22, 24, 25, 26, 30];
