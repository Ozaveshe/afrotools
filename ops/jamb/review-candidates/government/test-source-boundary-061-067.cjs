...
for(const id of ['061','062','063','064','065','066','067']){const original=local('./batch-'+id+'.json');for(const mutation of ['number','source','import','year',...original.counts.candidates?['options']:[]]){
...
console.log(fixtures+' fully rehashed 061-067 source/number/year/import/options mutations rejected');
