...
for(const id of ['057','058','059','060']){const original=local('./batch-'+id+'.json');for(const mutation of ['number','source','import','year',...original.counts.candidates?['options']:[]]){
...
console.log(fixtures+' fully rehashed 057-060 source/number/year/import/options mutations rejected');
