...
for(const id of ['053','054','055','056']){const original=local('./batch-'+id+'.json');for(const mutation of ['number','source','import','year',...original.counts.candidates?['options']:[]]){
...
console.log(fixtures+' fully rehashed 053-056 source/number/year/import/options mutations rejected, including the all-held batch');
