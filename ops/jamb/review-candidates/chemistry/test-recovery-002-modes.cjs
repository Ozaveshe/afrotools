...
const file=path.join(__dirname,'check-recovery-002.cjs'),local=mod.createRequire(file),batch=local('./recovery-002.json');
...
console.log('Recovery002 mode tests: local and portable integration pass; absent pre-intake PDF, wrong PDF and unauthorized held mutation correctly rejected.');
