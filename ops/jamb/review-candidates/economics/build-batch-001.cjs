...
const records=selected.map(original=>{
 ...
 const q={...original,options:{...original.options},answer:a[0],explanation:a[1],ai_explanation:a[1],has_diagram:false};
 ...
 q.verification={method:'ai-source-checked',reviewed_at:'2026-09-12'};delete q.verification_method;delete q.verified_at;q.format=Object.keys(q.options).length;r.candidate=q;r.content_sha256=questionFingerprint(q);
