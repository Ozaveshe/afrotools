...
const { manifestPath, batchPath } = require('../../nigeria-exams/import-jamb-english-2025-batch-03.cjs');
...
const expectedAnswerText = {
  ...
  74839: 'antagonist',
  74840: 'impermeable',
  74841: 'It is not convincing',
  74843: 'Keep trying',
  74844: 'Spent less money',
  74846: 'Made her plan harder to carry out',
  74847: 'The supervisor makes them work very hard',
  74850: 'food',
  74851: 'love',
  74852: 'serious',
  74854: 'chain',
...
function verify(manifest, manifestHash, pool, ledger, batch) {
  ...
  assert.equal(manifest.records.length + manifest.held_source_items.length, 25);
  const checked = [];
