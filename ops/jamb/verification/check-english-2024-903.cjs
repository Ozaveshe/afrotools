...
const { manifestPath, batchPath } = require('../../nigeria-exams/import-jamb-english-2024-batch-02.cjs');

// Selected by independently checking the novel, dictionary, and grammar;
// never derived from the publisher's answer letter or from the import manifest.
const expectedAnswerText = {
  69892: 'Speaker',
  69894: 'The mix of roommates',
  69898: '₦100,000',
  69901: 'Meddlesome',
  69942: 'Imagining an unlikely success',
  69947: 'Argue the less popular side to test an idea',
  69952: 'Person everyone notices',
  69953: 'Postponed',
  69954: 'Innocent',
  69955: 'Poor',
  69956: 'Authentic',
  69960: 'Tidy',
  69966: 'Leaves it to her in a will',
  69968: 'Fruitless',
  69969: 'Completely absorbed',
  69973: 'would have been',
  69974: 'up',
  69979: 'who'
};
...
function verify(manifest, manifestHash, pool, ledger, batch) {
  ...
  assert.equal(manifest.records.length + manifest.held_source_items.length, 44);
  const checked = [];
