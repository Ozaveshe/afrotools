...
- **1,255/1,255 canonical English free apps have accepted native French owners.**
...
1,255-row owner result remains in `reports/french-free-app-parity-inventory.*`.
...
|---|---:|---|
| Canonical published English rows | 1,257 | Current canonical English app inventory |
