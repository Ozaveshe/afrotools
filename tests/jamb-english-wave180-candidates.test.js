...
const batch=require('../ops/jamb/review-candidates/english/english-1980-005.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1980-005.cjs');
...
test('wave180 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave180 intake preserves candidates and held records at either integration stage',()=>{
