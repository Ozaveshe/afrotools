...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-2014-002.cjs');
...
test('wave11 intake preserves candidates and held records at either integration stage',()=>{
 assert.equal(verify(before).candidates,20);
 assert.equal(verify(after,true).held,20);
