...
const batch=require('../ops/jamb/review-candidates/english/english-1982-004.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1982-004.cjs');
...
test('wave155 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave155 intake preserves candidates and held records at either integration stage',()=>{
