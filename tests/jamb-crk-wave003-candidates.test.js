...
const batch=require('../ops/jamb/review-candidates/crk/crk-wave003.json');
const {verify}=require('../ops/jamb/review-candidates/crk/check-crk-wave003.cjs');
...
test('crk wave003 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('crk wave003 intake preserves candidates and held records at either integration stage',()=>{
