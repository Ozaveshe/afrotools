...
const batch=require('../ops/jamb/review-candidates/english/english-1985-004.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1985-004.cjs');
...
test('wave143 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave143 intake preserves candidates and held records at either integration stage',()=>{
