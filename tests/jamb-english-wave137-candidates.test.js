...
const batch=require('../ops/jamb/review-candidates/english/english-1986-010.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1986-010.cjs');
...
test('wave137 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave137 intake preserves candidates and held records at either integration stage',()=>{
