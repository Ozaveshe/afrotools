...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1995-002.cjs');
...
test('wave66 intake preserves candidates and held records at either integration stage',()=>{
