...
const batch=require('../ops/jamb/review-candidates/english/english-1986-004.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1986-004.cjs');
...
test('wave131 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave131 intake preserves candidates and held records at either integration stage',()=>{
