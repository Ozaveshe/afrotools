...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1998-007.cjs');
...
test('wave57 intake preserves candidates and held records at either integration stage',()=>{
