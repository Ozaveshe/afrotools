...
const batch=require('../ops/jamb/review-candidates/english/english-1985-002.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1985-002.cjs');
...
test('wave141 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave141 intake preserves candidates and held records at either integration stage',()=>{
