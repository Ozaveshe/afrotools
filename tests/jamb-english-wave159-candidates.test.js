...
const batch=require('../ops/jamb/review-candidates/english/english-1982-008.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1982-008.cjs');
...
test('wave159 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave159 intake preserves candidates and held records at either integration stage',()=>{
