...
const { prepareBatch } = require('../ops/nigeria-exams/import-jamb-english-2025-batch-01.cjs');
const { verify } = require('../ops/jamb/verification/check-english-2025-001.cjs');
...
test('independent answer checker agrees with source-linked review and catches an altered answer', () => {
  ...
  const question = changed.questions.find(row => row.id === 'english-2025-myschool-74809');
  question.answer = 'C';
