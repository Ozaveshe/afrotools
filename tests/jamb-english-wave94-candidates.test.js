...
const batch=require('../ops/jamb/review-candidates/english/english-1991-006.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1991-006.cjs');
...
test('wave94 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave94 intake preserves candidates and held records at either integration stage',()=>{
