...
const batch=require('../ops/jamb/review-candidates/crk/crk-wave002.json');
const {verify}=require('../ops/jamb/review-candidates/crk/check-crk-wave002.cjs');
...
test('crk wave002 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('crk wave002 intake preserves candidates and held records at either integration stage',()=>{
