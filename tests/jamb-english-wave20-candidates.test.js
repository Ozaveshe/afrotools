...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-2009-002.cjs');
...
test('wave20 intake preserves candidates and held records at either integration stage',()=>{
 assert.equal(verify(before).candidates,22);
