...
test('quality report is deterministic for an explicit as-of date', function () {
  ...
  const planningIds = ['formula-engines-morocco-paye', 'formula-engines-tunisia-paye', 'formula-assets-js-engines-ci-birth-leave', 'formula-assets-js-engines-senegal-child-leave'];
  ...
  assert.strictEqual(first.reviewBacklog.highRiskSources, planningIds.length, 'only the explicitly documented PAYE, CI birth-permission and Senegal annual-leave source uncertainties remain');
