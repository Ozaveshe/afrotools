...
const batch=require('../ops/jamb/review-candidates/english/english-1991-001.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1991-001.cjs');
...
test('wave89 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave89 intake preserves candidates and held records at either integration stage',()=>{
