...
const batch=require('../ops/jamb/review-candidates/english/english-1988-007.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1988-007.cjs');
...
test('wave115 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave115 intake preserves candidates and held records at either integration stage',()=>{
