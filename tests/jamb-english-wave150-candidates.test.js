...
const batch=require('../ops/jamb/review-candidates/english/english-1984-005.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1984-005.cjs');
...
test('wave150 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave150 intake preserves candidates and held records at either integration stage',()=>{
