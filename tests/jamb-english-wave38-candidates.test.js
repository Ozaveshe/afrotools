...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-2002-004.cjs');
...
test('wave38 intake preserves candidates and held records at either integration stage',()=>{
