...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1999-004.cjs');
...
test('wave48 intake preserves candidates and held records at either integration stage',()=>{
