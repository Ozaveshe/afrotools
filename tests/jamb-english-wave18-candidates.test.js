...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-2010-001.cjs');
...
test('wave18 intake preserves candidates and held records at either integration stage',()=>{
