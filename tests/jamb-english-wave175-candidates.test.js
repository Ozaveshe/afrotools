...
const batch=require('../ops/jamb/review-candidates/english/english-1981-006.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1981-006.cjs');
...
test('wave175 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave175 intake preserves candidates and held records at either integration stage',()=>{
