...
const fixture={fn:'Élodie',ln:'François Łukasz',title:'Ingénieure — Mhandisi',email:'synthetic@example.test',phoneCode:'+254',phone:'700000000',altPhone:'+250 700000001',loc:'Nairobi — Kigali',linkedin:'https://example.test/linkedin',github:'https://example.test/github',web:'https://example.test/website',portfolio:'https://example.test/portfolio',summary:'Évaluation des systèmes. Ujuzi wa mawasiliano.',exps:[{t:'Ingénieure',c:'Exemple',s:'2023',cur:true,d:'Amélioration vérifiée.'}],edus:[{deg:'Maîtrise',sch:'Université Exemple',y1:'2018',y2:'2020',d:'Étude des systèmes durables.'}],skills:{h:'Évaluation',s:'Uongozi',t:'SQL'},projs:[{n:'Projet Énergie',d:'Conception vérifiée.'}],certs:[{n:'Qualité',i:'Institut Exemple',y:'2025'}],langs:[{l:'Kiswahili',lv:'Fasaha'}],refs:[{n:'Asha Mwang’ombe',t:'Responsable',org:'Exemple',e:'ref@example.test',p:'+254 700000002',rel:'Ancienne responsable'}],showProjs:true,showRefs:true};
...
for(const [lang,headings]of [['en',['Summary','Experience','Education','References','Present']],['fr',['Profil','Expérience','Formation','Références','En cours']],['sw',['Muhtasari','Uzoefu','Elimu','Wadhamini','Sasa']]])test('DOCX preserves all supplied fields and native copy: '+lang,async()=>{
