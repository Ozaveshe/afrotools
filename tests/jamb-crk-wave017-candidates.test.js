...
const batch=require('../ops/jamb/review-candidates/crk/crk-wave017.json');
const {verify}=require('../ops/jamb/review-candidates/crk/check-crk-wave017.cjs');
...
test('crk wave017 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('crk wave017 intake preserves candidates and held records at either integration stage',()=>{
