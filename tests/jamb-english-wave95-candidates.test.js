...
const batch=require('../ops/jamb/review-candidates/english/english-1991-007.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1991-007.cjs');
...
test('wave95 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave95 intake preserves candidates and held records at either integration stage',()=>{
