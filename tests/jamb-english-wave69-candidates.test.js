...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1995-005.cjs');
...
test('wave69 intake preserves candidates and held records at either integration stage',()=>{
