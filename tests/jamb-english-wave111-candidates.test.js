...
const batch=require('../ops/jamb/review-candidates/english/english-1988-003.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1988-003.cjs');
...
test('wave111 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave111 intake preserves candidates and held records at either integration stage',()=>{
