...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-2003-003.cjs');
...
test('wave34 intake preserves candidates and held records at either integration stage',()=>{
