...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-2015-002.cjs');
...
test('wave7 intake preserves candidates and held records at either integration stage',()=>{
