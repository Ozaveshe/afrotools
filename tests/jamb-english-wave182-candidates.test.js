...
const batch=require('../ops/jamb/review-candidates/english/english-1979-001.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1979-001.cjs');
...
test('wave182 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave182 intake preserves candidates and held records at either integration stage',()=>{
