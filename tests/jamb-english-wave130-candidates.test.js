...
const batch=require('../ops/jamb/review-candidates/english/english-1986-003.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1986-003.cjs');
...
test('wave130 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave130 intake preserves candidates and held records at either integration stage',()=>{
