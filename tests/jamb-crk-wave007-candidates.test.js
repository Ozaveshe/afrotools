...
const batch=require('../ops/jamb/review-candidates/crk/crk-wave007.json');
const {verify}=require('../ops/jamb/review-candidates/crk/check-crk-wave007.cjs');
...
test('crk wave007 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('crk wave007 intake preserves candidates and held records at either integration stage',()=>{
