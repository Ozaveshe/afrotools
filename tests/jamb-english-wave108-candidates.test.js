...
const batch=require('../ops/jamb/review-candidates/english/english-1989-004.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1989-004.cjs');
...
test('wave108 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave108 intake preserves candidates and held records at either integration stage',()=>{
