...
const batch=require('../ops/jamb/review-candidates/english/english-1991-004.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1991-004.cjs');
...
test('wave92 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave92 intake preserves candidates and held records at either integration stage',()=>{
