...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-2001-001.cjs');
...
test('wave39 intake preserves candidates and held records at either integration stage',()=>{
