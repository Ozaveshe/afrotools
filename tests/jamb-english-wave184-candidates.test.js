...
const batch=require('../ops/jamb/review-candidates/english/english-1979-003.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1979-003.cjs');
...
test('wave184 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave184 intake preserves candidates and held records at either integration stage',()=>{
