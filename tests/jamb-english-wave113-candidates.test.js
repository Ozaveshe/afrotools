...
const batch=require('../ops/jamb/review-candidates/english/english-1988-005.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1988-005.cjs');
...
test('wave113 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave113 intake preserves candidates and held records at either integration stage',()=>{
