...
const batch=require('../ops/jamb/review-candidates/english/english-1981-002.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1981-002.cjs');
...
test('wave171 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave171 intake preserves candidates and held records at either integration stage',()=>{
