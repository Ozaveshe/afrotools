...
const batch=require('../ops/jamb/review-candidates/english/english-1982-015.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1982-015.cjs');
...
test('wave166 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave166 intake preserves candidates and held records at either integration stage',()=>{
