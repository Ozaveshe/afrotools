...
const batch=require('../ops/jamb/review-candidates/english/english-1988-012.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1988-012.cjs');
...
test('wave120 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave120 intake preserves candidates and held records at either integration stage',()=>{
