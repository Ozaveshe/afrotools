...
assert.strictEqual(inventory.rows.length, 1255);
...
console.log('Swahili Fintech payment allocation: authoritative 1,255-row free-app inventory and 2/2 accepted route contracts passed');
