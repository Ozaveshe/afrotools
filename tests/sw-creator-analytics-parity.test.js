...
assert.match(swApp, /hreflang="en" href="https:\/\/afrotools\.com\/tools\/creator-analytics\/app"/i);
assert.match(swApp, /hreflang="fr" href="https:\/\/afrotools\.com\/fr\/tools\/stats-createur\/app"/i);
assert.match(swApp, /hreflang="sw" href="https:\/\/afrotools\.com\/sw\/zana\/takwimu-za-mtayarishi\/app"/i);
assert.match(enApp, /hreflang="sw" href="https:\/\/afrotools\.com\/sw\/zana\/takwimu-za-mtayarishi\/app"/i);
assert.match(frApp, /hreflang="sw" href="https:\/\/afrotools\.com\/sw\/zana\/takwimu-za-mtayarishi\/app"/i);
