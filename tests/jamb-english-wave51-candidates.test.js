...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1998-001.cjs');
...
test('wave51 intake preserves candidates and held records at either integration stage',()=>{
