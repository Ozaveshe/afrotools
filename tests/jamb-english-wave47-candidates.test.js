...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1999-003.cjs');
...
test('wave47 intake preserves candidates and held records at either integration stage',()=>{
