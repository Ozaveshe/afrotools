...
const batch=require('../ops/jamb/review-candidates/crk/crk-wave021.json');
const {verify}=require('../ops/jamb/review-candidates/crk/check-crk-wave021.cjs');
...
test('crk wave021 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('crk wave021 intake preserves candidates and held records at either integration stage',()=>{
