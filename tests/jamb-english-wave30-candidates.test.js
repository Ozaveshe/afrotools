...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-2004-007.cjs');
...
test('wave30 intake preserves candidates and held records at either integration stage',()=>{
