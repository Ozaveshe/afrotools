...
const batch=require('../ops/jamb/review-candidates/crk/crk-wave005.json');
const {verify}=require('../ops/jamb/review-candidates/crk/check-crk-wave005.cjs');
...
test('crk wave005 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('crk wave005 intake preserves candidates and held records at either integration stage',()=>{
