...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1995-001.cjs');
...
test('wave65 intake preserves candidates and held records at either integration stage',()=>{
