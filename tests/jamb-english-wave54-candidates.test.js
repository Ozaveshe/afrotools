...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1998-004.cjs');
...
test('wave54 intake preserves candidates and held records at either integration stage',()=>{
