...
const batch=require('../ops/jamb/review-candidates/english/english-1987-006.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1987-006.cjs');
...
test('wave127 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave127 intake preserves candidates and held records at either integration stage',()=>{
