...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1994-002.cjs');
...
test('wave72 intake preserves candidates and held records at either integration stage',()=>{
