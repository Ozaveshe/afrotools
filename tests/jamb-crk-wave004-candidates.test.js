...
const batch=require('../ops/jamb/review-candidates/crk/crk-wave004.json');
const {verify}=require('../ops/jamb/review-candidates/crk/check-crk-wave004.cjs');
...
test('crk wave004 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('crk wave004 intake preserves candidates and held records at either integration stage',()=>{
