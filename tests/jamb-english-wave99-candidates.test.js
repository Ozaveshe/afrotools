...
const batch=require('../ops/jamb/review-candidates/english/english-1990-002.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1990-002.cjs');
...
test('wave99 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave99 intake preserves candidates and held records at either integration stage',()=>{
