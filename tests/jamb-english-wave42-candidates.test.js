...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-2000-001.cjs');
...
test('wave42 intake preserves candidates and held records at either integration stage',()=>{
