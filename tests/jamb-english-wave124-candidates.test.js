...
const batch=require('../ops/jamb/review-candidates/english/english-1987-003.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1987-003.cjs');
...
test('wave124 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave124 intake preserves candidates and held records at either integration stage',()=>{
