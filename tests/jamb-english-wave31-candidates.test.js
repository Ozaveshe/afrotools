...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-2004-008.cjs');
...
test('wave31 intake preserves candidates and held records at either integration stage',()=>{
