...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1985-003.cjs');
...
test('wave142 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave142 intake preserves candidates and held records at either integration stage',()=>{
