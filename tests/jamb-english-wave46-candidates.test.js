...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1999-002.cjs');
...
test('wave46 intake preserves candidates and held records at either integration stage',()=>{
