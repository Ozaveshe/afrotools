...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-2007-001.cjs');
...
test('wave23 intake preserves candidates and held records at either integration stage',()=>{
