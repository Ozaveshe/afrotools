...
const batch=require('../ops/jamb/review-candidates/english/english-1982-018.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1982-018.cjs');
...
test('wave169 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave169 intake preserves candidates and held records at either integration stage',()=>{
