...
const batch=require('../ops/jamb/review-candidates/english/english-1982-002.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1982-002.cjs');
...
test('wave153 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave153 intake preserves candidates and held records at either integration stage',()=>{
