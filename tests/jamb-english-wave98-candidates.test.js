...
const batch=require('../ops/jamb/review-candidates/english/english-1990-001.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1990-001.cjs');
...
test('wave98 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave98 intake preserves candidates and held records at either integration stage',()=>{
