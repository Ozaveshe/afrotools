...
const batch=require('../ops/jamb/review-candidates/english/english-1982-012.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1982-012.cjs');
...
test('wave163 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave163 intake preserves candidates and held records at either integration stage',()=>{
