...
const batch=require('../ops/jamb/review-candidates/english/english-1986-009.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1986-009.cjs');
...
test('wave136 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave136 intake preserves candidates and held records at either integration stage',()=>{
