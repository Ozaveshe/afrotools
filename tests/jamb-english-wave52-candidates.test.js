...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1998-002.cjs');
...
test('wave52 intake preserves candidates and held records at either integration stage',()=>{
