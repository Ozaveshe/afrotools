...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1992-006.cjs');
...
test('wave81 intake preserves candidates and held records at either integration stage',()=>{
