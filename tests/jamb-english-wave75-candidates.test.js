...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1993-002.cjs');
...
test('wave75 intake preserves candidates and held records at either integration stage',()=>{
