...
const batch=require('../ops/jamb/review-candidates/english/english-1988-010.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1988-010.cjs');
...
test('wave118 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave118 intake preserves candidates and held records at either integration stage',()=>{
