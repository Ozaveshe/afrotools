...
const batch=require('../ops/jamb/review-candidates/crk/crk-wave026.json');
const {verify}=require('../ops/jamb/review-candidates/crk/check-crk-wave026.cjs');
...
test('crk wave026 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('crk wave026 intake preserves candidates and held records at either integration stage',()=>{
