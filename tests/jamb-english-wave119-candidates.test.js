...
const batch=require('../ops/jamb/review-candidates/english/english-1988-011.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1988-011.cjs');
...
test('wave119 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave119 intake preserves candidates and held records at either integration stage',()=>{
