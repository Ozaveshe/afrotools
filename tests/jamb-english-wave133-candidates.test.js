...
const batch=require('../ops/jamb/review-candidates/english/english-1986-006.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1986-006.cjs');
...
test('wave133 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave133 intake preserves candidates and held records at either integration stage',()=>{
