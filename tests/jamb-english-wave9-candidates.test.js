...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-2015-004.cjs');
...
test('wave9 intake preserves candidates and held records at either integration stage',()=>{
 assert.equal(verify(before).candidates,29);
