...
const {verify}=require('../ops/jamb/review-candidates/crk/check-crk-wave001.cjs');
...
test('crk wave001 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('crk wave001 intake preserves candidates and held records at either integration stage',()=>{
