...
const batch=require('../ops/jamb/review-candidates/english/english-1980-006.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1980-006.cjs');
...
test('wave181 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave181 intake preserves candidates and held records at either integration stage',()=>{
