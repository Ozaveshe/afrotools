...
const batch=require('../ops/jamb/review-candidates/english/english-1985-005.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1985-005.cjs');
...
test('wave144 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave144 intake preserves candidates and held records at either integration stage',()=>{
