...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1979-006.cjs');
...
test('wave187 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave187 intake preserves candidates and held records at either integration stage',()=>{
