...
const batch=require('../ops/jamb/review-candidates/english/english-1991-008.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1991-008.cjs');
...
test('wave96 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave96 intake preserves candidates and held records at either integration stage',()=>{
