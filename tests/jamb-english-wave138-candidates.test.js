...
const batch=require('../ops/jamb/review-candidates/english/english-1986-011.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1986-011.cjs');
...
test('wave138 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave138 intake preserves candidates and held records at either integration stage',()=>{
