...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1992-004.cjs');
...
test('wave79 intake preserves candidates and held records at either integration stage',()=>{
