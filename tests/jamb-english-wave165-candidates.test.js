...
const batch=require('../ops/jamb/review-candidates/english/english-1982-014.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1982-014.cjs');
...
test('wave165 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave165 intake preserves candidates and held records at either integration stage',()=>{
