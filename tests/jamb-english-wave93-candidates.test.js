...
const batch=require('../ops/jamb/review-candidates/english/english-1991-005.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1991-005.cjs');
...
test('wave93 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave93 intake preserves candidates and held records at either integration stage',()=>{
