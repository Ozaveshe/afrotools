...
const batch=require('../ops/jamb/review-candidates/english/english-1992-013.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1992-013.cjs');
...
test('wave88 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave88 intake preserves candidates and held records at either integration stage',()=>{
