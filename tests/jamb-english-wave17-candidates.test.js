...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-2011-002.cjs');
...
test('wave17 intake preserves candidates and held records at either integration stage',()=>{
