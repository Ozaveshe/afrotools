...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1998-008.cjs');
...
test('wave58 intake preserves candidates and held records at either integration stage',()=>{
