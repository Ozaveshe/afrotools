...
const batch=require('../ops/jamb/review-candidates/english/english-1988-004.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1988-004.cjs');
...
test('wave112 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave112 intake preserves candidates and held records at either integration stage',()=>{
