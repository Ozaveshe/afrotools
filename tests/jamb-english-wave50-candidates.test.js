...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1999-006.cjs');
...
test('wave50 intake preserves candidates and held records at either integration stage',()=>{
