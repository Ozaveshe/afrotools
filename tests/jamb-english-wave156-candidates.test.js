...
const batch=require('../ops/jamb/review-candidates/english/english-1982-005.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1982-005.cjs');
...
test('wave156 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave156 intake preserves candidates and held records at either integration stage',()=>{
