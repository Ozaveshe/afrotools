...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-2004-004.cjs');
...
test('wave27 intake preserves candidates and held records at either integration stage',()=>{
