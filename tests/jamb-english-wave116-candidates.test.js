...
const batch=require('../ops/jamb/review-candidates/english/english-1988-008.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1988-008.cjs');
...
test('wave116 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave116 intake preserves candidates and held records at either integration stage',()=>{
