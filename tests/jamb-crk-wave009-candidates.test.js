...
const batch=require('../ops/jamb/review-candidates/crk/crk-wave009.json');
const {verify}=require('../ops/jamb/review-candidates/crk/check-crk-wave009.cjs');
...
test('crk wave009 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('crk wave009 intake preserves candidates and held records at either integration stage',()=>{
