...
const batch=require('../ops/jamb/review-candidates/english/english-1986-012.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1986-012.cjs');
...
test('wave139 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave139 intake preserves candidates and held records at either integration stage',()=>{
