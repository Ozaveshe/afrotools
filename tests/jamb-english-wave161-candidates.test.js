...
const batch=require('../ops/jamb/review-candidates/english/english-1982-010.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1982-010.cjs');
...
test('wave161 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave161 intake preserves candidates and held records at either integration stage',()=>{
