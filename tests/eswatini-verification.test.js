...
const context = { require, __dirname: path.join(root, 'scripts'), process: { argv: [] }, console };
vm.createContext(context);
vm.runInContext(owner.replace(/\nmain\(\);\s*$/, '\nthis.api = { applyEswatiniPayeEvidence, buildPanel };'), context);
