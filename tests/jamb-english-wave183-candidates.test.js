...
const batch=require('../ops/jamb/review-candidates/english/english-1979-002.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1979-002.cjs');
...
test('wave183 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave183 intake preserves candidates and held records at either integration stage',()=>{
