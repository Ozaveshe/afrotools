...
assert.strictEqual(engine.REVIEWED_ON, '2026-08-02');
...
assert.deepStrictEqual(engine.classify('standard'), { treatment: 'standard', rate: 7.5, section: 'NTA 2025 s147' });
assert.deepStrictEqual(engine.classify('medical-products-services'), { treatment: 'zero-rated', rate: 0, section: 'NTA 2025 s186' });
assert.deepStrictEqual(engine.classify('shared-road-transport'), { treatment: 'exempt', rate: null, section: 'NTA 2025 s185' });
