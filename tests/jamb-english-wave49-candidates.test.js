...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1999-005.cjs');
...
test('wave49 intake preserves candidates and held records at either integration stage',()=>{
