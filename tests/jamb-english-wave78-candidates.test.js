...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1992-003.cjs');
...
test('wave78 intake preserves candidates and held records at either integration stage',()=>{
