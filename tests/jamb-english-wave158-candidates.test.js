...
const batch=require('../ops/jamb/review-candidates/english/english-1982-007.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1982-007.cjs');
...
test('wave158 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave158 intake preserves candidates and held records at either integration stage',()=>{
