...
const batch=require('../ops/jamb/review-candidates/english/english-1990-003.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1990-003.cjs');
...
test('wave100 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave100 intake preserves candidates and held records at either integration stage',()=>{
