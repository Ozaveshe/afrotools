...
const batch=require('../ops/jamb/review-candidates/english/english-1982-011.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1982-011.cjs');
...
test('wave162 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave162 intake preserves candidates and held records at either integration stage',()=>{
