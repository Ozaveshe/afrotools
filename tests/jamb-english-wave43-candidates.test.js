...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-2000-002.cjs');
...
test('wave43 intake preserves candidates and held records at either integration stage',()=>{
