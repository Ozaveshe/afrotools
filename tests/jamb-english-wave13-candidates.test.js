...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-2013-002.cjs');
...
test('wave13 intake preserves candidates and held records at either integration stage',()=>{
 assert.equal(verify(before).candidates,26);
