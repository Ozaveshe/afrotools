...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1992-009.cjs');
...
test('wave84 intake preserves candidates and held records at either integration stage',()=>{
