...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-2009-001.cjs');
...
test('wave19 intake preserves candidates and held records at either integration stage',()=>{
 assert.equal(verify(before).candidates,19);
 assert.equal(verify(after,true).held,21);
