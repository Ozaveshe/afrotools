...
const batch=require('../ops/jamb/review-candidates/english/english-1988-001.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1988-001.cjs');
...
test('wave109 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave109 intake preserves candidates and held records at either integration stage',()=>{
