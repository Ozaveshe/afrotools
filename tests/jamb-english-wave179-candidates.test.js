...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1980-004.cjs');
...
test('wave179 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave179 intake preserves candidates and held records at either integration stage',()=>{
