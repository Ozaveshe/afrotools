...
const batch=require('../ops/jamb/review-candidates/crk/crk-wave024.json');
const {verify}=require('../ops/jamb/review-candidates/crk/check-crk-wave024.cjs');
...
test('crk wave024 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('crk wave024 intake preserves candidates and held records at either integration stage',()=>{
