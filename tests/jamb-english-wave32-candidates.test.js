...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-2003-001.cjs');
...
test('wave32 intake preserves candidates and held records at either integration stage',()=>{
