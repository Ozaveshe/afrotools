...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1998-011.cjs');
...
test('wave61 intake preserves candidates and held records at either integration stage',()=>{
