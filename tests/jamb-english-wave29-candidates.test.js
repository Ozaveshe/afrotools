...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-2004-006.cjs');
...
test('wave29 intake preserves candidates and held records at either integration stage',()=>{
