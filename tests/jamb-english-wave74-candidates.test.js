...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1993-001.cjs');
...
test('wave74 intake preserves candidates and held records at either integration stage',()=>{
