...
const batch=require('../ops/jamb/review-candidates/english/english-1992-012.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1992-012.cjs');
...
test('wave87 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave87 intake preserves candidates and held records at either integration stage',()=>{
