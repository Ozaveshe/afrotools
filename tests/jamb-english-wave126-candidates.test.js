...
const batch=require('../ops/jamb/review-candidates/english/english-1987-005.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1987-005.cjs');
...
test('wave126 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave126 intake preserves candidates and held records at either integration stage',()=>{
