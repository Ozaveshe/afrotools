...
const batch=require('../ops/jamb/review-candidates/english/english-1986-007.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1986-007.cjs');
...
test('wave134 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave134 intake preserves candidates and held records at either integration stage',()=>{
