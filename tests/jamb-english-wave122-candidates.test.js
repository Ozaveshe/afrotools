...
const batch=require('../ops/jamb/review-candidates/english/english-1987-001.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1987-001.cjs');
...
test('wave122 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave122 intake preserves candidates and held records at either integration stage',()=>{
