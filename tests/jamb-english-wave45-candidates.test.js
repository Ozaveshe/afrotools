...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1999-001.cjs');
...
test('wave45 intake preserves candidates and held records at either integration stage',()=>{
