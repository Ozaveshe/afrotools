...
const batch=require('../ops/jamb/review-candidates/english/english-1982-001.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1982-001.cjs');
...
test('wave152 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave152 intake preserves candidates and held records at either integration stage',()=>{
