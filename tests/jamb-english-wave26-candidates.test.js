...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-2004-003.cjs');
...
test('wave26 intake preserves candidates and held records at either integration stage',()=>{
