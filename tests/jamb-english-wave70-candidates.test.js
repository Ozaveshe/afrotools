...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1995-006.cjs');
...
test('wave70 intake preserves candidates and held records at either integration stage',()=>{
