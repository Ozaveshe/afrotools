...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1998-009.cjs');
...
test('wave59 intake preserves candidates and held records at either integration stage',()=>{
