...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-2004-002.cjs');
...
test('wave25 intake preserves candidates and held records at either integration stage',()=>{
