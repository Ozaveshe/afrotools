...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-2004-001.cjs');
...
test('wave24 intake preserves candidates and held records at either integration stage',()=>{
 assert.equal(verify(before).candidates,12);
 assert.equal(verify(after,true).held,28);
