...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1998-010.cjs');
...
test('wave60 intake preserves candidates and held records at either integration stage',()=>{
