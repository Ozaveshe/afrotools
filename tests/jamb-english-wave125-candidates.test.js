...
const batch=require('../ops/jamb/review-candidates/english/english-1987-004.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1987-004.cjs');
...
test('wave125 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave125 intake preserves candidates and held records at either integration stage',()=>{
