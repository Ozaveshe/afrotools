...
const batch=require('../ops/jamb/review-candidates/english/english-1986-005.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1986-005.cjs');
...
test('wave132 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave132 intake preserves candidates and held records at either integration stage',()=>{
