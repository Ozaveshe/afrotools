...
for(const locale of Object.keys(routes)){
  ...
  assert.ok(html.includes('https://cdn-webportal.airtelstream.net/website/airtel-money/tanzania/assets/pdf/Airtel-Money-Tarrif-English-2026.pdf'));
  ...
  assert.ok(generated.includes('590 TZS'));
}
