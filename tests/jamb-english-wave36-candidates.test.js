...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-2002-002.cjs');
...
test('wave36 intake preserves candidates and held records at either integration stage',()=>{
