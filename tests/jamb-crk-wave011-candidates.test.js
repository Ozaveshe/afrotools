...
const {verify}=require('../ops/jamb/review-candidates/crk/check-crk-wave011.cjs');
...
test('crk wave011 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('crk wave011 intake preserves candidates and held records at either integration stage',()=>{
