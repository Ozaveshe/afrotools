...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1998-005.cjs');
...
test('wave55 intake preserves candidates and held records at either integration stage',()=>{
