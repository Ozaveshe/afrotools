...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-2008-002.cjs');
...
test('wave22 intake preserves candidates and held records at either integration stage',()=>{
 assert.equal(verify(before).candidates,17);
 assert.equal(verify(after,true).held,23);
