...
const batch=require('../ops/jamb/review-candidates/english/english-1988-002.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1988-002.cjs');
...
test('wave110 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave110 intake preserves candidates and held records at either integration stage',()=>{
