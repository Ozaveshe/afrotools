...
const batch=require('../ops/jamb/review-candidates/crk/crk-wave018.json');
const {verify}=require('../ops/jamb/review-candidates/crk/check-crk-wave018.cjs');
...
test('crk wave018 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('crk wave018 intake preserves candidates and held records at either integration stage',()=>{
