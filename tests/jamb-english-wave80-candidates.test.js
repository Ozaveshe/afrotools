...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1992-005.cjs');
...
test('wave80 intake preserves candidates and held records at either integration stage',()=>{
