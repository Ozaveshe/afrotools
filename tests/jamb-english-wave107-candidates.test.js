...
const batch=require('../ops/jamb/review-candidates/english/english-1989-003.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1989-003.cjs');
...
test('wave107 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave107 intake preserves candidates and held records at either integration stage',()=>{
