...
const batch=require('../ops/jamb/review-candidates/crk/crk-wave025.json');
const {verify}=require('../ops/jamb/review-candidates/crk/check-crk-wave025.cjs');
...
test('crk wave025 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('crk wave025 intake preserves candidates and held records at either integration stage',()=>{
