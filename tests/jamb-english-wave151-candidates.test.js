...
const batch=require('../ops/jamb/review-candidates/english/english-1984-006.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1984-006.cjs');
...
test('wave151 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave151 intake preserves candidates and held records at either integration stage',()=>{
