...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-2008-001.cjs');
...
test('wave21 intake preserves candidates and held records at either integration stage',()=>{
 assert.equal(verify(before).candidates,30);
