...
const batch=require('../ops/jamb/review-candidates/english/english-1992-011.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1992-011.cjs');
...
test('wave86 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave86 intake preserves candidates and held records at either integration stage',()=>{
