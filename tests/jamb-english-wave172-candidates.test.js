...
const batch=require('../ops/jamb/review-candidates/english/english-1981-003.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1981-003.cjs');
...
test('wave172 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave172 intake preserves candidates and held records at either integration stage',()=>{
