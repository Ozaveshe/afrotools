...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1992-007.cjs');
...
test('wave82 intake preserves candidates and held records at either integration stage',()=>{
