...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-2001-002.cjs');
...
test('wave40 intake preserves candidates and held records at either integration stage',()=>{
