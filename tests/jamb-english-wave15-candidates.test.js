...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-2012-002.cjs');
...
test('wave15 intake preserves candidates and held records at either integration stage',()=>{
 assert.equal(verify(before).candidates,21);
 assert.equal(verify(after,true).held,19);
