...
const batch=require('../ops/jamb/review-candidates/crk/crk-wave012.json');
const {verify}=require('../ops/jamb/review-candidates/crk/check-crk-wave012.cjs');
...
test('crk wave012 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('crk wave012 intake preserves candidates and held records at either integration stage',()=>{
