...
const batch=require('../ops/jamb/review-candidates/english/english-1985-006.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1985-006.cjs');
...
test('wave145 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave145 intake preserves candidates and held records at either integration stage',()=>{
