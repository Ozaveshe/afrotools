...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1994-001.cjs');
...
test('wave71 intake preserves candidates and held records at either integration stage',()=>{
