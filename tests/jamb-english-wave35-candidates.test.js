...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-2002-001.cjs');
...
test('wave35 intake preserves candidates and held records at either integration stage',()=>{
