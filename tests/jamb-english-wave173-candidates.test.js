...
const batch=require('../ops/jamb/review-candidates/english/english-1981-004.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1981-004.cjs');
...
test('wave173 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave173 intake preserves candidates and held records at either integration stage',()=>{
