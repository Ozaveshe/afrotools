...
const batch=require('../ops/jamb/review-candidates/english/english-1986-002.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1986-002.cjs');
...
test('wave129 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave129 intake preserves candidates and held records at either integration stage',()=>{
