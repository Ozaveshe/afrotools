...
const batch=require('../ops/jamb/review-candidates/english/english-1980-003.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1980-003.cjs');
...
test('wave178 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave178 intake preserves candidates and held records at either integration stage',()=>{
