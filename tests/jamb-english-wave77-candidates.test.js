...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1992-002.cjs');
...
test('wave77 intake preserves candidates and held records at either integration stage',()=>{
