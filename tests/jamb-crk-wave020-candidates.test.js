...
const batch=require('../ops/jamb/review-candidates/crk/crk-wave020.json');
const {verify}=require('../ops/jamb/review-candidates/crk/check-crk-wave020.cjs');
...
test('crk wave020 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('crk wave020 intake preserves candidates and held records at either integration stage',()=>{
