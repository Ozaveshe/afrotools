...
const batch=require('../ops/jamb/review-candidates/english/english-1987-002.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1987-002.cjs');
...
test('wave123 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave123 intake preserves candidates and held records at either integration stage',()=>{
