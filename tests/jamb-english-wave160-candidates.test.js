...
const batch=require('../ops/jamb/review-candidates/english/english-1982-009.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1982-009.cjs');
...
test('wave160 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave160 intake preserves candidates and held records at either integration stage',()=>{
