...
const batch=require('../ops/jamb/review-candidates/crk/crk-wave006.json');
const {verify}=require('../ops/jamb/review-candidates/crk/check-crk-wave006.cjs');
...
test('crk wave006 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('crk wave006 intake preserves candidates and held records at either integration stage',()=>{
