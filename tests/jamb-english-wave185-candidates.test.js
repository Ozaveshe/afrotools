...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1979-004.cjs');
...
test('wave185 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave185 intake preserves candidates and held records at either integration stage',()=>{
