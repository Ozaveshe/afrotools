...
const batch=require('../ops/jamb/review-candidates/english/english-1989-002.json');
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1989-002.cjs');
...
test('wave106 rejects self-consistently rehashed answer and numbering mutations',()=>{
...
test('wave106 intake preserves candidates and held records at either integration stage',()=>{
