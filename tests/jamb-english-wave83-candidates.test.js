...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1992-008.cjs');
...
test('wave83 intake preserves candidates and held records at either integration stage',()=>{
