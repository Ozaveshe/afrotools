...
const {verify}=require('../ops/jamb/review-candidates/english/check-english-1998-006.cjs');
...
test('wave56 intake preserves candidates and held records at either integration stage',()=>{
