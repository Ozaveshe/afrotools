...
const batch=require('../../ops/jamb/review-candidates/english/english-2002-003.json');
for(const width of [320,390])test(`English wave37 answer disclosures at ${width}px`,async({page})=>{
