...
const batch=require('../../ops/jamb/review-candidates/crk/crk-recovery002.json');
for(const width of [320,390])test(`CRK recovery002 answer disclosures at ${width}px`,async({page})=>{
 ...
 for(const year of [...new Set(batch.records.map(r=>r.candidate.year))]){
