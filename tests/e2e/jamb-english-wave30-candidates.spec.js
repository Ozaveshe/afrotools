...
const batch=require('../../ops/jamb/review-candidates/english/english-2004-007.json');
for(const width of [320,390])test(`English wave30 answer disclosures at ${width}px`,async({page})=>{
