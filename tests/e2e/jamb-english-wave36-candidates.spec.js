...
const batch=require('../../ops/jamb/review-candidates/english/english-2002-002.json');
for(const width of [320,390])test(`English wave36 answer disclosures at ${width}px`,async({page})=>{
