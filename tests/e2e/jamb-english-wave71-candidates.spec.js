...
const batch=require('../../ops/jamb/review-candidates/english/english-1994-001.json');
for(const width of [320,390])test(`English wave71 answer disclosures at ${width}px`,async({page})=>{
