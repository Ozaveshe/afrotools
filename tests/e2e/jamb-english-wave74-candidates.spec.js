...
const batch=require('../../ops/jamb/review-candidates/english/english-1993-001.json');
for(const width of [320,390])test(`English wave74 answer disclosures at ${width}px`,async({page})=>{
