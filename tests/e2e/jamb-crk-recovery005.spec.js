...
const batch=require('../../ops/jamb/review-candidates/crk/crk-recovery005.json');
for(const width of [320,390])test(`CRK recovery005 answer disclosures at ${width}px`,async({page})=>{
