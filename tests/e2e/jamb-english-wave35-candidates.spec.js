...
const batch=require('../../ops/jamb/review-candidates/english/english-2002-001.json');
for(const width of [320,390])test(`English wave35 answer disclosures at ${width}px`,async({page})=>{
