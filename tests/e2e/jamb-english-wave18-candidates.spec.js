...
const batch=require('../../ops/jamb/review-candidates/english/english-2010-001.json');
for(const width of [320,390])test(`English wave18 answer disclosures at ${width}px`,async({page})=>{
