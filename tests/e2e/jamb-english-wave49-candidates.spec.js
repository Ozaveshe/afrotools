...
const batch=require('../../ops/jamb/review-candidates/english/english-1999-005.json');
for(const width of [320,390])test(`English wave49 answer disclosures at ${width}px`,async({page})=>{
