...
const batch=require('../../ops/jamb/review-candidates/english/english-2014-001.json');
for(const width of [320,390])test(`English wave10 answer disclosures at ${width}px`,async({page})=>{
