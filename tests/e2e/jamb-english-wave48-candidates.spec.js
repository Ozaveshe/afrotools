...
const batch=require('../../ops/jamb/review-candidates/english/english-1999-004.json');
for(const width of [320,390])test(`English wave48 answer disclosures at ${width}px`,async({page})=>{
