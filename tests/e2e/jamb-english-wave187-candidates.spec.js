...
const batch=require('../../ops/jamb/review-candidates/english/english-1979-006.json');
for(const width of [320,390])test(`English wave187 answer disclosures at ${width}px`,async({page})=>{
