...
const batch=require('../../ops/jamb/review-candidates/english/english-1998-006.json');
for(const width of [320,390])test(`English wave56 answer disclosures at ${width}px`,async({page})=>{
