...
test('guest receipt stays readable and exports locally with keyboard review', async ({ page }) => {
  ...
  // Dark styles load lazily in production; exercise them deterministically here.
  await page.addStyleTag({ path: path.resolve(__dirname, '../../assets/css/theme-dark.min.css') });
