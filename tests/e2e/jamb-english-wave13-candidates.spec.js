...
const batch=require('../../ops/jamb/review-candidates/english/english-2013-002.json');
for(const width of [320,390])test(`English wave13 answer disclosures at ${width}px`,async({page})=>{
