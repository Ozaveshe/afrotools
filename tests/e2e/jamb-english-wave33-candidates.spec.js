...
const batch=require('../../ops/jamb/review-candidates/english/english-2003-002.json');
for(const width of [320,390])test(`English wave33 answer disclosures at ${width}px`,async({page})=>{
