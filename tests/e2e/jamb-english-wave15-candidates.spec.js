...
const batch=require('../../ops/jamb/review-candidates/english/english-2012-002.json');
for(const width of [320,390])test(`English wave15 answer disclosures at ${width}px`,async({page})=>{
