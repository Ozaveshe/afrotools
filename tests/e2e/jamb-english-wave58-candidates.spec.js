...
const batch=require('../../ops/jamb/review-candidates/english/english-1998-008.json');
for(const width of [320,390])test(`English wave58 answer disclosures at ${width}px`,async({page})=>{
