...
const batch=require('../../ops/jamb/review-candidates/english/english-2011-002.json');
for(const width of [320,390])test(`English wave17 answer disclosures at ${width}px`,async({page})=>{
