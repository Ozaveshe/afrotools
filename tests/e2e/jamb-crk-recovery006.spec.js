...
const batch=require('../../ops/jamb/review-candidates/crk/crk-recovery006.json');
for(const width of [320,390])test(`CRK recovery006 answer disclosures at ${width}px`,async({page})=>{
