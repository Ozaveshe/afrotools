...
const batch=require('../../ops/jamb/review-candidates/english/english-1992-009.json');
for(const width of [320,390])test(`English wave84 answer disclosures at ${width}px`,async({page})=>{
 ...
 for(const year of [1994,1993,1992]){
