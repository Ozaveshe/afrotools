...
const batch=require('../../ops/jamb/review-candidates/english/english-2015-002.json');
for(const width of [320,390])test(`English wave7 answer disclosures at ${width}px`,async({page})=>{
