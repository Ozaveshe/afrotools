...
const batch=require('../../ops/jamb/review-candidates/english/english-1995-003.json');
for(const width of [320,390])test(`English wave67 answer disclosures at ${width}px`,async({page})=>{
