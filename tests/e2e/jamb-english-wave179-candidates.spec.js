...
const batch=require('../../ops/jamb/review-candidates/english/english-1980-004.json');
for(const width of [320,390])test(`English wave179 answer disclosures at ${width}px`,async({page})=>{
