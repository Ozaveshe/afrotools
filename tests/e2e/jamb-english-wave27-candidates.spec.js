...
const batch=require('../../ops/jamb/review-candidates/english/english-2004-004.json');
for(const width of [320,390])test(`English wave27 answer disclosures at ${width}px`,async({page})=>{
