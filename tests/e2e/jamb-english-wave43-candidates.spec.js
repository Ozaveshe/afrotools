...
const batch=require('../../ops/jamb/review-candidates/english/english-2000-002.json');
for(const width of [320,390])test(`English wave43 answer disclosures at ${width}px`,async({page})=>{
