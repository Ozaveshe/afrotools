...
const batch=require('../../ops/jamb/review-candidates/english/english-1999-003.json');
for(const width of [320,390])test(`English wave47 answer disclosures at ${width}px`,async({page})=>{
