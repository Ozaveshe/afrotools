...
const batch=require('../../ops/jamb/review-candidates/english/english-1992-007.json');
for(const width of [320,390])test(`English wave82 answer disclosures at ${width}px`,async({page})=>{
