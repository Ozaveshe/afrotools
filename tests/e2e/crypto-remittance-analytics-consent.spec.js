...
for(const route of ['/crypto/remittance/','/fr/crypto/remittance/','/sw/zana/ulinganisho-nukuu-za-kutuma-fedha/'])test(`${route} analytics require explicit consent`,async({page})=>{
