...
const batch=require('../../ops/jamb/review-candidates/english/english-2007-001.json');
for(const width of [320,390])test(`English wave23 answer disclosures at ${width}px`,async({page})=>{
