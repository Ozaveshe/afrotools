...
const batch=require('../../ops/jamb/review-candidates/english/english-2003-001.json');
for(const width of [320,390])test(`English wave32 answer disclosures at ${width}px`,async({page})=>{
