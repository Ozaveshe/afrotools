...
const batch=require('../../ops/jamb/review-candidates/english/english-1998-001.json');
for(const width of [320,390])test(`English wave51 answer disclosures at ${width}px`,async({page})=>{
