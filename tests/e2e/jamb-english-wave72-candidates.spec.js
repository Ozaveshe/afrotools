...
const batch=require('../../ops/jamb/review-candidates/english/english-1994-002.json');
for(const width of [320,390])test(`English wave72 answer disclosures at ${width}px`,async({page})=>{
