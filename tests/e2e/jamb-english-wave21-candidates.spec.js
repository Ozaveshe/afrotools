...
const batch=require('../../ops/jamb/review-candidates/english/english-2008-001.json');
for(const width of [320,390])test(`English wave21 answer disclosures at ${width}px`,async({page})=>{
