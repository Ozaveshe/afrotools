...
const batch=require('../../ops/jamb/review-candidates/english/english-2015-004.json');
for(const width of [320,390])test(`English wave9 answer disclosures at ${width}px`,async({page})=>{
