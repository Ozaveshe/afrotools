...
const batch=require('../../ops/jamb/review-candidates/english/english-2009-001.json');
for(const width of [320,390])test(`English wave19 answer disclosures at ${width}px`,async({page})=>{
