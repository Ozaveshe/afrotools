...
const batch=require('../../ops/jamb/review-candidates/crk/crk-recovery003.json');
for(const width of [320,390])test(`CRK recovery003 answer disclosures at ${width}px`,async({page})=>{
