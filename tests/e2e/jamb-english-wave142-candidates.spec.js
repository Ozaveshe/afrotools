...
const batch=require('../../ops/jamb/review-candidates/english/english-1985-003.json');
for(const width of [320,390])test(`English wave142 answer disclosures at ${width}px`,async({page})=>{
