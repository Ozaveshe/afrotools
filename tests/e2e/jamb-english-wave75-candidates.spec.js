...
const batch=require('../../ops/jamb/review-candidates/english/english-1993-002.json');
for(const width of [320,390])test(`English wave75 answer disclosures at ${width}px`,async({page})=>{
