...
const batch=require('../../ops/jamb/review-candidates/english/english-2009-002.json');
for(const width of [320,390])test(`English wave20 answer disclosures at ${width}px`,async({page})=>{
