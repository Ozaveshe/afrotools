...
const batch=require('../../ops/jamb/review-candidates/crk/crk-recovery001.json');
for(const width of [320,390])test(`CRK recovery001 answer disclosures at ${width}px`,async({page})=>{
