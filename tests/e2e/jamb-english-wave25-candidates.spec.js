...
const batch=require('../../ops/jamb/review-candidates/english/english-2004-002.json');
for(const width of [320,390])test(`English wave25 answer disclosures at ${width}px`,async({page})=>{
