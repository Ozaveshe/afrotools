...
!function(t, e) {
  ...
  "sw": {
    ...
    "skills": "Ujuzi",
    "projects": "Miradi",
    "certifications": "Vyeti vya taaluma",
    "languages": "Lugha",
    "references": "Wadhamini",
    "available": "Taarifa za wadhamini zinapatikana zikiombwa.",
    "present": "Sasa",
    "to": " hadi ",
    "name": "Jina la kwanza na la ukoo",
    "target": "Nafasi unayoomba",
    "role": "Nafasi",
    ...
    function r(t, e) {
        return t.map(o).filter(Boolean).join(e || " | ");
    }
    function n() {
        try {
    ...
    function i(t) {
        return r([ t.s || t.start || t.y1 || t.from, t.cur ? copy.present : t.e || t.end || t.y2 || t.to ], copy.to);
    }
    function l(t, e, a) {
        var r = Array.isArray(a) ? a.filter(Boolean).join("\n\n") : o(a);
        r && (t.push(""), t.push(e), t.push(r));
    }
    function s() {
        var t = n().data || {}, e = [];
    ...
    function d() {
        ...
        !function(a, o) {
            ...
            var r = URL.createObjectURL(a), n = e.createElement("a");
            n.href = r, n.download = o, n.dataset.noPdfGate = "true", e.body.appendChild(n),
    ...
    function u() {
        ...
        t || ((t = e.createElement("div")).className = "cv-export-modal-overlay", t.innerHTML = [ '<div class="cv-export-modal" role="dialog" aria-modal="true" aria-label="ATS Plain Version">', '<div class="cv-export-modal-head">', "<div><h3>ATS Plain Version</h3><p>One column, standard headings, selectable text, no tables, photos, icons, or decorative layout.</p></div>", "<button type=\"button\" data-export-close>Fermer</button>", "</div>", '<textarea data-export-ats-text spellcheck="true"></textarea>', '<div class="cv-export-modal-actions">', "<button type=\"button\" data-export-copy-ats>Copier</button>", '<button type="button" data-export-download-ats>Download TXT</button>', '<button type="button" data-export-download-ats-pdf>Download ATS Plain PDF</button>', "</div>", "</div>" ].join(""),
    ...
    function f() {
        ...
        return r || i ? "Creative or photo templates can parse poorly on job portals. Use ATS Plain PDF/TXT for portal uploads." : "";
    }
    function x() {
        !function() {
            if (t.CVExportUpgrade && !t.CVExportUpgrade.__atsPlainModeReady) {
                var e = t.CVExportUpgrade.handleExport;
                t.CVExportUpgrade.buildAtsPlainText = s, t.CVExportUpgrade.openAtsModal = u, t.CVExportUpgrade.exportText = d,
                t.CVExportUpgrade.exportAtsPdf = c, t.CVExportUpgrade.handleExport = function(t) {
                    return "ats" === t ? u() : "ats-pdf" === t ? c() : "text" === t ? d() : e ? e.apply(this, arguments) : void 0;
                }, t.CVExportUpgrade.__atsPlainModeReady = !0;
            }
        }(), function() {
            if (t.CVAdvanced && !t.CVAdvanced.__atsPlainWarningReady && t.CVAdvanced.runATSSimulator) {
                var a = t.CVAdvanced.runATSSimulator;
                t.CVAdvanced.runATSSimulator = function() {
                    var t = a.apply(this, arguments);
                    return setTimeout(function() {
                        var t = f(), a = e.querySelector("#cv-adv-ats, .cv-adv-modal, .cv-adv-overlay");
                        if (t && a && !a.querySelector("[data-ats-template-warning]")) {
                            var o = e.createElement("div");
                            o.setAttribute("data-ats-template-warning", "true"), o.style.cssText = "margin:10px 0;padding:10px 12px;border:1px solid #fed7aa;border-radius:8px;background:#fff7ed;color:#9a3412;font-size:12px;line-height:1.45",
                            o.textContent = t;
                            var r = a.querySelector(".cv-adv-section") || a.firstElementChild || a;
                            r.parentNode.insertBefore(o, r);
                        }
                    }, 40), t;
                }, t.CVAdvanced.__atsPlainWarningReady = !0;
            }
        }(), e.querySelectorAll(".cv-export-options").forEach(function(t) {
            if (!t.querySelector("[data-ats-plain-note]")) {
                var o = e.createElement("p");
                o.setAttribute("data-ats-plain-note", "true"), o.style.cssText = "margin:8px 0 0;color:var(--color-text-muted);font-size:12px;line-height:1.4",
                o.textContent = a;
                var r = t.querySelector(".cv-export-actions");
                r && r.parentNode.insertBefore(o, r.nextSibling);
            }
        }), setTimeout(x, 800);
    }
    t.CVAtsPlainMode = {
        ...
        exportTxt: d,
        templateWarning: f
    }, "loading" === e.readyState ? e.addEventListener("DOMContentLoaded", x) : x();
}(window, document);