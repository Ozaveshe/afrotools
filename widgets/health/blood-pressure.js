      ...
      '<div style="padding:22px">' +
        ...
        '<div id="aw-bp-result" style="display:none;margin-top:14px">' +
          ...
          '<table style="width:100%;border-collapse:collapse;margin-top:14px;font-size:.78rem">' +
            ...
            '<tbody>' +
              '<tr style="border-bottom:1px solid '+border+'"><td style="padding:8px"><span style="display:inline-block;width:10px;height:10px;border-radius:50%;background:#007AFF;margin-right:6px"></span>Normal</td><td style="text-align:center;padding:8px">&lt; 120</td><td style="text-align:center;padding:8px">&lt; 80</td></tr>' +
