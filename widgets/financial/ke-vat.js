(function(){
  ...
  window.AfroWidgets.ke_vat = function(container, opts) {
    opts = opts || {};
    ...
    var COUNTRY = 'Kenya';
    var CURRENCY = 'KES';
    var INFO = 'Standard rate 16%. 8% on petroleum. Basic food, health, education exempt. Authority: KRA. Filing: Monthly. Threshold: KES 5M/yr.';

    var uid = 'aw_kevat_' + Math.random().toString(36).substr(2,6);
