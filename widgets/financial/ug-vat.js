(function(){
  ...
  window.AfroWidgets.ug_vat = function(container, opts) {
    opts = opts || {};
    ...
    var COUNTRY = 'Uganda';
    var CURRENCY = 'USh';
    var INFO = 'Standard rate 18%. Zero-rated basic food. Health, education exempt. Authority: URA. Filing: Monthly. Threshold: UGX 150M/yr.';

    var uid = 'aw_ugvat_' + Math.random().toString(36).substr(2,6);
