(function(){
  ...
  window.AfroWidgets.gh_vat = function(container, opts) {
    ...
    var NAME = 'Ghana';
    var FLAG = '\uD83C\uDDEC\uD83C\uDDED';
    var INFO = 'Effective rate 21.9% (15% VAT + NHIL 2.5% + GETFund 2.5% + COVID 1% + Debt Recovery 1.9%). Flat rate 3% for small businesses. Authority: GRA. Filing: Monthly. Threshold: GHS 200K/yr.';
