(function(){
  ...
  window.AfroWidgets.gh_vat = function(container, opts) {
    opts = opts || {};
    ...
    var COUNTRY = 'Ghana';
    var CURRENCY = 'GHS';
    var INFO = 'Effective rate 21.9% (15% + NHIL 2.5% + GETFund 2.5% + COVID 1% + Debt Recovery 1.9%). Flat rate 3% for small businesses. Authority: GRA. Filing: Monthly. Threshold: GHS 200K/yr.';

    var uid = 'aw_ghvat_' + Math.random().toString(36).substr(2,6);
    ...
    html += '<p style="margin:0 0 14px;font-size:0.82rem;color:'+muted+';">Effective rate: '+RATE+'%</p>';
