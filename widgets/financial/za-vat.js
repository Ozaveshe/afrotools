(function(){
  ...
  window.AfroWidgets.za_vat = function(container, opts) {
    opts = opts || {};
    ...
    var CURRENCY = 'R';
    var INFO = 'Standard rate 15%. Zero-rated basic food basket (bread, milk, eggs, etc.). Authority: SARS. Filing: Bi-monthly. Threshold: R1M/yr.';

    var uid = 'aw_zavat_' + Math.random().toString(36).substr(2,6);
