(function(){
  ...
  window.AfroWidgets.eg_vat = function(container, opts) {
    opts = opts || {};
    ...
    var COUNTRY = 'Egypt';
    var CURRENCY = 'E\u00A3';
    var INFO = 'Standard rate 14%. Reduced 5% on some food items. Authority: ETA. Filing: Monthly. Threshold: EGP 500K/yr.';

    var uid = 'aw_egvat_' + Math.random().toString(36).substr(2,6);
