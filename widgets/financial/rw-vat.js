(function(){
  ...
  window.AfroWidgets.rw_vat = function(container, opts) {
    opts = opts || {};
    ...
    var COUNTRY = 'Rwanda';
    var CURRENCY = 'FRw';
    var INFO = 'Standard rate 18%. Reduced rate 6%. Food, medicine, health exempt. Authority: RRA. Filing: Monthly. Threshold: FRw 20M/yr.';

    var uid = 'aw_rwvat_' + Math.random().toString(36).substr(2,6);
