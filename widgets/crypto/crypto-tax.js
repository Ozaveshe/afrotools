      ...
      '<div style="padding:22px">' +
        ...
        '<div id="aw-ctx-result" style="display:none;margin-top:14px">' +
          '<div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">' +
            ...
            '<div style="text-align:center;padding:14px;background:'+cardBg+';border:1px solid '+border+';border-radius:8px"><div id="aw-ctx-after" style="font-size:1.3rem;font-weight:800;color:#007AFF"></div><div style="font-size:.68rem;color:#64748b;font-weight:600;text-transform:uppercase;margin-top:3px">After-Tax Profit</div></div>' +
