!function() {
  ...
  var e = {
    ...
    NG: {
      ...
      law: "National Minimum Wage (Amendment) Act 2024",
      sectors: [ {
        name: "Federal / Large Employers (25+ employees)",
        rate: "₦70,000",
        period: "month"
      }, {
        name: "Private Sector (<25 employees)",
        rate: "₦50,000",
        period: "month"
      }, {
      ...
      livingWage: 15e4,
      livingWageFamily: 28e4,
      livingWageSource: "WageIndicator 2025",
    ...
    KE: {
      ...
      law: "Labour Institutions Act (Revised 2022)",
      sectors: [ {
        name: "General — Nairobi / Mombasa",
        rate: "KES 16,114",
        period: "month"
      }, {
        name: "General — Other Areas",
        rate: "KES 13,572",
        period: "month"
      }, {
        name: "Agriculture (Unskilled)",
        rate: "KES 8,163",
        period: "month"
      }, {
    ...
    ZA: {
      ...
      law: "National Minimum Wage Act (2018), Annual Review",
      sectors: [ {
        name: "National Minimum Wage (General)",
        rate: "R27.58",
        period: "hour"
      }, {
        name: "Farm Workers",
        ...
        name: "Expanded Public Works (EPWP)",
        rate: "R15.16",
        period: "hour"
      } ],
      history: [ {
      ...
      livingWage: 9500,
      livingWageFamily: 18e3,
      livingWageSource: "PACSA 2025",
    ...
    GH: {
      ...
      law: "National Daily Minimum Wage Declaration",
      sectors: [ {
        name: "National Daily Minimum",
        rate: "GHS 18.15",
        period: "day"
      }, {
        name: "Formal Sector",
      ...
      history: [ {
        year: "2025",
        nominal: 544.5,
        amount: "GHS 18.15/day"
      }, {
        year: "2024",
        nominal: 446.4,
        amount: "GHS 14.88/day"
      }, {
        year: "2023",
        nominal: 446.4,
        amount: "GHS 14.88/day"
        ...
        year: "2022",
        nominal: 405.9,
        amount: "GHS 13.53/day"
      } ],
      livingWage: 2e3,
      livingWageFamily: 4200,
      livingWageSource: "WageIndicator 2025",
    ...
    EG: {
      ...
      law: "National Wages Council Decision",
      sectors: [ {
        name: "Public Sector",
        rate: "EGP 6,000",
        period: "month"
    ...
    ET: {
      ...
      basis: "none",
      effectiveDate: "N/A",
      law: "No national minimum wage legislation (private sector)",
      sectors: [ {
    ...
    TZ: {
      ...
      law: "Wage Order under the Employment and Labour Relations Act",
      sectors: [ {
        name: "Agriculture",
        rate: "TZS 200,000",
        period: "month"
    ...
    UG: {
      ...
      monthly: 6e3,
      basis: "monthly",
      effectiveDate: "1984 (unchanged)",
      law: "Minimum Wages Advisory Board Act (1957)",
      sectors: [],
      history: [ {
        year: "1984",
        nominal: 6e3,
    ...
    RW: {
      ...
      basis: "none",
      effectiveDate: "N/A",
      law: "No comprehensive national minimum wage",
      sectors: [ {
        name: "Tea Sector",
        rate: "RWF 1,500",
        period: "day"
    ...
    CI: {
      ...
      law: "Salaire Minimum Interprofessionnel Garanti (SMIG)",
      sectors: [ {
        name: "SMIG (General)",
        rate: "FCFA 75,000",
        period: "month"
      }, {
        name: "SMAG (Agriculture)",
        rate: "FCFA 36,607",
        period: "month"
      } ],
      history: [ {
    ...
    SN: {
      ...
      history: [ {
        year: "2024",
        nominal: 65014,
        amount: "FCFA 370.54/hr"
      }, {
        year: "2018",
        nominal: 53248,
        amount: "FCFA 302.89/hr"
      } ],
      livingWage: 13e4,
      livingWageFamily: 25e4,
      livingWageSource: "WageIndicator 2025",
    ...
    MA: {
      ...
      law: "Code du Travail — SMIG/SMAG Review",
      sectors: [ {
        name: "SMIG (Non-Agricultural)",
        rate: "MAD 17.12",
        period: "hour"
      }, {
        name: "SMAG (Agriculture)",
    ...
    TN: {
      ...
      law: "Salaire Minimum Interprofessionnel Garanti (SMIG)",
      sectors: [ {
        name: "SMIG (48hr regime)",
        rate: "TND 480",
        period: "month"
      }, {
        name: "SMIG (40hr regime)",
        rate: "TND 416",
        period: "month"
      }, {
        name: "SMAG (Agriculture)",
    ...
    AO: {
      ...
      basis: "monthly",
      effectiveDate: "July 2023",
      law: "Presidential Decree on National Minimum Wage",
      sectors: [ {
    ...
    ZM: {
      ...
      basis: "monthly",
      effectiveDate: "April 2024",
      law: "Minimum Wages and Conditions of Employment Act",
      sectors: [ {
        name: "Shop Workers",
        rate: "ZMW 1,698",
        period: "month"
    ...
    ZW: {
      ...
      law: "National Employment Council Agreements",
      sectors: [ {
        name: "General (USD)",
        rate: "US$250",
        period: "month"
    ...
    MU: {
      ...
      law: "National Minimum Wage Regulations",
      sectors: [ {
        name: "National Minimum",
        rate: "MUR 15,000",
        period: "month"
      }, {
    ...
    BW: {
      ...
      law: "Employment Act — Minimum Wages Order",
      sectors: [ {
        name: "General",
        rate: "BWP 8.65",
        period: "hour"
    ...
    NA: {
      ...
      basis: "monthly",
      effectiveDate: "April 2024",
      law: "Minimum Wage Order under the Labour Act",
      sectors: [ {
        name: "General",
        rate: "NAD 7,000",
        period: "month"
    ...
    MW: {
      ...
      basis: "monthly",
      effectiveDate: "July 2024",
      law: "Employment Act — Minimum Wage Order",
      sectors: [ {
        name: "General",
        rate: "MWK 50,000",
        period: "month"
    ...
    MZ: {
      ...
      basis: "monthly",
      effectiveDate: "April 2024",
      law: "Minimum Wage by Sector — Annual Gazette",
      sectors: [ {
        name: "Agriculture",
        rate: "MZN 5,150",
        period: "month"
    ...
    MG: {
      ...
      basis: "monthly",
      effectiveDate: "January 2024",
      law: "Decree on Minimum Wage (SMIG/SMAG)",
      sectors: [ {
        name: "SMIG (Non-Agricultural)",
        rate: "MGA 250,000",
        period: "month"
    ...
    LS: {
      ...
      basis: "monthly",
      effectiveDate: "April 2024",
      law: "Labour Code Order — Minimum Wage",
      sectors: [ {
    ...
    SZ: {
      ...
      basis: "monthly",
      effectiveDate: "July 2024",
      law: "Employment Act — Wages Order",
      sectors: [ {
        name: "Manufacturing",
        rate: "SZL 2,200",
        period: "month"
    ...
    BF: {
      ...
      basis: "monthly",
      effectiveDate: "January 2024",
      law: "SMIG (Salaire Minimum Interprofessionnel Garanti)",
      sectors: [ {
        name: "SMIG",
        rate: "FCFA 45,000",
        period: "month"
    ...
    ML: {
      ...
      basis: "monthly",
      effectiveDate: "January 2023",
      law: "SMIG — Inter-professional Guaranteed Minimum Wage",
      sectors: [ {
        name: "SMIG",
        rate: "FCFA 40,000",
        period: "month"
    ...
    NE: {
      ...
      monthly: 30047,
      basis: "monthly",
      effectiveDate: "January 2012 (unchanged)",
      law: "SMIG",
      sectors: [ {
        name: "SMIG",
        rate: "FCFA 30,047",
    ...
    LR: {
      ...
      monthly: 6e3,
      basis: "monthly",
      effectiveDate: "2016 (unchanged)",
      law: "Decent Work Act",
      sectors: [ {
        name: "General",
        rate: "LRD 6,000 or US$40",
        period: "month"
      } ],
      history: [ {
        year: "2016",
        nominal: 6e3,
        amount: "US$40 / LRD 6,000"
      } ],
      livingWage: 12e3,
      livingWageFamily: 22e3,
      livingWageSource: "WageIndicator 2025",
    ...
    GM: {
      ...
      dailyRate: 150,
      effectiveDate: "January 2024",
      law: "Labour Act — Minimum Wage Order",
      sectors: [ {
        name: "General",
        rate: "GMD 150",
        period: "day"
    ...
    CV: {
      ...
      basis: "monthly",
      effectiveDate: "January 2024",
      law: "National Minimum Wage Decree",
      sectors: [ {
        name: "General",
        rate: "CVE 14,000",
        period: "month"
    ...
    DJ: {
      ...
      monthly: 35e3,
      basis: "monthly",
      effectiveDate: "2012 (unchanged)",
      law: "Labour Code — Minimum Wage Decree",
      sectors: [ {
        name: "General",
        rate: "DJF 35,000",
        period: "month"
    ...
    SO: {
      ...
      basis: "none",
      effectiveDate: "N/A",
      law: "No effective minimum wage legislation",
      sectors: [],
      history: [],
      livingWage: 0,
      livingWageFamily: 0,
    ...
    SS: {
      ...
      basis: "none",
      effectiveDate: "N/A",
      law: "Labour Act 2017 (minimum wage provision not implemented)",
      sectors: [],
      history: [],
      livingWage: 0,
      livingWageFamily: 0,
    ...
    LY: {
      ...
      monthly: 450,
      basis: "monthly",
      effectiveDate: "2014 (unchanged)",
      law: "Labour Law — Public Sector Salary Scale",
      sectors: [ {
        name: "Public Sector",
        rate: "LYD 450",
        period: "month"
    ...
    DZ: {
      ...
      law: "SNMG (Salaire National Minimum Garanti)",
      sectors: [ {
        name: "SNMG",
        rate: "DZD 20,000",
        period: "month"
    ...
    CD: {
      ...
      basis: "daily",
      dailyRate: 283,
      effectiveDate: "January 2018 (unchanged)",
      law: "Labour Code — Minimum Wage Decree",
      sectors: [ {
        name: "General",
        rate: "CDF 7,075 (or US$3.50)",
        period: "day"
      } ],
      history: [ {
        year: "2018",
    ...
    GQ: {
      ...
      monthly: 129035,
      basis: "monthly",
      effectiveDate: "2020 (unchanged)",
      law: "Minimum Wage Decree",
      sectors: [ {
        name: "General",
        rate: "FCFA 129,035",
        period: "month"
    ...
    ER: {
      ...
      monthly: 800,
      basis: "monthly",
      effectiveDate: "2003 (unchanged)",
      law: "Labour Proclamation",
      sectors: [ {
        name: "General",
        rate: "ERN 800",
        period: "month"
    ...
    rate: 85e3,
    effectiveDate: "October 2024",
    note: "Governor mandated higher floor"
  }, {
    code: "AB",
    name: "Abia State",
    rate: 7e4,
    ...
    basis: "hourly",
    effectiveDate: "March 2025",
    note: "Government relief workers — lower rate"
  } ], t = {
    NG: {
      baseYear: 2019,
      currency: "₦",
  ...
  var r = {
    getCountry: function(e) {
      ...
      var n = function(e) {
        var a, i, n = e.monthly || 0;
        return "monthly" === e.basis ? i = (a = n / 22) / 8 : "daily" === e.basis ? (a = e.dailyRate || n / 22,
        n || (n = 22 * a), i = a / 8) : "hourly" === e.basis ? (a = 8 * (i = e.hourlyRate || 0),
        n = e.monthly || 22 * a) : (n = 0, a = 0, i = 0), {
          monthly: n,
          daily: a,
          hourly: i
        };
      ...
      return {
        ...
        sectors: i.sectors || [],
        history: i.history || [],
        livingWage: i.livingWage || 0,
        livingWageFamily: i.livingWageFamily || 0,
        livingWageSource: i.livingWageSource || "",
        notes: i.notes || "",
        observation: i.observation || "",
        usdMonthly: o(n.monthly, e)
      };
    },
    getAllCountries: function(e) {
      for (var i = Object.keys(a), n = [], t = 0; t < i.length; t++) {
        var o = this.getCountry(i[t]);
        o && n.push(o);
      }
      var r = e || "usd";
      return n.sort(function(e, a) {
        return "usd" === r ? a.usdMonthly - e.usdMonthly : "local" === r ? a.monthly - e.monthly : "name" === r ? e.name.localeCompare(a.name) : "date" === r ? e.effectiveDate.localeCompare(a.effectiveDate) : a.usdMonthly - e.usdMonthly;
      }), n;
    },
    checkCompliance: function(e, a) {
      var i = this.getCountry(e);
      if (!i) {
        return {
      ...
      return {
        ...
        salary: a,
        minimum: i.monthly,
        diff: Math.abs(Math.round(n)),
        diffPct: Math.round(100 * Math.abs(n / i.monthly)),
        symbol: i.symbol,
        currency: i.currency,
        country: i.name,
        flag: i.flag,
    ...
    fmt: function(e, a) {
      if (null == e || isNaN(e) || 0 === e) {
        return "Not set";
      }
      var i = a || "";
      return e >= 1e6 ? i + (e / 1e6).toFixed(2) + "M" : e >= 1e4 || e >= 1e3 ? i + Math.round(e).toLocaleString("en") : i + e.toFixed(2);
    },
    toUSD: o
  };
  window.AfroTools = window.AfroTools || {}, window.AfroTools.MinWageEngine = r;
}(), function(e) {
  "use strict";
  var a = e.AfroTools && e.AfroTools.MinWageEngine, i = 30.23, n = Math.round(241.84 * 22);
  if (a) {
    var t = a.getCountry, o = a.getStateRates, r = a.getInflationData;
    a.getCountry = function(e) {
      var o = t.call(this, e);
      return o && "ZA" === e ? (o.monthly = n, o.daily = 241.84, o.hourly = i, o.effectiveDate = "March 2026",
      o.law = "National Minimum Wage Act (2018), amendment effective 1 March 2026", o.sectors = [ {
        name: "National Minimum Wage (General)",
        rate: "R30.23",
        period: "hour"
      }, {
        ...
        nominal: 4528,
        amount: "R21.69/hr"
      } ], o.notes = "South Africa raised the national minimum wage to R30.23/hour from 1 March 2026. EPWP workers remain under a separate dispensation at R16.62/hour.",
      o.observation = "South Africa's national minimum wage increased to R30.23/hour effective 1 March 2026. EPWP workers remain on a separate lower statutory rate of R16.62/hour. Non-compliance can attract underpayment orders, fines, and repeat-offence multipliers.",
      o.usdMonthly = a.toUSD(o.monthly, "ZA"), o) : o;
    }, a.getStateRates = function(e) {
      return "ZA" === e ? [ {
        code: "general",
        name: "National Minimum (General)",
        rate: i,
        ...
        basis: "hourly",
        effectiveDate: "March 2026",
        note: "Government relief workers - lower statutory rate"
      } ] : o.call(this, e);
    }, a.getInflationData = function(e) {
      var a = r.call(this, e);
      return "ZA" === e && a ? (a.points = [ {
        year: 2019,
        nominal: 3520,
        cpi: 100
      }, {
