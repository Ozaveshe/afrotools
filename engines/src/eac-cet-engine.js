var EacCetEngine = function() {
  ...
  var e = [ {
    ...
    authority: "NRA",
    flag: "🇸🇸",
    note: "Contact NRA for current rates"
  }, {
    code: "CD",
    name: "DR Congo",
    joined: 2022,
    ...
    process: [ {
      step: 1,
      title: "Register with Revenue Authority",
      detail: "Apply to national customs authority (KRA/TRA/URA/RRA/OBR) for Duty Remission status. Present business registration, manufacturing licence and premises details."
    }, {
      step: 2,
      title: "Submit Application with HS Codes",
      detail: "List all raw materials and inputs with their HS codes and estimated annual quantities. Provide the finished product HS code and intended market."
    }, {
      step: 3,
    ...
    cooRequirements: {
      ...
      criteria: [ "Wholly Obtained: Goods entirely grown, mined or manufactured in the EAC (e.g., fresh produce, minerals)", "Value Addition: At least 35% of the ex-factory price is value added within the EAC", "Change of Tariff Heading (CTH): The HS chapter or heading of the finished product differs from all non-EAC inputs", "Specific Process Rule: Certain goods (textiles, chemicals) must undergo specific processes within the EAC" ],
    ...
    UG: [ {
      ...
      name: "Withholding Tax (commercial)",
      rate: 6,
      base: "cif",
    ...
    RW: [ {
      name: "Infrastructure Development Surcharge",
      rate: 1.5,
      base: "cif"
    }, {
      name: "AU Levy",
    ...
    name: "Industrial Machinery (General)",
    hsChapter: 84,
    hsRange: "8479",
    cetRate: 0,
    band: 0,
    ...
    name: "Dairy Processing Equipment",
    hsChapter: 84,
    hsRange: "8434",
    cetRate: 0,
    band: 0,
    ...
    name: "Solar Panels (Photovoltaic)",
    hsChapter: 85,
    hsRange: "8541",
    cetRate: 0,
    band: 0,
    ...
    name: "Pharmaceutical Ingredients (API)",
    hsChapter: 29,
    hsRange: "2941",
    cetRate: 0,
    band: 0,
    ...
    name: "Synthetic Fibers (Polyester)",
    hsChapter: 54,
    hsRange: "5402",
    cetRate: 10,
    band: 10,
    ...
    name: "Flat-Rolled Steel (Hot Rolled)",
    hsChapter: 72,
    hsRange: "7208",
    cetRate: 10,
    band: 10,
    ...
    name: "Plastic Granules (Polyethylene)",
    hsChapter: 39,
    hsRange: "3901",
    cetRate: 10,
    band: 10,
    ...
    name: "Vegetable Oils (Crude Palm)",
    hsChapter: 15,
    hsRange: "1511",
    cetRate: 10,
    band: 10,
    ...
    name: "Commercial Trucks & Lorries",
    hsChapter: 87,
    hsRange: "8704",
    cetRate: 25,
    band: 25,
    ...
    name: "Mineral Water / Soft Drinks",
    hsChapter: 22,
    hsRange: "2202",
    cetRate: 25,
    band: 25,
    ...
    name: "Cigarettes & Tobacco Products",
    hsChapter: 24,
    hsRange: "2402",
    cetRate: 25,
    band: 25,
    ...
    name: "Steel Bars & Rods (Reinforcing)",
    hsChapter: 72,
    hsRange: "7214",
    cetRate: 25,
    band: 25,
    ...
    name: "Used Footwear (Second-hand)",
    hsChapter: 64,
    hsRange: "6404",
    cetRate: 35,
    band: 35,
    ...
    name: "Plastic Tableware & Kitchenware",
    hsChapter: 39,
    hsRange: "3924",
    cetRate: 35,
    band: 35,
    ...
    name: "Dairy Products (Milk/Cheese)",
    hsChapter: 4,
    hsRange: "0402",
    cetRate: 60,
    band: 35,
  ...
  return {
    search: function(e) {
      ...
      var a = e.trim().toLowerCase(), t = s.map(function(e) {
        var t = -1 !== e.name.toLowerCase().indexOf(a), n = -1 !== e.hsRange.indexOf(a), r = -1 !== e.category.toLowerCase().indexOf(a), s = -1 !== String(e.hsChapter).indexOf(a), i = 0;
        return e.name.toLowerCase().startsWith(a) ? i += 10 : t && (i += 6), e.hsRange.startsWith(a) ? i += 8 : n && (i += 4),
        r && (i += 2), s && (i += 1), {
          product: e,
          score: i
        };
    ...
    compareCountries: function(e, a) {
      ...
      return [ "KE", "TZ", "UG", "RW", "BI" ].map(function(s) {
        var o = i({
          cifValue: e,
          cetRate: a,
          countryCode: s
        ...
        return {
          ...
          leviesSubtotal: l,
          vat: o.vatAmount,
          totalLanded: o.totalLanded,
          effectiveRate: o.effectiveRate
        };
      });
    },
    getSensitiveItems: function() {
      return t;
    },
    ...
    getProductByHs: function(e) {
      var a = parseInt(e, 10);
      return s.find(function(e) {
        return e.hsChapter === a;
      }) || null;
    },
    PRODUCTS: s
  };
