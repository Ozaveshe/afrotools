var BusinessPlannerEngine = function() {
  function e(e, i, a, t, r, n, o, s, l, c, m, p, d, u, g, h, y) {
    return {
      name: e,
      currency: {
        code: i,
      ...
      registration: {
        ...
        types: [ {
          ...
          steps: [ "Obtain tax identification number from " + l, "Register business name with " + o, "Pay registration fee (" + a + (h || 0).toLocaleString() + ")", "Obtain certificate of registration", "Open business bank account" ]
        }, {
          ...
          steps: [ "Search and reserve company name with " + o, "Prepare Memorandum & Articles of Association", "File incorporation documents", "Pay registration fee (" + a + (y || 0).toLocaleString() + ")", "Receive Certificate of Incorporation", "Register for tax with " + l, "Register for VAT if applicable", "Open corporate bank account" ]
        } ]
      },
      tax: {
        authority: l,
        ...
        obligations: [ {
          ...
          name: "VAT",
          rate: d,
          applicableTo: [ "Ltd", "Sole Proprietorship" ],
          note: u ? "If turnover exceeds threshold" : ""
        } ],
        filingDeadlines: [ {
          tax: "CIT",
          deadline: "Within 3-6 months of financial year end"
        }, {
          tax: "VAT",
          deadline: "Monthly or quarterly, varies"
        } ]
      },
      licenses: {
        general: [ {
      ...
      banking: {
        majorBanks: g || [],
        accountRequirements: [ "Certificate of Registration/Incorporation", "Tax ID", "Directors' IDs", "Proof of address" ],
        estimatedTimeline: "3-10 business days"
      },
      startupCosts: {
        low: {
          range: a + "50,000 - " + a + "200,000",
          description: "Sole proprietorship, home-based"
        },
        medium: {
          range: a + "500,000 - " + a + "2,000,000",
          description: "Ltd company, small office, 1-5 employees"
        },
        high: {
          range: a + "5,000,000+",
          description: "Ltd company, commercial premises, industry licenses"
        }
      }
    };
  }
  var i = {
    NG: {
      ...
      tax: {
        ...
        obligations: [ {
          ...
          rate: "30% (large), 20% (medium), 0% (small < ₦25M)",
          applicableTo: [ "Ltd" ]
        }, {
          name: "Value Added Tax (VAT)",
          rate: "7.5%",
          applicableTo: [ "Ltd", "Sole Proprietorship" ],
          note: "If turnover > ₦25M per annum"
        }, {
          name: "Pay As You Earn (PAYE)",
          rate: "7% - 24% progressive",
          applicableTo: [ "Ltd" ],
      ...
      licenses: {
        ...
        byIndustry: {
          ...
          "Technology / Fintech": [ {
            ...
            note: "Required for payment processing, lending, banking"
          } ],
          "Import/Export": [ {
            name: "Import Duty Registration",
            authority: "Nigeria Customs Service",
            cost: "Varies",
            timeline: "14-30 days"
          }, {
            name: "SON Conformity Assessment",
            authority: "Standards Organisation of Nigeria",
          ...
          Education: [ {
            name: "Approval to Operate",
            authority: "State Ministry of Education",
            cost: "Varies by state",
            timeline: "3-12 months"
          } ],
          "Construction / Real Estate": [ {
            name: "Building Plan Approval",
            authority: "State Physical Planning Authority",
            cost: "Varies",
            timeline: "30-60 days"
          } ]
        }
      ...
      startupCosts: {
        low: {
          ...
          description: "Sole proprietorship, home-based, no employees"
        },
        medium: {
        ...
        high: {
          range: "₦5,000,000+",
          description: "Ltd company, commercial premises, 10+ employees, industry licenses"
        }
      }
    },
    GH: {
      ...
      tax: {
        ...
        obligations: [ {
          ...
          name: "VAT + NHIL + GETFund + COVID Levy",
          rate: "21.9% combined",
          applicableTo: [ "Ltd", "Sole Proprietorship" ],
          note: "If turnover > GH₵200,000"
        }, {
          name: "PAYE",
          rate: "0% - 35% progressive",
          applicableTo: [ "Ltd" ],
        ...
        filingDeadlines: [ {
          ...
          tax: "VAT",
          deadline: "Last working day of the month following"
        }, {
          tax: "PAYE",
      ...
      licenses: {
        general: [ {
          ...
          authority: "Metropolitan/Municipal Assembly",
          cost: "GH₵200 - GH₵5,000",
          timeline: "7-14 days"
        } ],
        byIndustry: {
          "Food & Beverage": [ {
            ...
            cost: "GH₵500 - GH₵5,000",
            timeline: "1-3 months"
          } ],
          "Technology / Fintech": [ {
            name: "Electronic Money Issuer License",
      ...
      startupCosts: {
        low: {
          range: "GH₵500 - GH₵5,000",
          description: "Sole proprietorship, home-based"
        },
        medium: {
          range: "GH₵10,000 - GH₵50,000",
          description: "Ltd company, small office, 1-5 employees"
        },
        high: {
          range: "GH₵100,000+",
          description: "Ltd with commercial premises and industry licenses"
        }
      }
    },
    SN: {
      ...
      registration: {
        ...
        types: [ {
          type: "Entreprise Individuelle (Sole Proprietorship)",
          registrationFee: 1e4,
          minCapital: 0,
          timeline: "2-5 days",
          ...
          type: "SARL (Société à Responsabilité Limitée)",
          registrationFee: 1e5,
          minCapital: 1e5,
          timeline: "5-14 days",
      ...
      tax: {
        ...
        obligations: [ {
          name: "Impôt sur les Sociétés (Corporate Tax)",
          rate: "30%",
          applicableTo: [ "SARL" ]
        }, {
          name: "Impôt sur le Revenu (Personal Income Tax)",
          rate: "0% - 40% progressive",
          applicableTo: [ "Sole Proprietorship" ]
        }, {
          name: "TVA (VAT)",
          rate: "18%",
          applicableTo: [ "SARL", "Sole Proprietorship" ],
          note: "If turnover > CFA 100M"
        }, {
          name: "PAYE / Retenue à la source",
          rate: "Progressive",
          applicableTo: [ "SARL" ],
          note: "If you have employees"
        }, {
          name: "Patente (Business Tax)",
          rate: "Varies by turnover",
          applicableTo: [ "SARL", "Sole Proprietorship" ]
        } ],
        filingDeadlines: [ {
          tax: "CIT",
      ...
      startupCosts: {
        low: {
          range: "CFA 50,000 - CFA 300,000",
          description: "Sole proprietorship, home-based"
        },
        medium: {
          range: "CFA 1,000,000 - CFA 5,000,000",
          description: "SARL, small office, 1-5 employees"
        },
        high: {
          range: "CFA 10,000,000+",
          description: "SARL, commercial premises, industry licenses"
        }
      }
    },
    CI: {
      ...
      tax: {
        ...
        obligations: [ {
          name: "BIC (Corporate Tax)",
          rate: "25%",
          applicableTo: [ "SARL" ]
        }, {
          name: "Personal Income Tax (IGR)",
          rate: "0% - 36% progressive",
          applicableTo: [ "Sole Proprietorship" ]
        }, {
          name: "TVA",
          rate: "18%",
          ...
          name: "Contribution Nationale (CN)",
          rate: "1.5% of turnover",
          applicableTo: [ "SARL" ],
          note: "If turnover > CFA 50M"
        } ],
        filingDeadlines: [ {
          tax: "BIC",
          deadline: "April 30 each year"
      ...
      banking: {
        majorBanks: [ "Société Générale CI", "Ecobank CI", "NSIA Banque", "Bank of Africa CI", "Oragroup" ],
        accountRequirements: [ "RCCM", "DFE", "Notarized statutes", "ID for signatories" ],
        estimatedTimeline: "3-7 business days"
      },
      startupCosts: {
        low: {
        ...
        medium: {
          range: "CFA 1,000,000 - CFA 5,000,000",
          description: "SARL, small office"
        },
        high: {
          range: "CFA 10,000,000+",
          description: "SARL, commercial premises"
        }
      }
    },
    ML: e("Mali", "XOF", "CFA", "West African CFA Franc", "French", "West Africa", "CEFORE (Centre de Facilitation des Entreprises)", "https://cefore.ml", "Direction Générale des Impôts (DGI)", "", "30%", "0% - 40% progressive", "18%", !0, [ "BMS", "Ecobank Mali", "Bank of Africa Mali", "BNDA" ], 15e3, 15e4),
    BF: e("Burkina Faso", "XOF", "CFA", "West African CFA Franc", "French", "West Africa", "CEFORE (Centre de Formalités des Entreprises)", "https://www.cefore.bf", "Direction Générale des Impôts", "", "27.5%", "0% - 25% progressive", "18%", !0, [ "Coris Bank", "Ecobank BF", "Bank of Africa BF", "Société Générale BF" ], 12e3, 1e5),
    NE: e("Niger", "XOF", "CFA", "West African CFA Franc", "French", "West Africa", "Maison de l'Entreprise", "", "Direction Générale des Impôts", "", "30%", "0% - 35% progressive", "19%", !0, [ "Bank of Africa Niger", "Ecobank Niger", "BIA Niger", "Sonibank" ], 1e4, 1e5),
    GN: e("Guinea", "GNF", "GNF", "Guinean Franc", "French", "West Africa", "APIP (Agence de Promotion des Investissements Privés)", "https://apip.gov.gn", "Direction Nationale des Impôts", "", "25%", "0% - 35% progressive", "18%", !0, [ "Ecobank Guinea", "BICIGUI", "Société Générale Guinea", "UBA Guinea" ], 5e5, 2e6),
    SL: e("Sierra Leone", "SLE", "Le", "Sierra Leonean Leone", "English", "West Africa", "Corporate Affairs Commission (OARG)", "https://ofrg.gov.sl", "National Revenue Authority (NRA)", "https://www.nra.gov.sl", "25%", "0% - 30% progressive", "15%", !0, [ "Sierra Leone Commercial Bank", "Rokel Commercial Bank", "Ecobank SL", "UBA SL" ], 5e4, 5e5),
    LR: e("Liberia", "LRD", "L$", "Liberian Dollar", "English", "West Africa", "Liberia Business Registry (LBR)", "https://lbr.gov.lr", "Liberia Revenue Authority (LRA)", "https://www.lra.gov.lr", "25%", "0% - 25% progressive", "10%", !0, [ "LBDI", "Ecobank Liberia", "UBA Liberia", "GT Bank Liberia" ], 5e3, 25e3),
    TG: e("Togo", "XOF", "CFA", "West African CFA Franc", "French", "West Africa", "Centre de Formalités des Entreprises (CFE)", "https://www.cfetogo.tg", "Office Togolais des Recettes (OTR)", "https://www.otr.tg", "27%", "0% - 35% progressive", "18%", !0, [ "Ecobank Togo", "UTB", "BTCI", "Oragroup" ], 12e3, 1e5),
    BJ: e("Benin", "XOF", "CFA", "West African CFA Franc", "French", "West Africa", "Guichet Unique de Formalisation des Entreprises (GUFE)", "https://monentreprise.bj", "Direction Générale des Impôts", "", "30%", "0% - 35% progressive", "18%", !0, [ "Bank of Africa Benin", "Ecobank Benin", "BGFI Benin", "UBA Benin" ], 12e3, 1e5),
    GM: e("Gambia", "GMD", "D", "Gambian Dalasi", "English", "West Africa", "Business Registration Office", "", "Gambia Revenue Authority (GRA)", "https://www.gra.gm", "27%", "0% - 30% progressive", "15%", !0, [ "Trust Bank Gambia", "Ecobank Gambia", "GT Bank Gambia", "Zenith Bank Gambia" ], 1e3, 5e3),
    GW: e("Guinea-Bissau", "XOF", "CFA", "West African CFA Franc", "Portuguese", "West Africa", "Guiché Único de Empresas", "", "Direcção-Geral das Contribuições e Impostos", "", "25%", "0% - 20% progressive", "17%", !0, [ "Ecobank Guinea-Bissau", "BAO", "Banco da União" ], 15e3, 1e5),
    CV: {
      name: "Cabo Verde",
      currency: {
        code: "CVE",
      ...
      registration: {
        ...
        types: [ {
          type: "Empresa em Nome Individual (Sole Proprietorship)",
          registrationFee: 5e3,
          minCapital: 0,
          timeline: "1-3 days",
      ...
      tax: {
        ...
        website: "",
        obligations: [ {
          name: "IRPC (Corporate Tax)",
          rate: "22%",
          applicableTo: [ "Lda" ]
        }, {
          name: "IUR (Personal Income Tax)",
          rate: "0% - 35% progressive",
          applicableTo: [ "Sole Proprietorship" ]
        }, {
          name: "IVA (VAT)",
          rate: "15%",
          applicableTo: [ "Lda", "Sole Proprietorship" ]
        } ],
        filingDeadlines: [ {
          tax: "IRPC",
          deadline: "By May 31 each year"
        }, {
          tax: "IVA",
      ...
      banking: {
        majorBanks: [ "BCA", "BI", "Caixa Económica de Cabo Verde", "BAI Cabo Verde" ],
        accountRequirements: [ "Commercial Registry certificate", "NIF", "ID for signatories" ],
        estimatedTimeline: "3-7 business days"
      },
      startupCosts: {
        low: {
          range: "Esc 20,000 - Esc 100,000",
          description: "Sole proprietorship, home-based"
        },
        medium: {
          range: "Esc 500,000 - Esc 2,000,000",
          description: "Lda, small office"
        },
        high: {
          range: "Esc 5,000,000+",
          description: "Lda, commercial premises"
        }
      }
    },
    MR: e("Mauritania", "MRU", "UM", "Mauritanian Ouguiya", "Arabic, French", "West Africa", "Guichet Unique", "", "Direction Générale des Impôts", "", "25%", "0% - 40% progressive", "16%", !0, [ "Banque Mauritanienne pour le Commerce International", "Société Générale Mauritanie", "Chinguittel Bank" ], 5e3, 5e4),
    KE: {
      name: "Kenya",
      currency: {
        code: "KES",
      ...
      tax: {
        ...
        obligations: [ {
          ...
          name: "Personal Income Tax",
          rate: "10% - 35% progressive",
          applicableTo: [ "Sole Proprietorship" ]
        }, {
          name: "VAT",
          rate: "16%",
          applicableTo: [ "Ltd", "Sole Proprietorship" ],
          note: "If turnover > KSh 5,000,000"
        }, {
          name: "PAYE",
          rate: "10% - 35% progressive",
          applicableTo: [ "Ltd" ],
          ...
          applicableTo: [ "Ltd" ],
          note: "For digital marketplace services"
        }, {
          name: "Withholding Tax",
          rate: "3% - 20%",
          applicableTo: [ "Ltd" ]
        ...
        filingDeadlines: [ {
          tax: "Corporation Tax",
          deadline: "6 months after end of accounting period"
        }, {
          tax: "VAT",
      ...
      licenses: {
        general: [ {
          ...
          cost: "KSh 5,000 - KSh 50,000",
          timeline: "7-14 days"
        } ],
        byIndustry: {
          "Food & Beverage": [ {
            name: "Food Hygiene License",
            authority: "Public Health Department",
            cost: "KSh 5,000 - KSh 20,000",
            timeline: "14-30 days"
          }, {
            name: "KEBS Standardization Mark",
            authority: "Kenya Bureau of Standards",
            cost: "KSh 10,000+",
            timeline: "1-3 months"
          } ],
          "Technology / Fintech": [ {
            name: "CBK Fintech License",
      ...
      startupCosts: {
        low: {
          range: "KSh 5,000 - KSh 50,000",
          description: "Sole proprietorship, home-based"
        },
        medium: {
          range: "KSh 100,000 - KSh 500,000",
          description: "Ltd, small office, 1-5 employees"
        },
        high: {
          range: "KSh 1,000,000+",
          description: "Ltd, commercial premises, industry licenses"
        }
      }
    },
    TZ: {
      ...
      tax: {
        ...
        obligations: [ {
          ...
          name: "Personal Income Tax",
          rate: "0% - 30% progressive",
          applicableTo: [ "Sole Proprietorship" ]
        }, {
          name: "VAT",
          rate: "18%",
          applicableTo: [ "Ltd", "Sole Proprietorship" ],
          note: "If turnover > TSh 200,000,000"
        }, {
          name: "PAYE",
          rate: "0% - 30% progressive",
          applicableTo: [ "Ltd" ],
      ...
      licenses: {
        general: [ {
          ...
          authority: "Municipal/City Council",
          cost: "TSh 50,000 - TSh 500,000",
          timeline: "7-14 days"
        } ],
        byIndustry: {}
      },
      banking: {
        majorBanks: [ "CRDB Bank", "NMB Bank", "Stanbic Tanzania", "Equity Bank Tanzania", "DTB" ],
        accountRequirements: [ "Certificate of Incorporation / Business Name", "TIN Certificate", "Directors' IDs", "Board Resolution (for Ltd)" ],
        estimatedTimeline: "1-5 business days"
      },
      startupCosts: {
        low: {
          range: "TSh 200,000 - TSh 1,000,000",
          description: "Sole proprietorship, home-based"
        },
        medium: {
          range: "TSh 5,000,000 - TSh 20,000,000",
          description: "Ltd, small office"
        },
        high: {
          range: "TSh 50,000,000+",
          description: "Ltd, commercial premises, industry licenses"
        }
      }
    },
    UG: {
      ...
      tax: {
        ...
        obligations: [ {
          ...
          name: "Personal Income Tax",
          rate: "10% - 40% progressive",
          applicableTo: [ "Sole Proprietorship" ]
        }, {
          name: "VAT",
          rate: "18%",
          applicableTo: [ "Ltd", "Sole Proprietorship" ],
          note: "If turnover > USh 150,000,000"
        }, {
          name: "PAYE",
          rate: "10% - 40% progressive",
          applicableTo: [ "Ltd" ],
      ...
      licenses: {
        general: [ {
          ...
          authority: "KCCA / District",
          cost: "USh 100,000 - USh 2,000,000",
          timeline: "7-14 days"
        } ],
        byIndustry: {}
      },
      banking: {
        majorBanks: [ "Stanbic Uganda", "ABSA Uganda", "Centenary Bank", "dfcu Bank", "Equity Bank Uganda" ],
        accountRequirements: [ "Certificate of Incorporation / Registration", "TIN", "Directors' IDs", "Board Resolution" ],
        estimatedTimeline: "1-5 business days"
      },
      startupCosts: {
        low: {
          range: "USh 200,000 - USh 1,000,000",
          description: "Sole proprietorship, home-based"
        },
        medium: {
          range: "USh 5,000,000 - USh 20,000,000",
          description: "Ltd, small office"
        },
        high: {
          range: "USh 50,000,000+",
          description: "Ltd, commercial premises"
        }
      }
    },
    RW: {
      ...
      tax: {
        ...
        obligations: [ {
          ...
          rate: "18%",
          applicableTo: [ "Ltd", "Sole Proprietorship" ],
          note: "If turnover > FRw 20,000,000"
        }, {
          name: "PAYE",
          rate: "0% - 30% progressive",
          applicableTo: [ "Ltd" ],
      ...
      banking: {
        majorBanks: [ "Bank of Kigali", "Equity Bank Rwanda", "I&M Bank Rwanda", "Access Bank Rwanda", "Cogebanque" ],
        accountRequirements: [ "Certificate of Incorporation", "TIN", "Directors' IDs" ],
        estimatedTimeline: "1-3 business days"
      },
      startupCosts: {
        low: {
          range: "FRw 50,000 - FRw 500,000",
          description: "Sole proprietorship, home-based"
        },
        medium: {
          range: "FRw 2,000,000 - FRw 10,000,000",
          description: "Ltd, small office"
        },
        high: {
          range: "FRw 30,000,000+",
          description: "Ltd, commercial premises"
        }
      }
    },
    ET: {
      ...
      tax: {
        ...
        obligations: [ {
          ...
          name: "VAT (TOT)",
          rate: "15%",
          applicableTo: [ "PLC", "Sole Proprietorship" ],
          note: "If turnover > ETB 1,000,000"
        }, {
          name: "PAYE",
          rate: "0% - 35% progressive",
          applicableTo: [ "PLC" ],
        ...
        filingDeadlines: [ {
          tax: "CIT",
          deadline: "Within 4 months of fiscal year end (Hamle 7 / Oct)"
        }, {
          tax: "VAT",
          deadline: "Monthly by end of month"
        } ]
      },
      licenses: {
        general: [ {
          ...
          name: "Business License",
          authority: "Regional Trade Bureau",
          cost: "ETB 1,000 - ETB 10,000",
          timeline: "7-14 days"
        } ],
        byIndustry: {}
      },
      banking: {
        majorBanks: [ "Commercial Bank of Ethiopia", "Dashen Bank", "Awash Bank", "Bank of Abyssinia", "Zemen Bank" ],
        accountRequirements: [ "Certificate of Incorporation", "TIN", "Directors' IDs", "Memorandum of Association" ],
        estimatedTimeline: "1-5 business days"
      },
      startupCosts: {
        low: {
          range: "ETB 10,000 - ETB 50,000",
          description: "Sole proprietorship, home-based"
        },
        medium: {
          range: "ETB 200,000 - ETB 1,000,000",
          description: "PLC, small office"
        },
        high: {
          range: "ETB 5,000,000+",
          description: "PLC, commercial premises"
        }
      }
    },
    BI: e("Burundi", "BIF", "FBu", "Burundian Franc", "Kirundi, French", "East Africa", "Agence de Promotion des Investissements (API)", "", "Office Burundais des Recettes (OBR)", "", "30%", "0% - 35% progressive", "18%", !0, [ "Bancobu", "BCB", "Ecobank Burundi", "KCB Burundi" ], 2e4, 2e5),
    SS: e("South Sudan", "SSP", "SSP", "South Sudanese Pound", "English", "East Africa", "Ministry of Justice — Business Registry", "", "National Revenue Authority (NRA)", "", "25%", "10% - 20% progressive", "18%", !0, [ "Equity Bank South Sudan", "KCB South Sudan", "Cooperative Bank of South Sudan" ], 5e3, 5e4),
    ER: e("Eritrea", "ERN", "Nfk", "Eritrean Nakfa", "Tigrinya, Arabic, English", "East Africa", "Ministry of Trade and Industry", "", "Inland Revenue Department", "", "30%", "2% - 30% progressive", "5%", !1, [ "Commercial Bank of Eritrea", "Housing and Commerce Bank of Eritrea" ], 5e3, 5e4),
    DJ: e("Djibouti", "DJF", "Fdj", "Djiboutian Franc", "French, Arabic", "East Africa", "Guichet Unique / ODPIC", "", "Direction des Impôts", "", "25%", "0% - 30% progressive", "10%", !0, [ "Banque pour le Commerce et l'Industrie", "Saba Islamic Bank", "CAC International Bank" ], 3e4, 2e5),
    SO: e("Somalia", "SOS", "Sh", "Somali Shilling", "Somali, Arabic", "East Africa", "Ministry of Commerce and Industry", "", "Federal Ministry of Finance", "", "No formal CIT system", "Variable", "10% (sales tax)", !1, [ "Dahabshiil", "Premier Bank", "Salaam Somali Bank", "Amal Bank" ], 5e4, 5e5),
    KM: e("Comoros", "KMF", "CF", "Comorian Franc", "Comorian, French, Arabic", "East Africa", "Tribunal de Commerce", "", "Direction Générale des Impôts", "", "35%", "0% - 30% progressive", "10%", !1, [ "Banque Fédérale de Commerce", "Banque de Développement des Comores", "Exim Bank Comoros" ], 5e4, 3e5),
    SC: {
      name: "Seychelles",
      currency: {
        code: "SCR",
      ...
      tax: {
        ...
        obligations: [ {
          name: "Business Tax",
          rate: "25% (first SCR 1M) / 33% above",
          applicableTo: [ "Ltd" ]
        }, {
          name: "Personal Income Tax",
          rate: "0% - 15% progressive",
          applicableTo: [ "Sole Proprietorship" ]
        }, {
          name: "VAT",
          rate: "15%",
          applicableTo: [ "Ltd", "Sole Proprietorship" ],
          note: "If turnover > SCR 5,000,000"
        } ],
        filingDeadlines: [ {
          tax: "Business Tax",
          deadline: "March 31 each year"
      ...
      licenses: {
        general: [ {
          ...
          name: "Trade License",
          authority: "Seychelles Licensing Authority",
          cost: "SR 1,000 - SR 10,000",
          timeline: "7-14 days"
        } ],
        byIndustry: {}
      },
      banking: {
        majorBanks: [ "Seychelles Commercial Bank", "Nouvobanq", "BMI Bank", "Absa Seychelles" ],
        accountRequirements: [ "Certificate of Incorporation", "TIN", "ID for signatories" ],
        estimatedTimeline: "3-7 business days"
      },
      startupCosts: {
        low: {
          range: "SR 5,000 - SR 25,000",
          description: "Sole proprietorship, home-based"
        },
        medium: {
          range: "SR 100,000 - SR 500,000",
          description: "Ltd, small office"
        },
        high: {
          range: "SR 1,000,000+",
    ...
    MU: {
      ...
      tax: {
        ...
        obligations: [ {
          ...
          rate: "15% flat",
          applicableTo: [ "Sole Proprietorship" ],
          note: "First Rs 325,000 exempt"
        }, {
          name: "VAT",
          rate: "15%",
          applicableTo: [ "Ltd", "Sole Proprietorship" ],
          note: "If turnover > Rs 6,000,000"
        }, {
          name: "CSG (Social Contribution)",
          rate: "1.5% (employee) - 3% (employer)",
          applicableTo: [ "Ltd" ]
        } ],
        filingDeadlines: [ {
          tax: "CIT",
      ...
      licenses: {
        general: [ {
          ...
          cost: "Rs 1,000 - Rs 10,000",
          timeline: "7-14 days"
        } ],
        byIndustry: {}
      },
      banking: {
        majorBanks: [ "MCB", "SBM", "ABSA Mauritius", "AfrAsia Bank", "Bank One" ],
        accountRequirements: [ "Certificate of Incorporation", "TAN", "Directors' IDs", "Constitution" ],
        estimatedTimeline: "1-5 business days"
      },
      startupCosts: {
        low: {
          range: "Rs 10,000 - Rs 50,000",
          description: "Sole proprietorship, home-based"
        },
        medium: {
          range: "Rs 200,000 - Rs 1,000,000",
          description: "Ltd, small office"
        },
        high: {
          range: "Rs 5,000,000+",
    ...
    EG: {
      ...
      registration: {
        ...
        types: [ {
          type: "Sole Proprietorship (Individual Enterprise)",
          registrationFee: 500,
          minCapital: 0,
          timeline: "3-7 days",
      ...
      tax: {
        ...
        obligations: [ {
          ...
          name: "Personal Income Tax",
          rate: "0% - 27.5% progressive",
          applicableTo: [ "Sole Proprietorship" ]
        }, {
          name: "VAT",
          rate: "14%",
          applicableTo: [ "LLC", "Sole Proprietorship" ],
          note: "Standard rate; some goods/services exempt"
        }, {
          name: "Social Insurance",
          rate: "18.75% employer + 11% employee",
          applicableTo: [ "LLC" ]
        }, {
          name: "Stamp Tax",
          rate: "0.225% - 0.9%",
        ...
        filingDeadlines: [ {
          ...
          tax: "PAYE",
          deadline: "Within 15 days of end of month"
        } ]
      },
      licenses: {
        general: [ {
          ...
          authority: "Egyptian Chamber of Commerce",
          cost: "E£500 - E£2,000",
          timeline: "1-3 days"
        } ],
        byIndustry: {
          ...
          "Technology / Fintech": [ {
            name: "Fintech License",
            authority: "Financial Regulatory Authority (FRA) or CBE",
            cost: "Varies",
            timeline: "6-12 months"
          } ]
        }
      ...
      banking: {
        majorBanks: [ "National Bank of Egypt", "Banque Misr", "Commercial International Bank (CIB)", "QNB Alahli", "HSBC Egypt" ],
        accountRequirements: [ "Commercial register extract", "Tax card", "National ID for all signatories", "Company Articles of Association", "Power of attorney for authorized signatories" ],
        estimatedTimeline: "3-7 business days"
      },
      startupCosts: {
        low: {
          range: "E£5,000 - E£20,000",
          description: "Sole proprietorship, home-based"
        },
        medium: {
          range: "E£50,000 - E£200,000",
          description: "LLC, small office, 1-5 employees"
        },
        high: {
          range: "E£500,000+",
          description: "LLC, commercial premises, industry licenses"
        }
      }
    },
    MA: {
      ...
      tax: {
        ...
        obligations: [ {
          ...
          rate: "10% - 31% progressive (based on profit)",
          applicableTo: [ "SARL" ]
        }, {
          name: "IR (Income Tax)",
          rate: "0% - 38% progressive",
          applicableTo: [ "Sole Proprietorship" ]
        }, {
          name: "TVA (VAT)",
          rate: "20% standard",
          applicableTo: [ "SARL", "Sole Proprietorship" ],
          note: "Reduced rates: 7%, 10%, 14% for some goods/services"
        }, {
          name: "CNSS (Social Security)",
          rate: "4.48% employee + 12.89% employer",
          applicableTo: [ "SARL" ]
        } ],
        filingDeadlines: [ {
          tax: "IS",
          ...
          tax: "TVA",
          deadline: "Monthly by 20th or quarterly"
        } ]
      },
      licenses: {
        general: [ {
      ...
      banking: {
        majorBanks: [ "Attijariwafa Bank", "BMCE Bank of Africa", "Banque Populaire", "CIH Bank", "Société Générale Maroc" ],
        accountRequirements: [ "RC extract", "Tax ID", "Company statutes", "ID for signatories" ],
        estimatedTimeline: "1-5 business days"
      },
      startupCosts: {
        low: {
          range: "MAD 1,000 - MAD 10,000",
          description: "Auto-entrepreneur, home-based"
        },
        medium: {
          range: "MAD 50,000 - MAD 200,000",
          description: "SARL, small office"
        },
        high: {
          range: "MAD 500,000+",
    ...
    DZ: e("Algeria", "DZD", "DA", "Algerian Dinar", "Arabic, French", "North Africa", "Centre National du Registre de Commerce (CNRC)", "https://www.cnrc.dz", "Direction Générale des Impôts (DGI)", "https://www.mfdgi.gov.dz", "19% (26% for some sectors)", "0% - 35% progressive", "19%", !0, [ "BNA", "BEA", "CPA", "Société Générale Algérie", "Gulf Bank Algeria" ], 5e3, 1e5),
    TN: {
      name: "Tunisia",
      currency: {
        code: "TND",
      ...
      tax: {
        ...
        obligations: [ {
          name: "IS (Corporate Tax)",
          rate: "15% (standard), 25% for some sectors",
          applicableTo: [ "SARL" ]
        }, {
          name: "IRPP (Personal Income Tax)",
          rate: "0% - 35% progressive",
          applicableTo: [ "Sole Proprietorship" ]
        }, {
          name: "TVA",
          rate: "19%",
          applicableTo: [ "SARL", "Sole Proprietorship" ],
          note: "Reduced rates 7% and 13% for some items"
        }, {
          name: "CNSS",
          rate: "9.18% employee + 16.57% employer",
          applicableTo: [ "SARL" ]
        } ],
        filingDeadlines: [ {
          tax: "IS",
          deadline: "March 25 each year"
        }, {
          tax: "TVA",
          deadline: "Monthly by 28th"
        } ]
      },
      licenses: {
        general: [ {
          name: "Tax ID (Identifiant Fiscal)",
          authority: "DGI",
          cost: "Free",
          timeline: "1-3 days"
        } ],
      ...
      banking: {
        majorBanks: [ "BIAT", "Banque de Tunisie", "Amen Bank", "Attijari Bank", "STB" ],
        accountRequirements: [ "RNE extract", "Tax ID", "Statutes", "CIN for signatories" ],
        estimatedTimeline: "3-7 business days"
      },
      startupCosts: {
        low: {
          range: "TND 500 - TND 5,000",
          description: "Sole proprietorship, home-based"
        },
        medium: {
          range: "TND 20,000 - TND 100,000",
          description: "SARL, small office"
        },
        high: {
          range: "TND 200,000+",
    ...
    LY: e("Libya", "LYD", "LD", "Libyan Dinar", "Arabic", "North Africa", "Ministry of Economy and Trade", "", "Tax Authority of Libya", "", "20%", "5% - 15% progressive", "No general VAT", !1, [ "Bank of Commerce & Development", "Wahda Bank", "Jumhouria Bank", "National Commercial Bank" ], 500, 5e3),
    SD: e("Sudan", "SDG", "SDG", "Sudanese Pound", "Arabic, English", "North Africa", "Commercial Registrar General", "", "Taxation Chamber", "", "15% - 30%", "0% - 15% progressive", "17%", !0, [ "Bank of Khartoum", "Faisal Islamic Bank", "Omdurman National Bank", "Farmer's Bank" ], 5e3, 5e4),
    ZA: {
      name: "South Africa",
      currency: {
        code: "ZAR",
      ...
      registration: {
        ...
        types: [ {
          ...
          registrationFee: 0,
          minCapital: 0,
          timeline: "Immediate (no formal registration required)",
      ...
      tax: {
        ...
        obligations: [ {
          name: "Corporate Income Tax",
          rate: "27%",
          applicableTo: [ "Pty Ltd" ]
        }, {
          name: "Personal Income Tax",
          rate: "18% - 45% progressive",
          applicableTo: [ "Sole Proprietorship" ]
        }, {
          name: "VAT",
          rate: "15%",
          applicableTo: [ "Pty Ltd", "Sole Proprietorship" ],
          note: "Mandatory if turnover > R1,000,000"
        }, {
          name: "PAYE",
          rate: "18% - 45% progressive",
          applicableTo: [ "Pty Ltd" ],
          ...
          applicableTo: [ "Pty Ltd" ],
          note: "If annual payroll > R500,000"
        }, {
          name: "Unemployment Insurance Fund (UIF)",
          rate: "2% (1% employer + 1% employee)",
          applicableTo: [ "Pty Ltd" ]
        }, {
          name: "Dividends Tax",
          rate: "20%",
      ...
      licenses: {
        general: [ {
          ...
          authority: "Accredited verification agency",
          cost: "R500 - R30,000",
          timeline: "14-30 days",
          note: "Important for government contracts"
        } ],
        byIndustry: {
          "Food & Beverage": [ {
          ...
          "Technology / Fintech": [ {
            name: "Financial Service Provider License",
      ...
      banking: {
        ...
        accountRequirements: [ "CIPC Registration Certificate", "Company MOI", "Director’s ID documents", "Proof of business address", "SARS Tax Number" ],
        estimatedTimeline: "1-5 business days"
      },
      startupCosts: {
        low: {
        ...
        medium: {
          range: "R20,000 - R100,000",
          description: "Pty Ltd, small office, 1-5 employees"
        },
        high: {
          range: "R500,000+",
          description: "Pty Ltd, commercial premises, industry licenses, B-BBEE"
        }
      }
    },
    BW: {
      ...
      registration: {
        ...
        types: [ {
          ...
          type: "Private Limited Company (Pty)",
          registrationFee: 300,
          minCapital: 1,
          timeline: "5-14 days",
      ...
      tax: {
        ...
        obligations: [ {
          ...
          name: "VAT",
          rate: "14%",
          applicableTo: [ "Pty", "Sole Proprietorship" ],
          note: "If turnover > P1,000,000"
        } ],
        filingDeadlines: [ {
          tax: "CIT",
      ...
      banking: {
        majorBanks: [ "First National Bank Botswana", "Barclays/Absa Botswana", "Stanbic Botswana", "Standard Chartered Botswana", "Bank of Botswana" ],
        accountRequirements: [ "Certificate of Incorporation", "TIN", "Directors' IDs", "Constitution" ],
        estimatedTimeline: "1-5 business days"
      },
      startupCosts: {
        low: {
          range: "P1,000 - P10,000",
          description: "Sole proprietorship, home-based"
        },
        medium: {
          range: "P50,000 - P200,000",
          description: "Pty, small office"
        },
        high: {
          range: "P500,000+",
          description: "Pty, commercial premises"
        }
      }
    },
    NA: e("Namibia", "NAD", "N$", "Namibian Dollar", "English", "Southern Africa", "Business and Intellectual Property Authority (BIPA)", "https://www.bipa.na", "Namibia Revenue Agency (NamRA)", "https://www.namra.org.na", "32%", "0% - 37% progressive", "15%", !0, [ "FNB Namibia", "Standard Bank Namibia", "Bank Windhoek", "Nedbank Namibia" ], 100, 350),
    ZM: {
      name: "Zambia",
      currency: {
        code: "ZMW",
      ...
      tax: {
        ...
        obligations: [ {
          ...
          name: "Personal Income Tax",
          rate: "0% - 37.5% progressive",
          applicableTo: [ "Sole Proprietorship" ]
        }, {
          name: "VAT",
          rate: "16%",
          applicableTo: [ "Ltd", "Sole Proprietorship" ],
          note: "If turnover > ZMW 800,000"
        }, {
          name: "PAYE",
          rate: "0% - 37.5% progressive",
          applicableTo: [ "Ltd" ],
        ...
        filingDeadlines: [ {
          tax: "CIT",
          deadline: "June 21 each year"
        }, {
          tax: "VAT",
          deadline: "18th of the following month"
        } ]
      },
      licenses: {
        general: [ {
      ...
      banking: {
        majorBanks: [ "Zanaco", "Stanbic Zambia", "ABSA Zambia", "Standard Chartered Zambia", "FNB Zambia" ],
        accountRequirements: [ "Certificate of Incorporation", "TPIN", "Directors' IDs", "Board Resolution" ],
        estimatedTimeline: "1-5 business days"
      },
      startupCosts: {
        low: {
          range: "ZK 1,000 - ZK 10,000",
          description: "Sole proprietorship, home-based"
        },
        medium: {
          range: "ZK 50,000 - ZK 200,000",
          description: "Ltd, small office"
        },
        high: {
          range: "ZK 500,000+",
    ...
    ZW: e("Zimbabwe", "ZWG", "ZiG", "Zimbabwe Gold", "English, Shona, Ndebele", "Southern Africa", "Companies and Deeds Registry (CIPC)", "https://www.dcip.gov.zw", "Zimbabwe Revenue Authority (ZIMRA)", "https://www.zimra.co.zw", "24.72% (incl. AIDS levy)", "0% - 40% progressive", "15%", !0, [ "CBZ Bank", "FBC Bank", "Stanbic Zimbabwe", "NMB Bank", "Steward Bank" ], 50, 200),
    MW: e("Malawi", "MWK", "MK", "Malawian Kwacha", "English, Chichewa", "Southern Africa", "Department of Registrar General", "https://www.registrargeneral.gov.mw", "Malawi Revenue Authority (MRA)", "https://www.mra.mw", "30%", "0% - 35% progressive", "16.5%", !0, [ "National Bank of Malawi", "Standard Bank Malawi", "FDH Bank", "NBS Bank" ], 2e3, 2e4),
    MZ: e("Mozambique", "MZN", "MT", "Mozambican Metical", "Portuguese", "Southern Africa", "Balição de Atendimento Único (BAU) / CRE", "https://www.portaldogoverno.gov.mz", "Autoridade Tributária (AT)", "", "32%", "10% - 32% progressive", "16%", !0, [ "Millennium bim", "Standard Bank Moçambique", "BCI", "Absa Moçambique" ], 5e3, 5e4),
    AO: e("Angola", "AOA", "Kz", "Angolan Kwanza", "Portuguese", "Southern Africa", "Guichê Único da Empresa (GUE)", "https://gue.gov.ao", "Administração Geral Tributária (AGT)", "https://www.agt.minfin.gov.ao", "25%", "0% - 25% progressive (IRT)", "14%", !0, [ "BAI", "BFA", "BIC", "Standard Bank Angola", "Banco Millennium Atlantico" ], 2e4, 2e5),
    SZ: e("Eswatini", "SZL", "E", "Swazi Lilangeni", "English, siSwati", "Southern Africa", "Registrar of Companies", "", "Eswatini Revenue Authority (SRA)", "https://www.sra.org.sz", "27.5%", "20% - 33% progressive", "15%", !0, [ "Standard Bank Eswatini", "FNB Eswatini", "Nedbank Eswatini" ], 500, 2500),
    LS: e("Lesotho", "LSL", "L", "Lesotho Loti", "English, Sesotho", "Southern Africa", "Registrar of Companies", "", "Lesotho Revenue Authority (LRA)", "https://www.lra.org.ls", "25%", "20% - 30% progressive", "15%", !0, [ "Standard Lesotho Bank", "FNB Lesotho", "Nedbank Lesotho" ], 300, 1500),
    MG: e("Madagascar", "MGA", "Ar", "Malagasy Ariary", "Malagasy, French", "Southern Africa", "EDBM (Economic Development Board of Madagascar)", "https://www.edbm.mg", "Direction Générale des Impôts", "", "20%", "0% - 20% progressive", "20%", !0, [ "BFV-SG", "BOA Madagascar", "BNI Madagascar", "Access Banque" ], 5e4, 5e5),
    CD: e("DR Congo", "CDF", "FC", "Congolese Franc", "French", "Central Africa", "Guichet Unique de Création d'Entreprises (GUCE)", "https://www.guichetunique.cd", "Direction Générale des Impôts (DGI)", "", "30%", "0% - 40% progressive", "16%", !0, [ "Rawbank", "Equity BCDC", "TMB", "FBN Bank DRC", "Access Bank DRC" ], 5e4, 5e5),
    CG: e("Republic of Congo", "XAF", "FCFA", "Central African CFA Franc", "French", "Central Africa", "Centre de Formalités des Entreprises (CFE)", "", "Direction Générale des Impôts et Domaines", "", "28%", "1% - 40% progressive", "18.9%", !0, [ "BGFI Bank Congo", "Société Générale Congo", "LCB Bank", "UBA Congo" ], 5e4, 3e5),
    CM: {
      name: "Cameroon",
      currency: {
        code: "XAF",
      ...
      tax: {
        ...
        obligations: [ {
          name: "IS (Corporate Tax)",
          rate: "30% + 10% surcharge = 33%",
          applicableTo: [ "SARL" ]
        }, {
          name: "IRPP (Personal Income Tax)",
          rate: "10% - 38.5% progressive",
          applicableTo: [ "Sole Proprietorship" ]
        }, {
          name: "TVA",
          rate: "19.25%",
          ...
          name: "CNPS",
          rate: "4.2% employee + 11.2% employer",
          applicableTo: [ "SARL" ]
        } ],
        filingDeadlines: [ {
          tax: "IS",
      ...
      banking: {
        majorBanks: [ "Afriland First Bank", "BGFI Cameroon", "Société Générale Cameroun", "Ecobank Cameroon", "UBA Cameroon" ],
        accountRequirements: [ "RCCM", "NIU", "Notarized statutes", "ID for signatories" ],
        estimatedTimeline: "3-7 business days"
      },
      startupCosts: {
        low: {
          range: "FCFA 100,000 - FCFA 500,000",
          description: "Sole proprietorship, home-based"
        },
        medium: {
          range: "FCFA 2,000,000 - FCFA 10,000,000",
          description: "SARL, small office"
        },
        high: {
          range: "FCFA 25,000,000+",
          description: "SARL, commercial premises"
        }
      }
    },
    GA: e("Gabon", "XAF", "FCFA", "Central African CFA Franc", "French", "Central Africa", "Agence Nationale de Promotion des Investissements (ANPI)", "https://www.anpi-gabon.com", "Direction Générale des Impôts", "", "30%", "0% - 35% progressive", "18%", !0, [ "BGFI Bank", "UBA Gabon", "Orabank Gabon", "Ecobank Gabon" ], 5e4, 3e5),
    GQ: e("Equatorial Guinea", "XAF", "FCFA", "Central African CFA Franc", "Spanish, French", "Central Africa", "Ministry of Commerce / CCGE", "", "Direction Générale des Impôts", "", "25%", "0% - 35% progressive", "15%", !1, [ "BGFI Bank GQ", "CCEI Bank", "Banco Nacional de Guinea Ecuatorial" ], 1e5, 5e5),
    TD: e("Chad", "XAF", "FCFA", "Central African CFA Franc", "French, Arabic", "Central Africa", "Agence Nationale des Investissements et des Exportations (ANIE)", "", "Direction Générale des Impôts", "", "35%", "0% - 60% progressive", "18%", !0, [ "Ecobank Chad", "Société Générale Tchad", "UBA Chad", "Commercial Bank Tchad" ], 3e4, 2e5),
    CF: e("Central African Republic", "XAF", "FCFA", "Central African CFA Franc", "French, Sango", "Central Africa", "Guichet Unique des Opérations du Commerce Extérieur", "", "Direction Générale des Impôts et Contributions", "", "30%", "0% - 50% progressive", "19%", !1, [ "Ecobank RCA", "BSIC", "Commercial Bank Centrafrique" ], 2e4, 2e5),
    ST: e("São Tomé and Príncipe", "STN", "Db", "São Toméan Dobra", "Portuguese", "Central Africa", "Conservatória do Registo Comercial", "", "Direcção dos Impostos", "", "25%", "0% - 25% progressive", "15%", !1, [ "BISTP", "Afriland First Bank STP", "Ecobank STP" ], 1e4, 1e5)
  }, a = [ "Agriculture & Agribusiness", "Technology / Fintech", "Food & Beverage", "Retail & E-commerce", "Import/Export & Trading", "Healthcare", "Education", "Construction / Real Estate", "Transportation & Logistics", "Manufacturing", "Tourism & Hospitality", "Creative & Media", "Mining & Natural Resources", "Professional Services (Consulting, Legal, Accounting)", "Energy & Utilities", "Other" ];
  return {
    ...
    generateActionPlan: function(e) {
      var a = e.countryCode, t = e.businessType, r = e.industry, n = e.hasEmployees, o = (e.estimatedRevenue,
      i[a]);
      if (!o) {
        return {
      ...
      for (var s = null, l = 0; l < o.registration.types.length; l++) {
        if (-1 !== o.registration.types[l].type.toLowerCase().indexOf(t.toLowerCase())) {
          s = o.registration.types[l];
          break;
        }
      }
      s || (s = o.registration.types[0]);
      for (var c = [], m = 0; m < o.tax.obligations.length; m++) {
        for (var p = o.tax.obligations[m], d = !1, u = 0; u < p.applicableTo.length; u++) {
          if (-1 !== s.type.indexOf(p.applicableTo[u]) || -1 !== p.applicableTo[u].indexOf("Sole") && -1 !== s.type.indexOf("Sole") || -1 !== p.applicableTo[u].indexOf("Sole") && -1 !== s.type.indexOf("Individu")) {
            d = !0;
            break;
          }
        }
        p.note && -1 !== p.note.indexOf("employees") && !n || d && c.push(p);
      }
      return {
        country: o.name,
        countryCode: a,
        ...
        phase1_registration: {
          ...
          authority: o.registration.authority,
          website: o.registration.website,
          portalUrl: o.registration.portalUrl || "",
          steps: s.steps,
          requirements: s.requirements,
          estimatedCost: s.registrationFee,
          estimatedTimeline: s.timeline
        },
        phase2_tax: {
          title: "Tax Registration & Compliance",
          authority: o.tax.authority,
          website: o.tax.website,
          applicableTaxes: c,
          filingDeadlines: o.tax.filingDeadlines
        },
        phase3_licenses: {
          title: "Licenses & Permits",
          generalLicenses: o.licenses.general,
          industryLicenses: o.licenses.byIndustry && o.licenses.byIndustry[r] || [],
          note: r && o.licenses.byIndustry && !o.licenses.byIndustry[r] ? 'Industry-specific license data for "' + r + '" in ' + o.name + " not yet available. The AI advisor can help research this." : null
        },
        phase4_banking: {
          title: "Business Banking",
          recommendedBanks: o.banking.majorBanks,
          requirements: o.banking.accountRequirements,
          estimatedTimeline: o.banking.estimatedTimeline
        },
        costEstimate: o.startupCosts,
        generated: (new Date).toISOString(),
        disclaimer: "This action plan is based on publicly available information about business registration in " + o.name + ". Regulations change frequently. Always verify current requirements with " + o.registration.authority + " and " + o.tax.authority + " before proceeding."
      };
    }
  };
}();

"undefined" != typeof module && module.exports && (module.exports = BusinessPlannerEngine);
