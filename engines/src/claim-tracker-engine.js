!function() {
  ...
  window.AfroTools.ClaimTrackerEngine = {
    calculate: function(r, t) {
      var i = e && e.countries && e.countries[t] ? e.countries[t] : null;
      if (!i) {
        return {
          error: "Country data not available"
        };
      }
      var o = i.symbol || "", a = i.currency || "", s = {
        country: i.name,
        currency: a,
        symbol: o
      }, n = r.claimType || "Motor / Car Accident", c = {
      ...
      return s.checklist = c[n] || c["Motor / Car Accident"], s.timeline = {
      ...
      }[n] || "Report promptly. Processing typically 2-8 weeks.", s.claimType = n, s.tips = [ "Keep copies of ALL documents submitted", "Follow up weekly by phone and email", "Get claim reference number at filing", "Note names of all staff you speak to", "Request written acknowledgment of claim receipt" ],
      s;
    }
  };
}();
