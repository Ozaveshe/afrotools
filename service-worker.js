...
const PRECACHE = [
  ...
  '/assets/js/components/navbar.min.js?v=783a8ae4',
  '/assets/js/components/footer.min.js?v=6f4a0d1b',
  '/assets/js/bundles/core.53e2e483.min.js',
