...
const PRECACHE = [
  ...
  '/assets/js/components/navbar.min.js?v=65f906d7',
  '/assets/js/components/footer.min.js?v=fb81e3cd',
  '/assets/js/bundles/core.b94ab182.min.js',
