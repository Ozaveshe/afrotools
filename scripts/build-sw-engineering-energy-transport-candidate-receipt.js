...
const receipt = {
  ...
  outcome: {
    ...
    byCategory: {
      engineering: { denominator: 20, acceptedCandidates: 10, blocked: 10 },
  ...
  proof: {
    ...
    browser: ["tests/e2e/sw-engineering-energy-transport-candidate.spec.js", "tests/e2e/sw-engineering-materials-parity.spec.js", "tests/e2e/sw-boq-builder-parity.spec.js", "tests/e2e/sw-structural-screening-parity.spec.js", "tests/e2e/sw-electrical-load-parity.spec.js", "tests/e2e/sw-paint-parity.spec.js", "tests/e2e/sw-transport-cost-parity.spec.js"],
    browserMatrix: "54 physical routes at 320px, 375px and 640px/200% reflow; 17 deep Energy workflows; 10 deep Engineering workflows plus English regressions; fleet-fuel, vehicle-operating-cost and truck-load deep Swahili and English regressions; car-import focused invalid/reset/privacy flow.",
...
if (accepted.length !== 30 || blocked.length !== 25) throw new Error(`Expected 30 accepted candidates and 25 blocked; received ${accepted.length}/${blocked.length}.`);
...
Status: **30 accepted candidates / 25 blocked / exact denominator 55**. This receipt does not edit or imply coordinator acceptance.

## Outcome

| Category | Denominator | Accepted candidate | Blocked |
|---|---:|---:|---:|
| Engineering & Construction | 20 | 10 | 10 |
...
- Concrete, tiles, water-tank, rebar and paint now share \`assets/js/engines/engineering-materials-engine.js\` with their English routes. Exact constants, geometry, unit conversions and calculation boundaries have oracle fixtures; after the solar, building-cost, BOQ Builder, structural-screening and electrical-load additions, the remaining 10 Engineering IDs stay fail-closed.
