...
<afro-footer></afro-footer>${locale === 'sw' ? '<script src="/assets/js/lib/sw-accessibility.js" defer></script>' : ''}<script src="/blog/assets/js/blog-reading.js?v=${blogReadingVersion}" defer></script><script src="/assets/js/lazy-analytics.js?v=${analyticsVersion}" defer></script>
</body></html>
`;
}
