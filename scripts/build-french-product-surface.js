...
function output(rel, value) {
  ...
  if (POST_PROCESSED_HTML.has(rel)) {
    ...
    if (current.includes(`name="afrotools-source-hash" content="${sourceHash}"`)) return;
  }
...
<title>Calculateurs Afrique francophone | AfroTools</title><meta name="description" content="Calculez votre salaire net, la TVA, vos conversions de devises et vos documents selon le pays. Outils gratuits, sources et hypothèses visibles.">
<meta property="og:type" content="website"><meta property="og:locale" content="fr_FR"><meta property="og:url" content="https://afrotools.com/fr/"><meta property="og:title" content="Calculateurs Afrique francophone | AfroTools"><meta property="og:description" content="Salaire net, TVA, devises, factures et PDF : ouvrez un outil en français avec ses sources et ses limites."><meta property="og:image" content="https://afrotools.com/assets/img/og/og-home-v2.webp"><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title" content="Calculateurs Afrique francophone | AfroTools"><meta name="twitter:description" content="Des outils en français pour calculer, vérifier et préparer vos décisions selon le pays."><meta name="twitter:image" content="https://afrotools.com/assets/img/og/og-home-v2.webp">
...
<div class="fr-actions"><a class="fr-btn" href="/fr/all-tools/">Trouver un outil</a><a class="fr-btn alt" href="/fr/countries/">Choisir mon pays</a></div>
<p class="fr-proof-line"><strong data-registry-count="tools.locale.fr.published">1 452</strong> outils publiés en français, avec une profondeur qui varie selon le pays.</p></div></section>
...
<section class="fr-section"><div class="fr-wrap"><p class="fr-eyebrow">Outils à ouvrir directement</p><h2>Quatre parcours utiles, entièrement en français</h2><p class="fr-intro">Commencez par votre décision. Chaque page explique la méthode, les hypothèses et ce qui doit encore être vérifié.</p><div class="fr-grid fr-featured">
<a class="fr-card" href="/fr/senegal/calculateur-salaire-net"><strong>Salaire net au Sénégal</strong><p>Estimez le brut, les retenues et le net dans le contexte sénégalais.</p><em>Ouvrir le calculateur →</em></a>
<a class="fr-card" href="/fr/cote-divoire/calculateur-tva"><strong>TVA en Côte d’Ivoire</strong><p>Passez du HT au TTC ou retirez la TVA avec les contrôles de traitement affichés.</p><em>Ouvrir le calculateur →</em></a>
<a class="fr-card" href="/fr/tools/generateur-factures/"><strong>Créer une facture</strong><p>Préparez une facture locale, choisissez votre devise et saisissez un taux vérifié.</p><em>Créer une facture →</em></a>
<a class="fr-card" href="/fr/tools/convertisseur-devises/"><strong>Convertir avec un taux daté</strong><p>Comparez une conversion indicative avec le taux et les frais de votre prestataire.</p><em>Ouvrir le convertisseur →</em></a></div></div></section>
...
<section class="fr-section"><div class="fr-wrap"><p class="fr-eyebrow">Confiance</p><h2>Comprendre avant de décider</h2><div class="fr-trust"><article><h3>Formules et hypothèses visibles</h3><p>Le résultat montre la juridiction, la méthode et les limites utiles à son interprétation.</p></article><article><h3>Sources officielles quand les règles changent</h3><p>Les pages fiscales et réglementaires indiquent la source et la date de la dernière vérification disponible.</p></article><article><h3>Traitement local lorsque l’outil le permet</h3><p>Les calculs et documents locaux restent dans le navigateur ; un transfert réseau doit être annoncé avant l’envoi.</p></article></div></div></section>
