...
const receipt = {
  ...
  orderingDecision: 'After position 92, selection wrapped to the earliest blocked row. Positions 48-56 remain fail-closed because their PAYE calculations are inline or legacy and lack a maintained readable DOM-free engine. Position 59 ng-land-use is the first eligible row: it owns a maintained DOM-free engine, a dedicated controller and a notice-driven current-source boundary. Position 90 za-paye remains skipped fail-closed.',
  changedProductPaths: [
    ...
    'assets/js/pages/ng-land-use-vip.js',
    'engines/src/ng-land-use-engine.js',
    'engines/ng-land-use-engine.js',
    ...
    'sw/zana/kikokotoo-ada-ya-matumizi-ya-ardhi-lagos/index.html',
    ...
    'tools/ng-land-use/index.html',
    'fr/tools/ng-taxe-fonciere/index.html',
  ...
  formulaDataSourceDecision: 'No rate, ceiling, tier, valuation or benefit formula changed. Ng-land-use delegates to engines/ng-land-use-engine.js generated from the maintained engines/src owner; only verifiedThrough advanced to 2026-08-09 after rechecking the live Lagos Ministry of Finance LUC portal against the 2020 law boundary. The app still requires the current official assessment or demand notice and does not prefill a property-use rate or discount.',
  ...
  requiredCommands: [
    ...
    'node C:\\Users\\Oza\\Documents\\afrotools\\node_modules\\@playwright\\test\\cli.js test --config tests/playwright.ng-land-use-sw.config.js',
