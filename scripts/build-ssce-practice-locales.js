...
const scope = {
  fr: '12 exercices originaux de mathématiques, 2 d’anglais, 20 guides de mathématiques WAEC 5 guides de rédaction WAEC et 3 guides de mathématiques NECO 2023. Il ne s’agit pas d’une épreuve complète WAEC ou NECO. Les réponses rédigées sont vérifiées par l’utilisateur, sans notation automatique.',
  sw: 'Kazi 12 asilia za Hisabati, 2 za Kiingereza, miongozo 20 ya Hisabati WAEC 5 ya uandishi WAEC na 3 ya Hisabati NECO 2023. Hii si karatasi kamili ya WAEC au NECO. Majibu ya kuandika yanahakikiwa na mwanafunzi mwenyewe, bila kutolewa alama kiotomatiki.'
};
...
const pageCopy = {
  fr: {
    ...
    description: '52 questions et 42 exercices rédigés de préparation WAEC / NECO, avec explications en français, sauvegardes locales et comptes rendus téléchargeables.',
    education: 'Éducation', hub: '/fr/education/', eyebrow: 'Préparation WAEC / NECO · Pilote', h1: 'Comprendre.<br>Puis s’entraîner.',
    intro: '24 questions de mathématiques et 16 d’anglais, 12 questions de physique, puis 42 exercices rédigés et guides WAEC 2021–2023 et NECO 2023. Vérifiez vos réponses, conservez votre travail et reprenez vos erreurs.',
  ...
  sw: {
    ...
    description: 'Maswali 52 na kazi 42 za kuandika za maandalizi ya WAEC / NECO, maelezo ya Kiswahili, nakala za maendeleo na ripoti zinazopakuliwa kwenye kifaa.',
    education: 'Elimu', hub: '/sw/elimu/', eyebrow: 'Maandalizi ya WAEC / NECO · Majaribio', h1: 'Elewa.<br>Kisha fanya mazoezi.',
    intro: 'Maswali 24 ya Hisabati na 16 ya Kiingereza, maswali 12 ya Fizikia, pamoja na kazi 42 za kuandika na miongozo ya WAEC 2021–2023 na NECO 2023. Hakiki majibu, hifadhi kazi yako na urudie uliyokosea.',
    ...
    coverageBody: 'Mazoezi asilia hayana mwaka wa mtihani. Maswali 2–3 ya Hisabati WAEC 2021 yana sehemu zote; mada zote tano za uandishi WAEC 2023 zina mwongozo. Sehemu za ufahamu na muhtasari hazijajumuishwa. Miongozo mitatu ya NECO 2023 inahusu maswali 1, 5 na 9 ya nakala iliyochanganuliwa. Miongozo ya WAEC inahifadhi miaka 2021, 2022 na 2023, namba ya swali na kiungo cha chanzo; kifungue kuona swali na michoro asilia. Huu si mtihani kamili wala mtaala kamili. Hakuna utoaji wa alama za insha kiotomatiki wala sauti za mtihani wa Kiingereza cha mazungumzo.',
...
function run(write) {
  ...
  console.log(`${write ? 'Generated' : 'Validated'} SSCE FR/SW: 52 quick questions and 42 written tasks per locale (${changed.length} changed files).`);
}
