...
const scope = {
  fr: '12 exercices originaux de mathématiques, 2 d’anglais, 27 guides de mathématiques WAEC, 10 guides de rédaction et 4 de lecture WAEC, 9 guides de mathématiques NECO 2023, 4 guides de rédaction et 2 de lecture NECO. Il ne s’agit pas d’une épreuve complète WAEC ou NECO. Les réponses rédigées sont vérifiées par l’utilisateur, sans notation automatique.',
  sw: 'Kazi 12 asilia za Hisabati, 2 za Kiingereza, miongozo 27 ya Hisabati WAEC, 10 ya uandishi na 4 ya kusoma WAEC, 9 ya Hisabati NECO 2023, 4 ya uandishi na 2 ya kusoma NECO. Hii si karatasi kamili ya WAEC au NECO. Majibu ya kuandika yanahakikiwa na mwanafunzi mwenyewe, bila kutolewa alama kiotomatiki.'
};
...
const pageCopy = {
  fr: {
    ...
    description: '52 questions et 69 exercices rédigés de préparation WAEC / NECO, avec explications en français, sauvegardes locales et comptes rendus téléchargeables.',
    education: 'Éducation', hub: '/fr/education/', eyebrow: 'Préparation WAEC / NECO · Pilote', h1: 'Comprendre.<br>Puis s’entraîner.',
    intro: '24 questions de mathématiques et 16 d’anglais, 12 questions de physique, puis 69 exercices rédigés et guides WAEC 2021–2023 et NECO 2023. Vérifiez vos réponses, conservez votre travail et reprenez vos erreurs.',
  ...
  sw: {
    ...
    description: 'Maswali 52 na kazi 69 za kuandika za maandalizi ya WAEC / NECO, maelezo ya Kiswahili, nakala za maendeleo na ripoti zinazopakuliwa kwenye kifaa.',
    education: 'Elimu', hub: '/sw/elimu/', eyebrow: 'Maandalizi ya WAEC / NECO · Majaribio', h1: 'Elewa.<br>Kisha fanya mazoezi.',
    intro: 'Maswali 24 ya Hisabati na 16 ya Kiingereza, maswali 12 ya Fizikia, pamoja na kazi 69 za kuandika na miongozo ya WAEC 2021–2023 na NECO 2023. Hakiki majibu, hifadhi kazi yako na urudie uliyokosea.',
