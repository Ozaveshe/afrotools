...
const scope = {
  ...
  sw: 'Kazi 12 asilia za Hisabati, 2 za Kiingereza, miongozo 28 ya Hisabati WAEC, 10 ya uandishi na 4 ya kusoma WAEC, 43 ya Hisabati NECO 2023, 4 ya uandishi na 2 ya kusoma NECO. Hii si karatasi kamili ya WAEC au NECO. Majibu ya kuandika yanahakikiwa na mwanafunzi mwenyewe, bila kutolewa alama kiotomatiki.'
};
...
const pageCopy = {
  fr: {
    ...
    description: '52 questions et 105 exercices rédigés de préparation WAEC / NECO, avec explications en français, sauvegardes locales et comptes rendus téléchargeables.',
    education: 'Éducation', hub: '/fr/education/', eyebrow: 'Préparation WAEC / NECO · Pilote', h1: 'Comprendre.<br>Puis s’entraîner.',
    intro: '24 questions de mathématiques et 16 d’anglais, 12 questions de physique, puis 105 exercices rédigés et guides WAEC 2021–2023 et NECO 2023. Vérifiez vos réponses, conservez votre travail et reprenez vos erreurs.',
  ...
  sw: {
    ...
    description: 'Maswali 52 na kazi 105 za kuandika za maandalizi ya WAEC / NECO, maelezo ya Kiswahili, nakala za maendeleo na ripoti zinazopakuliwa kwenye kifaa.',
    education: 'Elimu', hub: '/sw/elimu/', eyebrow: 'Maandalizi ya WAEC / NECO · Majaribio', h1: 'Elewa.<br>Kisha fanya mazoezi.',
    intro: 'Maswali 24 ya Hisabati na 16 ya Kiingereza, maswali 12 ya Fizikia, pamoja na kazi 105 za kuandika na miongozo ya WAEC 2021–2023 na NECO 2023. Hakiki majibu, hifadhi kazi yako na urudie uliyokosea.',
