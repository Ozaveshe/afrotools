...
function buildReport() {
  ...
  const checks = [
    ...
    check("ask_source_freshness_notice_present", fileContains("ask/index.html", /sourceNoteFor/) && fileContains("ask/index.html", /Estimate only/) && fileContains("ask/index.html", /Check sources/) && fileContains("tests/e2e/ask-command-page.spec.js", /source and freshness guidance/), "ask/index.html"),
    check("ask_consumer_surface_simplified", fileContains("ask/index.html", /Say what you need/) && fileContains("ask/index.html", /What do you need\?/) && fileContains("ask/index.html", /Private by default/) && fileContains("ask/index.html", /Not right\?/) && fileContains("ask/index.html", /limit:\s*4/) && !fileContains("ask/index.html", /How this page works/), "ask/index.html"),
    check("ask_answer_engine_preview_present", fileContains("ask/index.html", /extractSalaryTaxIntent/) && fileContains("ask/index.html", /answerPreview/) && fileContains("ask/index.html", /answer engine match/) && fileContains("tests/e2e/ask-command-page.spec.js", /Angola salary-tax answer preview/), "ask/index.html"),
    ...
    check("token_training_model_path_declared", architecture.answerEngine && architecture.tokenStrategy && architecture.trainingDataStrategy && Array.isArray(architecture.modelPath) && architecture.modelPath.length >= 4 && /DeepSeek-like capability/.test(JSON.stringify(architecture.modelPath)), "data/ai/product-architecture.json"),
  ...
  return {
    ...
    architecture: {
      ...
      answerEngine: architecture.answerEngine || {},
      tokenStrategy: architecture.tokenStrategy || {},
      trainingDataStrategy: architecture.trainingDataStrategy || {},
      modelPathStages: (architecture.modelPath || []).map((item) => item.stage),
