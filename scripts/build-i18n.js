...
function processHTML(html, lang, pagePath) {
  ...
  if (lang === 'fr') {
    const UI_TRANSLATIONS_FR = [
      ...
      ['The complete AfroTools library — financial calculators, AI advisors, PDF tools, CV builder, engineering, and more. Built for all 54 African countries. Always free.', 'La bibliotheque complete AfroTools : calculateurs financiers, assistants, outils PDF, CV, ingenierie et plus encore. Concue pour les 54 pays africains. Acces gratuit aux outils inclus.'],
