...
function alternates(type) {
  const routes = { about: ['/about/','/fr/about/','/sw/kuhusu/','/ha/game-da-mu/'], contact: ['/contact/','/fr/contact/','/sw/wasiliana/','/ha/tuntube-mu/'], faq: ['/faq/','/fr/faq/','/sw/maswali-ya-mara-kwa-mara/',null], cookies: ['/cookies/','/fr/cookies/','/sw/vidakuzi/',null] }[type];
  const ha = routes[3] ? `<link rel="alternate" hreflang="ha" href="https://afrotools.com${routes[3]}">` : '';
  return `<link rel="alternate" hreflang="en" href="https://afrotools.com${routes[0]}"><link rel="alternate" hreflang="fr" href="https://afrotools.com${routes[1]}"><link rel="alternate" hreflang="sw" href="https://afrotools.com${routes[2]}">${ha}<link rel="alternate" hreflang="x-default" href="https://afrotools.com${routes[0]}">`;
}
