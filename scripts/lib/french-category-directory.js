...
const FRENCH_CATEGORIES = [
  ...
  { key: 'insurance', title: 'Assurance', href: '/fr/insurance/', nativeHub: true, icon: 'AS', bg: '#f0fdfa', description: 'Seize feuilles de planification pour devis, garanties, contributions, sinistres et vérifications.' },
