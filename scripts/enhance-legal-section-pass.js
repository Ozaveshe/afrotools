...
function updateLanding() {
  ...
  let next = current
    ...
    .replace('Legal & Compliance Tools for Africa — 33 Tools, 54 Countries | AfroTools', 'Legal & Compliance Apps for Africa - 33 Tools | AfroTools')
    .replace('Free legal and compliance tools for Africa. Business registration, NDA generator, privacy policy, compliance checkers, wills, child support, court fees - across 54 African countries.', 'Free legal and compliance apps for Africa. Business registration, contracts, privacy, wills, court fees and legal aid with honest country coverage by tool.')
    ...
    .replace('33 free legal and compliance tools for Africa - business registration, contracts, privacy, personal legal, and more.', '33 legal and compliance apps for Africa with explicit country coverage, official-source checks, and practical next steps.')
    ...
    .replace('Africa has over 100 distinct legal systems across 54 countries - yet access to legal tools remains painfully limited. These free tools help businesses and individuals navigate registration, compliance, contracts, data privacy, and personal legal matters.', 'Africa has many overlapping legal systems, registries, regulators, and court processes. These tools help businesses and individuals navigate registration, compliance, contracts, data privacy, and personal legal matters while showing where coverage is a full directory and where it is a deeper 16-market calculator.')
    ...
    .replace(/Company formation, registration, IP, contracts, and dissolution[^<]*for all 54 African countries/, 'Company formation, registration, IP, contracts, and dissolution with coverage labelled by tool')
    .replace('Real data on registration authorities, compliance requirements, and legal processes for every African country - not generic global templates.', 'Clear coverage labels, practical checklists, and official-source shortcuts so you can separate Africa-wide directories from deeper country calculators.');
  next = next
    .replace('Africa has many overlapping legal systems, registries, regulators, and court processes. These tools help businesses and individuals navigate registration, compliance, contracts, data privacy, and personal legal matters while showing where coverage is a full directory and where it is a deeper 16-market calculator.', 'Africa has many overlapping legal systems, registries, regulators, and court processes. These apps now help users move from answer to action: capture evidence, save a workflow, export a PDF checklist and continue into the next legal tool.')
    .replace(/Africa has many overlapping legal systems, registries, regulators, and court processes\.[^<]*?deeper 16-market calculator\./, 'Africa has many overlapping legal systems, registries, regulators, and court processes. These apps now help users move from answer to action: capture evidence, save a workflow, export a PDF checklist and continue into the next legal tool.');
  ...
  next = next
    ...
    .replace('Company Type Selector Answer 5 quick questions -> get the right structure', 'Company Type Selector Answer 5 quick questions to get the right structure')
