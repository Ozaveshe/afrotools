...
const tools = [
  ...
  },
  {
    ...
    existing: true,
    status: 'live',
    countries: ['ZA', 'ZW', 'BW', 'ZM', 'LS', 'SZ', 'NA'],
    priority: 81,
    ...
    checklist: ['Agree who speaks for each family before discussing money.', 'Separate symbolic livestock value from actual cash flow.', 'Record what has been agreed and what remains ceremonial.', 'Keep the process respectful and avoid treating the discussion as a price tag.'],
