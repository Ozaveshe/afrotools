...
function build() {
  ...
  if (accepted !== 31 || blocked !== 2) throw new Error(`Expected 31 accepted and 2 blocked, found ${accepted}/${blocked}`);
  const receipt = {
    schemaVersion:1,
