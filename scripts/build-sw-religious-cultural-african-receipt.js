...
const AFRICAN_ACCEPTED = new Set(['naira-to-words','amount-words-ke','amount-words-gh','susu-tracker','whatsapp-link','ajo-interest','market-days','ajo-chama-calc','remittance-compare','remittance-v2','mobile-money-fees','burial-cost','japa-calculator','brideprice-advisor']);
...
function build() {
  ...
  if (accepted !== 33 || blocked !== 0) throw new Error(`Expected 33 accepted and 0 blocked, found ${accepted}/${blocked}`);
  const receipt = {
    schemaVersion:1,
