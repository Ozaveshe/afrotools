...
const PAGES = [
  ...
  },
  {
    ...
    description:
      "Comparez frais, delai, devise et cout net pour paiements B2B internationaux.",
    eyebrow: "Paiements entreprises",
    lead:
      "Estimez le cout total avant d'envoyer un paiement fournisseur, freelance ou distributeur.",
    useCase:
      "Utile pour PME qui comparent SWIFT, fintechs, mobile money, stablecoins ou plateformes business.",
    safety:
      "Verifiez disponibilite, limites, KYC, taux de change et conformite avant paiement.",
    related:
      "A utiliser avec impact FX import, frais bancaires et prevision de tresorerie.",
    terms: [
    ...
    [
      ...
      },
      {
        ...
        mainEntity: [
          {
            "@type": "Question",
            name: `Quand utiliser ${page.name} ?`,
            acceptedAnswer: { "@type": "Answer", text: page.useCase },
          },
          {
            "@type": "Question",
            name: "Comment lire le resultat ?",
            acceptedAnswer: { "@type": "Answer", text: page.safety },
          },
        ],
      },
    ],
