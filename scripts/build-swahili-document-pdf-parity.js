...
const apps = [
  ...
  { id: 'pdf-watermark', localFirstDownloads: true, englishRoute: '/tools/pdf-watermark/', englishFile: 'tools/pdf-watermark/index.html', swahiliRoute: '/sw/zana/watermark-pdf/', swahiliFile: 'sw/zana/watermark-pdf/index.html', name: 'Alama ya Maji ya PDF', exports: ['pdf', 'zip'] },
