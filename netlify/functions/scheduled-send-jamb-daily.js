...
// Declared before PRACTICE_POOL because the filter below runs at module load and
// calls isLaunchSafeQuestion(), which dereferences this regex. `const` is not
// hoisted like the function is, so declaring it further down put it in the
// temporal dead zone: requiring this module threw "Cannot access
// 'VISUAL_DEPENDENT_RE' before initialization" before the handler was ever
// reached. Netlify could not load the function at all, so this hourly job never
// ran and never recorded scheduled proof.
