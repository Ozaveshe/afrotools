...
def build_pdf():
    ...
    tools_k = [
        ...
        (241, "Vehicle Import Duty Calculator", "x54", "[DDPE] Huge cost component"),
    ...
    batch1 = [
        ...
        [Paragraph("945-998", styles['TableCell']), Paragraph("Vehicle Import Duty Calculator", styles['TableCellBold']),
