(function () {
  ...
  var messages = {
    ...
    sw: { context: 'Ongeza sarafu, nchi au mamlaka na kipindi cha kodi.', amount: 'Ingiza kiasi cha fedha kisicho hasi na kinachofaa.', costs: 'Marejesho na gharama haviwezi kuzidi mapato ghafi.', assumption: 'Tumia kiwango cha akiba cha 0% hadi 100% na awamu 1 hadi 12.', evidence: 'Ongeza taarifa rasmi au chanzo cha mshauri na tarehe iliyokaguliwa ndani ya siku 365.', ready: 'Akiba ya kupanga iko tayari. Hakuna data iliyoondoka kwenye kivinjari hiki.', changed: 'Data imebadilika. Tengeneza mpango tena.', exported: 'Faili imetengenezwa ndani ya kifaa.', copied: 'Mpango umenakiliwa ndani ya kifaa.' }
  }[locale];
  var current = null;
