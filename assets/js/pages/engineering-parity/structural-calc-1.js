...
function matCost(concreteM3, rebarKg, note) {
  ...
  return (
    '<div class="cost-box"><strong>Estimated Material Cost — ' +
    cost.name +
    "</strong><br>Concrete (" +
    ...
    "</strong>" +
    (note ? "<br><em>" + note + "</em>" : "") +
    '<br><span style="font-size:.78rem;color:#92400e">Legacy undated rates: stale and low-confidence. Replace with current supplier quotes before budgeting.</span></div>'
  );
}
...
function calcBeam() {
  try {
    ...
    document.getElementById("beam-summary").innerHTML =
      '<div class="result-card highlight"><div class="result-label">Beam Size</div><div class="result-value">' +
      r.width +
      " x " +
      r.height +
      ...
      r.V.toFixed(1) +
      '<span class="result-unit"> kN</span></div></div><div class="result-card highlight"><div class="result-label">Main Steel</div><div class="result-value">' +
      r.As.toFixed(0) +
      '<span class="result-unit"> mm2</span></div></div>';
    document.getElementById("beam-table").innerHTML =
      "<tbody><tr><td>Effective depth</td><td>" +
      r.d +
      ...
      r.z.toFixed(1) +
      " mm</td></tr><tr><td>Minimum steel</td><td>" +
      r.AsMin.toFixed(0) +
...
function calcColumn() {
  try {
    ...
    document.getElementById("col-summary").innerHTML =
      '<div class="result-card highlight"><div class="result-label">Column Size</div><div class="result-value">' +
      r.dimLabel +
      '</div></div><div class="result-card"><div class="result-label">Required Gross Area</div><div class="result-value">' +
      fmtNumber(r.Ag) +
      '<span class="result-unit"> mm2</span></div></div><div class="result-card"><div class="result-label">Steel Area</div><div class="result-value">' +
      fmtNumber(r.Asc) +
    ...
    document.getElementById("col-table").innerHTML =
      "<tbody><tr><td>Design load</td><td>" +
      r.load +
      " kN</td></tr><tr><td>Concrete grade</td><td>C" +
      r.fcu +
      "</td></tr><tr><td>Steel percentage</td><td>" +
      r.steelPct.toFixed(1) +
      "%</td></tr><tr><td>Actual area</td><td>" +
...
function calcSlab() {
  try {
    ...
    document.getElementById("slab-summary").innerHTML =
      ...
      r.height +
      '<span class="result-unit"> mm</span></div></div><div class="result-card"><div class="result-label">Ultimate Load</div><div class="result-value">' +
      ...
      r.M.toFixed(1) +
      '<span class="result-unit"> kNm/m</span></div></div><div class="result-card highlight"><div class="result-label">Main Steel Prompt</div><div class="result-value" style="font-size:1rem">' +
      r.barChoice +
      "</div></div>";
    document.getElementById("slab-table").innerHTML =
      ...
      r.gk.toFixed(1) +
      " kN/m2</td></tr><tr><td>Effective depth</td><td>" +
      r.d +
      " mm</td></tr><tr><td>Required steel</td><td>" +
      fmtNumber(r.AsDesign) +
      " mm2/m</td></tr><tr><td>Minimum steel</td><td>" +
      fmtNumber(r.AsMin) +
      " mm2/m</td></tr></tbody>";
...
function calcFooting() {
  try {
    ...
    document.getElementById("foot-summary").innerHTML =
      '<div class="result-card highlight"><div class="result-label">Footing Size</div><div class="result-value">' +
      r.side +
      " x " +
      r.side +
      '<span class="result-unit"> mm</span></div></div><div class="result-card"><div class="result-label">Depth Prompt</div><div class="result-value">' +
      r.height +
    ...
    document.getElementById("foot-table").innerHTML =
      "<tbody><tr><td>Column load</td><td>" +
      r.load +
      " kN</td></tr><tr><td>Bearing assumption</td><td>" +
      r.sbc +
      " kN/m2</td></tr><tr><td>Required area</td><td>" +
      r.areaReq.toFixed(2) +
      " m2</td></tr><tr><td>Provided area</td><td>" +
      r.actualArea.toFixed(2) +
      " m2</td></tr><tr><td>Cantilever prompt</td><td>" +
      (r.cantilever * 1000).toFixed(0) +
      " mm</td></tr><tr><td>Concrete volume</td><td>" +
