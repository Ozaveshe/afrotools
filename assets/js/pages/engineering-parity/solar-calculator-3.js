...
async function sendAI(){
  ...
  if(!consent || !consent.checked){
    if(status) status.textContent='Tick the optional AI consent box before sending a question. The solar calculator, copy, CSV, and print actions still work locally.';
    msgsEl.innerHTML+='<div class="ai-msg-a">Please tick the optional AI consent box before sending. Do not include private customer, address, account, or installer-contract details.</div>';
