...
async function sendAI(){
  ...
  if(!consent || !consent.checked){
    if(status) status.textContent='Tick the optional AI consent box before sending a question. The Solaire Calculateur, Copier, CSV, and Imprimer actions still work locally.';
  ...
  try{
    ...
    if(thinkEl.parentNode)thinkEl.remove();
    msgsEl.innerHTML+='<div class="ai-msg-a">Informations et hypothèses du calcul</div>';
  }
