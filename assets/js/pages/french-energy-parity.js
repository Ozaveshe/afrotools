(function initFrenchEnergyParity(root) {
  ...
  var exact = [
    ...
    ["Copy the currency, price per kWh and any fixed charge or tax/levy from a current bill or official notice. AfroTools does not store or validate these values.", "Copiez la devise, le prix par kWh et les éventuels frais fixes ou taxes/prélèvements depuis une facture récente ou un avis officiel. AfroTools ne conserve ni ne valide ces valeurs."],
    ["Currency", "Devise"],
    ["Rate per kWh (", "Tarif par kWh ("],
    ["Fixed bill charge (", "Frais fixes de facture ("],
    ["Tax or levy (%)", "Taxe ou prélèvement (%)"],
    ...
    ["Fixed charge:", "Frais fixes :"],
    ["User-entered tax or levy", "Taxe ou prélèvement saisi par l’utilisateur"],
    ["Minimum charge applied.", "Frais minimum appliqués."],
    ...
    ["Tariff charges use the available purchase amount; no money remains for electricity units.", "Les frais tarifaires utilisent tout le montant disponible ; aucun montant ne reste pour les unités d’électricité."],
