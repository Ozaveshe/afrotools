(function(){
  ...
  let last=null;
  const translations={
    en:{invalid:'Complete every quote with valid values.',updated:'Comparison calculated on this device.',copied:'Summary copied.',copyFailed:'Could not copy. Download JSON instead.',downloaded:'JSON downloaded.',highest:'Highest recipient amount',none:'No eligible comparable quotes.',debit:'Total debit',recipient:'Recipient amount',rate:'Effective rate',fee:'Stated fee',checked:'Checked',expiry:'Expiry state',difference:'Difference from highest',boundary:'Highest recipient amount is not a recommendation. Recheck the quote, expiry, payout route, safety and limits before sending.',expiryStates:{expired:'expired',unknown:'unknown','not-expired':'not expired'}},
