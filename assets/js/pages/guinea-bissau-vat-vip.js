  ...
  function init() {
    ...
    var copy = {
      ...
      fr: {
        ...
        lead: "Ajoutez ou extrayez une estimation de TVA en francs CFA au taux de référence de 19 %. Ce repère a été revu le 3 mai 2026 ; confirmez le texte applicable et la classification auprès de la DGCI avant toute déclaration.",
        amount: "Montant",
        add: "Ajouter la TVA",
        ...
        rules: "Repères DGCI · revue du 3 mai 2026",
        source: "Sources officielles",
        sourceOne: "DGCI Kontaktu — portail officiel à revérifier",
        ...
        disclaimer: "Estimation de planification uniquement. Le registre de cette catégorie, revu le 3 mai 2026, conserve 29 lacunes de liaison vers des régulateurs africains ; ce calculateur renvoie au portail général de la DGCI. Confirmez le taux, la classification, l’immatriculation, la facturation, la déduction et la déclaration auprès de la DGCI ou d’un conseiller qualifié.",
      },
      sw: {
