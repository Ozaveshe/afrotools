!function() {
    ...
    function h(e) {
        var t = u("toast");
        t && (t.textContent = e, t.classList.add("show"), clearTimeout(h._timer), h._timer = setTimeout(function() {
        ...
        !function(e) {
            ...
            if (t) {
                ...
                n.forEach(function(e, n) {
                    var r = document.createElement("p");
                    r.textContent = e, 0 === n && (r.className = "paper-name"), t.appendChild(r);
                });
            }
        }(t), function(e) {
            ...
            if (i) if (e.keywords.length) {
                var l = e.matched.map(function(e) {
                    return '<span class="chip hit">' + p(e) + "</span>";
                }), c = e.missing.map(function(e) {
                    return '<span class="chip miss">' + p(e) + "</span>";
                });
    ...
    function k() {
        ...
        var e = u("editState");
        e && (e.textContent = "Draft created from your form. You can edit the text directly before exporting."),
        x();
    }
    function S(t) {
        try {
    ...
    function T(e) {
        return (e.jobTitle || "Cover letter") + (e.company ? " at " + e.company : "");
    }
    function C() {
        var e = u("savedList");
        if (e) if (o) {
            ...
            t.length ? e.innerHTML = t.map(function(e) {
                ...
                return '<div class="saved-item" data-id="' + p(e.id) + '"><div class="saved-title">' + p(e.title || "Untitled letter") + '</div><div class="saved-meta">' + p(t) + '</div><div class="saved-actions"><button class="btn btn-soft" type="button" data-load="' + p(e.id) + '">Load</button><button class="btn btn-danger" type="button" data-delete="' + p(e.id) + '">Delete</button></div></div>';
    ...
    function E() {
        if (r) {
            var e = u("editState");
            return e && (e.textContent = "Form changed after manual edits. Click Create cover letter to regenerate from the form."),
            void x();
        }
        k();
    }
    function N() {
        ...
        f("lengthId", l, "standard"), v("years", "3"), function() {
            ...
            e && e.addEventListener("input", function() {
                r = !0;
                var e = u("editState");
                e && (e.textContent = "Manual edits are preserved. Use Create cover letter only when you want a fresh draft."),
                x();
