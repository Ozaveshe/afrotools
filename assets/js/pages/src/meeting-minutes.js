...
!function() {
    ...
    function validateDocumentBackup(value) {
        importRecord(value);
        requireBackup(typeof value.meetingTitle === "string" && typeof value.minutesText === "string");
        ["attendees", "agendaItems", "decisions", "actions"].forEach(function(key) {
            requireBackup(Array.isArray(value[key]));
            value[key].forEach(function(item) { importRecord(item); });
        });
        return value;
    }

    var e = "afrotools-meeting-minutes-current-v2", t = "minutes", n = null, i = !1, a = window.SaveState ? new window.SaveState("meeting-minutes") : null, o = [], r = [], s = [], d = [], c = [ {
        id: "blank",
        name: "Blank meeting",
        agenda: []
    }, {
        id: "board",
        name: "Board meeting",
        agenda: [ "Call to order", "Approval of previous minutes", "Chair report", "Financial report", "Resolutions", "Any other business", "Adjournment" ]
    }, {
        id: "team-sync",
        name: "Team sync",
        agenda: [ "Wins since last meeting", "Current priorities", "Blockers", "Decisions needed", "Next actions" ]
    }, {
        id: "project-review",
        name: "Project review",
        agenda: [ "Project status", "Deliverables review", "Timeline and milestones", "Risks and blockers", "Resource needs", "Next steps" ]
    }, {
        id: "sales",
        name: "Sales review",
        agenda: [ "Pipeline update", "Key accounts", "Revenue risks", "Customer blockers", "Next actions" ]
    }, {
        id: "ngo",
        name: "NGO or donor meeting",
        agenda: [ "Program update", "Field observations", "Budget and compliance", "Beneficiary issues", "Donor actions" ]
    }, {
        id: "school",
        name: "School committee",
        agenda: [ "Opening remarks", "Attendance and apologies", "Academic update", "Finance and facilities", "Parent or community issues", "Action items" ]
    } ], u = [ {
        id: "executive",
        ...
        id: "standup",
        name: "Standup brief"
    } ], l = [ "templateId", "styleId", "meetingTitle", "organization", "meetingDate", "startTime", "endTime", "location", "chair", "minuteTaker", "risks", "parkingLot", "nextDate", "nextTime", "nextAgenda" ];
    function m(e) {
        return document.getElementById(e);
    }
    function g(e) {
        return (e || "id") + "-" + Date.now().toString(36) + "-" + Math.random().toString(36).slice(2, 8);
    }
    function p(e) {
        return String(e || "").replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#39;");
    }
    function f(e, t) {
        return (String(e || t || "meeting-minutes").replace(/[^a-zA-Z0-9]+/g, "-").replace(/^-+|-+$/g, "") || t || "meeting-minutes").toLowerCase();
    }
    function v(e) {
        var t = m("toast");
        t && (t.textContent = e, t.classList.add("show"), clearTimeout(v._timer), v._timer = setTimeout(function() {
            t.classList.remove("show");
        }, 2600));
    }
    function h(e, t, n) {
        var i = m(e);
        i && (i.innerHTML = "", t.forEach(function(e) {
    ...
    function w(e, t) {
        ...
        return 3 === n.length && n[0] ? new Date(n[0], n[1] - 1, n[2]).toLocaleDateString("en-GB", t || {
            day: "numeric",
            month: "long",
            year: "numeric"
        }) : e;
    ...
    function S(e, t) {
        ...
        }), a = e.attendees, o = (Array.isArray(a) ? a : []).map(function(e) {
            return {
                id: e.id || g("attendee"),
                name: e.name || "",
                role: e.role || "",
    ...
    function A() {
        ...
        !function(e) {
            ...
            var a = r.filter(function(e) {
                return e.title && (e.discussion || e.decision);
            }).length, c = s.length + r.filter(function(e) {
                return e.decision;
            }).length, u = d.filter(function(e) {
                return e.owner;
    ...
    function E() {
        b("minutesText", function(e) {
            var t = [], n = e.meetingTitle || "Meeting minutes", i = e.styleId || "executive", a = o.filter(function(e) {
            ...
            }), g.length && (t.push(""), t.push("DECISIONS"), g.forEach(function(e, n) {
                t.push(String(n + 1) + ". " + e.text + (e.owner ? " - Owner: " + e.owner : "") + (e.status ? " [" + e.status + "]" : ""));
            })), d.length && (t.push(""), t.push("ACTION ITEMS"), d.forEach(function(e, n) {
                var i = [];
                e.owner && i.push("Owner: " + e.owner), e.due && i.push("Due: " + w(e.due, {
                    day: "numeric",
                    month: "short",
                    year: "numeric"
    ...
    function D(t) {
        try {
            localStorage.setItem(e, JSON.stringify(t || x()));
        } catch (e) {}
    }
    function C(e) {
    ...
    function N() {
        var e = m("agendaList");
        e && (r.length ? e.innerHTML = r.map(function(e, t) {
            return '<div class="agenda-card" data-agenda="' + p(e.id) + '"><div class="agenda-top"><div class="agenda-index">' + (t + 1) + '</div><label class="field full" style="margin:0"><span>Title</span><input value="' + p(e.title) + '" data-agenda-field="title" data-id="' + p(e.id) + '"></label><button class="btn btn-danger" type="button" data-remove-agenda="' + p(e.id) + '">Remove</button></div><label class="field full"><span>Discussion</span><textarea data-agenda-field="discussion" data-id="' + p(e.id) + '">' + p(e.discussion) + '</textarea></label><div class="form-grid"><label class="field"><span>Decision or outcome</span><input value="' + p(e.decision) + '" data-agenda-field="decision" data-id="' + p(e.id) + '"></label><label class="field"><span>Owner</span><input value="' + p(e.owner) + '" data-agenda-field="owner" data-id="' + p(e.id) + '"></label></div></div>';
        }).join("") : e.innerHTML = '<div class="helper">No agenda items yet. Choose a template or add one below.</div>');
    }
    function L() {
        var e;
        ...
        function() {
            ...
            e && (s.length ? e.innerHTML = s.map(function(e) {
                return '<div class="list-item"><div class="list-title">' + p(e.text) + '</div><div class="list-meta">' + p([ e.owner ? "Owner: " + e.owner : "", e.status ].filter(Boolean).join(" | ")) + '</div><div class="list-actions"><button class="btn btn-danger" type="button" data-remove-decision="' + p(e.id) + '">Remove</button></div></div>';
            }).join("") : e.innerHTML = '<div class="helper">No standalone decisions yet.</div>');
        }(), function() {
            var e = m("actionList");
            e && (d.length ? e.innerHTML = d.map(function(e) {
                var t = e.due ? w(e.due, {
                    day: "numeric",
                    month: "short",
                    year: "numeric"
                }) : "No due date";
                return '<div class="list-item"><div class="list-title">' + p(e.text) + '</div><div class="list-meta">' + p([ e.owner ? "Owner: " + e.owner : "No owner", "Due: " + t, "Priority: " + e.priority, e.source ? "Source: " + e.source : "" ].filter(Boolean).join(" | ")) + '</div><div><span class="action-status status-' + p(e.status) + '">' + p(e.status) + '</span></div><div class="list-actions"><button class="btn btn-soft" type="button" data-toggle-action="' + p(e.id) + '">' + ("done" === e.status ? "Reopen" : "Mark done") + '</button><button class="btn btn-danger" type="button" data-remove-action="' + p(e.id) + '">Remove</button></div></div>';
            }).join("") : e.innerHTML = '<div class="helper">No action items yet.</div>');
        }();
    }
    function I() {
        L(), i ? A() : E();
    ...
    function R() {
        ...
        if (e) if (a) {
            ...
            t.length ? e.innerHTML = t.map(function(e) {
                ...
                return '<div class="saved-item"><div class="saved-title">' + p(e.title || "Untitled minutes") + '</div><div class="saved-meta">' + p(t) + '</div><div class="list-actions"><button class="btn btn-soft" type="button" data-load="' + p(e.id) + '">Load</button><button class="btn btn-danger" type="button" data-delete="' + p(e.id) + '">Delete</button></div></div>';
            }).join("") : e.innerHTML = '<div class="helper">No saved minutes yet.</div>';
        } else e.innerHTML = '<div class="helper">Saved minutes are not available in this browser.</div>';
    }
    function M(e, t, n) {
        var i = new Blob([ n ], {
            type: t
    ...
    function j() {
        ...
        if (e) {
            e.focus(), e.select();
            try {
                document.execCommand("copy"), v("Copied to clipboard.");
            } catch (e) {
                v("Select the text and copy manually.");
            }
        }
    }
    function P() {
        var e = function(e) {
            var n = JSON.stringify(e), i = btoa(unescape(encodeURIComponent(n))).replace(/\+/g, "-").replace(/\//g, "_").replace(/=+$/g, ""), a = new URL(window.location.href);
            return a.search = "", a.searchParams.set(t, i), a.toString();
        }(x());
        navigator.clipboard && navigator.clipboard.writeText ? navigator.clipboard.writeText(e).then(function() {
            v("Share link copied.");
        }).catch(function() {
            v("Could not copy share link.");
        }) : v("Clipboard unavailable.");
    }
    function B(e) {
        if (e && e.target && "templateId" === e.target.id) {
            ...
            t && t.agenda.length && 0 === r.length && (r = t.agenda.map(function(e) {
                return {
                    id: g("agenda"),
                    title: e,
                    discussion: "",
    ...
    function U() {
        !function() {
            h("templateId", c, "blank"), h("styleId", u, "executive");
            var e = new Date;
            b("meetingDate", e.toISOString().slice(0, 10)), b("startTime", e.toTimeString().slice(0, 5));
        }(), function() {
            l.forEach(function(e) {
                var t = m(e);
                t && (t.addEventListener("input", B), t.addEventListener("change", B));
            });
            var e = m("minutesText");
            e && e.addEventListener("input", function() {
                ...
                var t = e.target;
                if (t && t.getAttribute) {
                    var n = t.getAttribute("data-id"), a = t.getAttribute("data-agenda-field");
                    n && a && (r = r.map(function(e) {
                        return e.id === n && (e[a] = t.value), e;
                    }), i ? A() : E());
                }
            }), document.addEventListener("click", function(e) {
                var t, i, c, u, l, h, w = e.target.closest("[data-action]");
                if (w) {
                    ...
                    "rebuild" === y && E(), "save" === y && function() {
                        ...
                        var e = T("minutesText");
                        e ? navigator.clipboard && navigator.clipboard.writeText ? navigator.clipboard.writeText(e).then(function() {
                            v("Copied to clipboard.");
                        }).catch(function() {
                            j();
                        }) : j() : v("Nothing to copy yet.");
                    }(), "share" === y && P(), "pdf" === y && function() {
                        var e = x();
                        if (window.jspdf && window.jspdf.jsPDF) {
                            var t = new window.jspdf.jsPDF({
                                ...
                                unit: "mm",
                                format: "a4"
                            }), n = t.internal.pageSize.getWidth(), i = t.internal.pageSize.getHeight(), a = 20, o = n - 36;
                            t.setProperties({
                                title: C(e),
                            ...
                            t.save(f(C(e), "meeting-minutes") + ".pdf"), v("PDF downloaded.");
                    ...
                    "txt" === y && function() {
                        ...
                        d.forEach(function(t) {
                            e.push([ t.text, t.owner, t.due, t.priority, t.status, t.source ]);
                        });
                        ...
                        if (i) {
                            ...
                            M(f(a, "next-meeting") + ".ics", "text/calendar;charset=utf-8", r), v("ICS calendar file downloaded.");
                    ...
                    "add-attendee" === y && ((i = T("attendeeName")) ? (o.push({
                        ...
                        name: i,
                        role: T("attendeeRole"),
                        status: T("attendeeStatus") || "present",
                        email: T("attendeeEmail")
                    }), [ "attendeeName", "attendeeRole", "attendeeEmail" ].forEach(function(e) {
                        b(e, "");
                    }), I()) : v("Add an attendee name.")), "add-agenda" === y && ((t = T("agendaTitle")) ? (r.push({
                        id: g("agenda"),
                        title: t,
                        discussion: T("agendaDiscussion"),
                        decision: T("agendaDecision"),
                        owner: ""
                    }), [ "agendaTitle", "agendaDiscussion", "agendaDecision" ].forEach(function(e) {
                        b(e, "");
                    }), I()) : v("Add an agenda title.")), "add-decision" === y && function() {
                        var e = T("decisionText");
                        e ? (s.push({
                            id: g("decision"),
                            text: e,
                            owner: T("decisionOwner"),
                            status: T("decisionStatus") || "approved"
                        }), [ "decisionText", "decisionOwner" ].forEach(function(e) {
                            b(e, "");
                        }), I()) : v("Add a decision.");
                    }(), "add-action" === y && function() {
                        var e = T("actionText");
                        e ? (d.push({
                            id: g("action"),
                            text: e,
                            owner: T("actionOwner"),
                            due: T("actionDue"),
                            priority: T("actionPriority") || "medium",
                            status: T("actionStatus") || "open",
                            source: T("actionSource")
                        }), [ "actionText", "actionOwner", "actionDue", "actionSource" ].forEach(function(e) {
                            b(e, "");
                        }), I()) : v("Add an action.");
                    }();
                }
            ...
            var i = new URLSearchParams(window.location.search), o = i.get(t);
            if (o) {
                var r = function(e) {
                    try {
                ...
                if (r) return n = null, S(r, !1), v("Shared minutes loaded."), !0;
            }
            var s = i.get("id");
            if (s && a) {
                var d = a.load(s);
