...
(function (window) {
  ...
  function createCardDOM(opts) {
    ...
    grid.style.cssText = `
      ...
      background-image:linear-gradient(rgba(0,135,81,.06) 1px,transparent 1px),linear-gradient(90deg,rgba(0,135,81,.06) 1px,transparent 1px);
    ...
    glow.style.cssText = `position:absolute;inset:0;pointer-events:none;background:radial-gradient(ellipse 60% 50% at 50% 30%,rgba(0,135,81,.15) 0%,transparent 70%);`;
    ...
    logoRow.innerHTML = `
      <div style="display:flex;align-items:center;gap:10px;">
        <div style="width:36px;height:36px;background:#0a1a10;border:2px solid rgba(0,200,115,.3);border-radius:8px;display:flex;align-items:center;justify-content:center;">
          <div style="width:12px;height:12px;background:#00c873;transform:rotate(45deg);"></div>
        </div>
