...
(function () {
  ...
  const NAV_ITEMS = [
    ...
    },
    {
      ...
      tools: [
        { label: 'Business Registration Checklist', href: '/tools/business-registration/', emoji: '📋', badge: 'NEW' },
        { label: 'Company Type Selector', href: '/tools/company-type-selector/', emoji: '🏢', badge: 'NEW' },
        { label: 'NDA Generator', href: '/tools/nda-generator/', emoji: '📄', badge: 'NEW' },
        { label: 'Privacy Policy Generator', href: '/tools/privacy-policy-gen/', emoji: '🔒', badge: 'NEW' },
        { label: 'Will / Testament Generator', href: '/tools/will-generator/', emoji: '📜', badge: 'NEW' },
        { label: 'NDPA Compliance Checker', href: '/tools/ndpa-checker/', emoji: '🇳🇬', badge: 'NEW' },
        { label: 'POPIA Compliance Checker', href: '/tools/popia-checker/', emoji: '🇿🇦', badge: 'NEW' },
        { label: 'Child Support Calculator', href: '/tools/child-support/', emoji: '👶', badge: 'NEW' },
        { label: 'Court Fee Calculator', href: '/tools/court-fees/', emoji: '⚖️', badge: 'NEW' },
    ...
    },
    {
      ...
      tools: [
        ...
        { label: 'Data Usage Calculator', href: '/telecom/data-usage-calc/', emoji: '📈' },
