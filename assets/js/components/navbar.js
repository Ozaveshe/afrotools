  ...
  const NAV_ITEMS = [
    ...
    },
    {
      ...
      tools: [
        ...
        { label: 'BMI Calculator for Africans', href: '/health/bmi-calculator/', emoji: '⚕️', badge: 'LIVE' },
        { label: 'Blood Pressure Tracker', href: '/tools/blood-pressure/', emoji: '❤️', badge: 'LIVE' },
        { label: 'Child Vaccine Schedule', href: '/tools/vaccine-schedule/', emoji: '💉', badge: 'LIVE' },
        { label: 'Hospital Cost Estimator', href: '/tools/hospital-cost/', emoji: '🏥', badge: 'LIVE' },
        { label: 'Pregnancy Due Date', href: '/health/pregnancy-due-date/', emoji: '👶', badge: 'LIVE' },
    ...
    },
    {
      ...
      tools: [
        { label: "Côte d'Ivoire — Salaire", href: '/fr/cote-divoire/calculateur-salaire-net', emoji: '🇨🇮', badge: 'NEW' },
        { label: 'Sénégal — Salaire', href: '/fr/senegal/calculateur-salaire-net', emoji: '🇸🇳', badge: 'NEW' },
        { label: 'Cameroun — Salaire', href: '/fr/cameroun/calculateur-salaire-net', emoji: '🇨🇲', badge: 'NEW' },
        { label: 'RD Congo — Salaire', href: '/fr/rdc/calculateur-salaire-net', emoji: '🇨🇩', badge: 'NEW' },
        { label: 'Maroc — Salaire', href: '/fr/maroc/calculateur-salaire-net', emoji: '🇲🇦', badge: 'NEW' },
        { label: 'Algérie — Salaire', href: '/fr/algerie/calculateur-salaire-net', emoji: '🇩🇿', badge: 'NEW' },
        { label: 'Tunisie — Salaire', href: '/fr/tunisie/calculateur-salaire-net', emoji: '🇹🇳', badge: 'NEW' },
        { label: 'Mali — Salaire', href: '/fr/mali/calculateur-salaire-net', emoji: '🇲🇱', badge: 'NEW' },
        { label: 'Burkina Faso — Salaire', href: '/fr/burkina-faso/calculateur-salaire-net', emoji: '🇧🇫', badge: 'NEW' },
        { label: 'Niger — Salaire', href: '/fr/niger/calculateur-salaire-net', emoji: '🇳🇪', badge: 'NEW' },
        { label: 'Guinée — Salaire', href: '/fr/guinee/calculateur-salaire-net', emoji: '🇬🇳', badge: 'NEW' },
        { label: 'Congo — Salaire', href: '/fr/congo/calculateur-salaire-net', emoji: '🇨🇬', badge: 'NEW' },
        { label: 'Gabon — Salaire', href: '/fr/gabon/calculateur-salaire-net', emoji: '🇬🇦', badge: 'NEW' },
        { label: 'Togo — Salaire', href: '/fr/togo/calculateur-salaire-net', emoji: '🇹🇬', badge: 'NEW' },
