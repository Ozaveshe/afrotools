!function() {
    ...
    function r(t, a) {
        return (a || document).querySelector(t);
    }
    function e(t, a) {
    ...
    function n(a, r) {
        return t.formatMoney(a, r || "USD");
    }
    function c() {
        return document.body && document.body.getAttribute("data-default-country") || "NG";
    }
    function i(t, a) {
        (a = a || {}).tool_name = "car-import-cost", window.AfroTools && window.AfroTools.analytics && window.AfroTools.analytics.track ? window.AfroTools.analytics.track(t, a) : "function" == typeof window.gtag && window.gtag("event", t, a);
    }
    function s(t) {
        return fetch(t, {
            cache: "no-cache"
        }).then(function(a) {
            if (!a.ok) throw new Error("Could not load " + t);
            return a.json();
        });
    }
    function l(t, a, r) {
        var e = document.createElement("option");
        return e.value = t, e.textContent = a, r && (e.selected = !0), e;
    }
    function u() {
        var t = r("#carImportCountry").value, n = a.data.countryRulePacks[t], c = r("#carImportPort"), s = r("#carImportDestinationCity");
        n && (c && (c.innerHTML = "", (n.ports || []).forEach(function(t, a) {
            c.appendChild(l(t.code, t.label, 0 === a));
        })), s && (s.innerHTML = "", (n.cities || []).forEach(function(t, a) {
            s.appendChild(l(t.id, t.label, 0 === a));
        })), function(t) {
            e("[data-country-name]").forEach(function(a) {
                a.textContent = t.countryName;
            });
            var a = r("#carImportCountryIntro");
            a && (a.textContent = t.copy && t.copy.intro || "");
            var n = r("#carImportHiddenCosts");
            n && (n.textContent = t.copy && t.copy.hiddenCosts || "");
            var c = r("#carImportSourceBlock");
            c && (c.innerHTML = (t.sourceNotes || []).map(function(t) {
                return '<li><a href="' + o(t.url) + '" rel="nofollow noopener" target="_blank">' + o(t.name) + "</a><span>" + o(t.lastVerified) + " - " + o(t.confidence) + "</span><small>" + o(t.note) + "</small></li>";
            }).join("")), function(t) {
                var a = r("#carImportFaqList");
                a && (a.innerHTML = (t.faqs || []).map(function(t) {
                    return "<details><summary>" + o(t.question) + "</summary><p>" + o(t.answer) + "</p></details>";
                }).join(""));
            }(t);
        }(n), i("car_import_country_selected", {
            country: t
        }));
    }
    function d(t) {
        return Number(r(t) && r(t).value || 0);
    }
    function p(t) {
    ...
    function m() {
        if (a.data) {
            ...
            var e = {
                ...
                make: p("#carImportMake"),
                model: p("#carImportModel"),
                trim: p("#carImportTrim"),
                year: d("#carImportYear"),
                firstRegistrationMonth: d("#carImportFirstRegistrationMonth"),
                fuelType: p("#carImportFuelType"),
                engineCc: d("#carImportEngineCc"),
                transmission: p("#carImportTransmission"),
                bodyType: p("#carImportBodyType"),
                vehicleClass: p("#carImportBodyType"),
                driveSide: p("#carImportDriveSide"),
                condition: p("#carImportCondition"),
                mileage: d("#carImportMileage"),
                purchasePriceUsd: d("#carImportPurchasePrice"),
                fobUsd: d("#carImportFob"),
                cifUsd: d("#carImportCif"),
                freightUsd: d("#carImportFreight"),
                insuranceUsd: d("#carImportInsurance"),
                customsValueUsd: d("#carImportCustomsValue"),
                portCode: p("#carImportPort"),
                destinationCity: p("#carImportDestinationCity"),
                delayDays: d("#carImportDelayDays"),
                storageDays: d("#carImportStorageDays"),
                clearingMode: p("#carImportClearingMode"),
                downPaymentPct: d("#carImportDownPayment") / 100 || .25,
                financeAprPct: d("#carImportApr") / 100 || .24,
                financeMonths: d("#carImportFinanceMonths") || 36,
                localDealerPriceUsd: d("#carImportLocalDealerPrice"),
                extraAgencyChargesUsd: d("#carImportExtraAgencyCharges")
            ...
            a.lastResult = s, function(t) {
                ...
                r("#carImportBadgeStack").innerHTML = t.badges.map(function(t) {
                    ...
                    r("#carImportWarnings").innerHTML = t.warnings.map(function(t) {
                        return '<div class="car-import-warning ' + o(t.severity) + '"><strong>' + o(t.severity.toUpperCase()) + ":</strong> " + o(t.message) + "</div>";
                    }).join("");
                }(t), function(t) {
                    var a = [ [ "Customs value", t.totals.cifUsd, "USD" ], [ "Official charges", t.totals.officialTaxesUsd + t.totals.officialFeesUsd, "USD" ], [ "Practical extras", t.totals.practicalCostsUsd + t.totals.inlandDeliveryUsd, "USD" ], [ "Registration", t.totals.registrationUsd, "USD" ], [ "Monthly finance", t.finance.monthlyPaymentUsd, "USD" ], [ "Resale band", t.resale.suggestedLowUsd, "USD" ] ];
                    r("#carImportMetrics").innerHTML = a.map(function(a) {
                        var r = "Resale band" === a[0] ? " - " + n(t.resale.suggestedHighUsd, "USD") : "";
                        return '<div class="car-import-metric"><span>' + o(a[0]) + "</span><strong>" + n(a[1], a[2]) + r + "</strong></div>";
                    }).join("");
                }(t), function(t) {
                    var a = t.country.currency;
                    r("#carImportBasisTable").innerHTML = y(t.breakdowns.customsValueBasis.map(function(a) {
                    ...
                    r("#carImportRegistrationTable").innerHTML = y(t.breakdowns.registration, a), r("#carImportSensitivityTable").innerHTML = t.sensitivity.exchangeRate.map(function(t) {
                        ...
                        return "<tr><td>" + t.days + " delay days</td><td>" + n(t.extraUsd, "USD") + '</td><td colspan="2">' + n(t.onRoadUsd, "USD") + "</td></tr>";
                    }).join("");
                }(t), function(t) {
                    var a = [ [ "Vehicle + freight + insurance", t.totals.cifUsd ], [ "Official taxes", t.totals.officialTaxesUsd ], [ "Official fees", t.totals.officialFeesUsd ], [ "Practical port costs", t.totals.practicalCostsUsd ], [ "Inland delivery", t.totals.inlandDeliveryUsd ], [ "Registration", t.totals.registrationUsd ] ], e = Math.max.apply(null, a.map(function(t) {
                        return t[1];
                    })) || 1;
                    r("#carImportWaterfall").innerHTML = a.map(function(t) {
                        var a = Math.max(4, Math.round(t[1] / e * 100));
                        return '<div class="car-import-bar"><span>' + o(t[0]) + '</span><span class="car-import-bar-track"><span class="car-import-bar-fill" style="--bar-width:' + a + '%"></span></span><strong>' + n(t[1], "USD") + "</strong></div>";
                    }).join("");
                }(t), function(t) {
                    r("#carImportScenarioTable").innerHTML = t.scenarios.map(function(t) {
                        return "<tr><td>" + o(t.label) + "<br><small>" + o(t.assumption) + '</small></td><td colspan="3">' + n(t.totalUsd, "USD") + "</td></tr>";
                    }).join(""), r("#carImportFinanceBlock").innerHTML = "Finance estimate: " + n(t.finance.monthlyPaymentUsd, "USD") + " per month for " + t.finance.months + " months after " + n(t.finance.downPaymentUsd, "USD") + " down. Suggested resale band: " + n(t.resale.suggestedLowUsd, "USD") + " to " + n(t.resale.suggestedHighUsd, "USD") + ". Local comparator: " + t.localComparator.cheaperOption + " by " + n(Math.abs(t.localComparator.importSavingsUsd), "USD") + ".";
                }(t), function(t) {
                    r("#carImportCompareTable").innerHTML = (t.sourceMarketCompare || []).map(function(t) {
                        return "<tr><td>" + o(t.label) + "</td><td>" + n(t.freightUsd, "USD") + "</td><td>" + n(t.totalLandedUsd, "USD") + "</td><td>" + n(t.onRoadUsd, "USD") + "</td></tr>";
                    }).join("");
                }(t), function(t) {
                    r("#carImportDocuments").innerHTML = t.documents.map(function(t) {
                        return "<li>" + o(t) + "</li>";
                    }).join("");
                }(t), function(t) {
                    r("#carImportResultSources").innerHTML = t.sourceMetadata.map(function(t) {
                        return '<li><a href="' + o(t.url) + '" target="_blank" rel="nofollow noopener">' + o(t.name) + "</a><span>" + o(t.lastVerified) + " - " + o(t.confidence) + "</span></li>";
                    }).join(""), r("#carImportResultDisclaimer").innerHTML = t.disclaimers.map(function(t) {
                        return "<li>" + o(t) + "</li>";
                    }).join("");
                }(t);
            }(s), function(t) {
                try {
                    localStorage.setItem("carImportCostLastInput", JSON.stringify(t));
                } catch (t) {
                    return;
                }
            }(e), function(t) {
                ...
                var a = r("#carImportCloudSave");
                a && "function" == typeof a.setData && a.setData({
                    inputs: t.input,
                    outputs: {
                        totals: t.totals,
                        rulePack: t.rulePack,
            ...
            }(s), i("car_import_quote_calculated", {
                country: e.countryCode,
                source_market: e.sourceMarket,
                vehicle_class: e.vehicleClass,
                output_mode: e.outputMode
            }), s.warnings.some(function(t) {
                return "stale-rule-pack" === t.code;
            }) && i("car_import_rule_pack_stale_warning_shown", {
                country: e.countryCode
            });
        }
    }
    function f(t) {
        var e = {
            "#carImportCountry": t.countryCode,
            "#carImportSourceMarket": t.sourceMarket,
            "#carImportInputMode": t.inputMode,
            "#carImportOutputMode": t.outputMode,
            "#carImportMake": t.make,
            "#carImportModel": t.model,
            "#carImportTrim": t.trim,
            "#carImportYear": t.year,
            "#carImportFirstRegistrationMonth": t.firstRegistrationMonth,
            "#carImportFuelType": t.fuelType,
            "#carImportEngineCc": t.engineCc,
            "#carImportTransmission": t.transmission,
            "#carImportBodyType": t.bodyType || t.vehicleClass,
            "#carImportDriveSide": t.driveSide,
            "#carImportCondition": t.condition,
            "#carImportMileage": t.mileage,
            "#carImportPurchasePrice": t.purchasePriceUsd,
            "#carImportFob": t.fobUsd,
            "#carImportCif": t.cifUsd,
            "#carImportFreight": t.freightUsd,
            "#carImportInsurance": t.insuranceUsd,
            "#carImportCustomsValue": t.customsValueUsd,
            "#carImportDelayDays": t.delayDays,
            "#carImportStorageDays": t.storageDays,
            "#carImportClearingMode": t.clearingMode,
            "#carImportDownPayment": t.downPaymentPct ? 100 * t.downPaymentPct : "",
            "#carImportApr": t.financeAprPct ? 100 * t.financeAprPct : "",
            "#carImportFinanceMonths": t.financeMonths,
            "#carImportLocalDealerPrice": t.localDealerPriceUsd,
            "#carImportExtraAgencyCharges": t.extraAgencyChargesUsd
        };
    ...
    function y(t, r) {
        return t && t.length ? t.map(function(t) {
            var e = null != t.rate ? Math.round(1e4 * t.rate) / 100 + "%" : "", c = t.tierLabel || t.notes || "";
            return "<tr><td>" + o(t.label) + (c ? "<br><small>" + o(c) + "</small>" : "") + "</td><td>" + o(e) + "</td><td>" + n(t.amountUsd, "USD") + "</td><td>" + n(t.amountLocal || t.amountUsd * a.lastResult.fx.usdToLocal, r) + "</td></tr>";
        }).join("") : '<tr><td colspan="4">No charges in this block for the active inputs.</td></tr>';
    }
    function h(t) {
        e(".car-import-tab").forEach(function(a) {
            a.setAttribute("aria-selected", a === t ? "true" : "false");
        }), e(".car-import-tab-panel").forEach(function(a) {
            a.classList.toggle("active", a.id === t.getAttribute("aria-controls"));
        });
    }
    function I() {
        a.lastResult || m();
        var t = a.lastResult, r = [ [ "section", "label", "amount_usd" ] ];
        if ([ "officialTaxes", "officialFees", "practicalCosts", "inlandDelivery", "registration" ].forEach(function(a) {
            t.breakdowns[a].forEach(function(t) {
                r.push([ a, t.label, t.amountUsd ]);
            });
        }), r.push([ "total", "on-road", t.totals.onRoadUsd ]), window.AfroExport && window.AfroExport.csv) {
            var e = r.slice(1).map(function(t) {
                return {
                    section: t[0],
                    label: t[1],
                    amount_usd: t[2]
            ...
            window.AfroExport.csv(e, "afrotools-car-import-cost.csv");
        } else {
    ...
    function g() {
        a.lastResult || m();
        var t = a.lastResult;
        i("car_import_export_pdf", {
            country: t.country.code
        }), window.AfroTools && window.AfroTools.pdf && window.AfroTools.pdf.generate ? window.AfroTools.pdf.generate({
            title: "African Car Landed Cost Report",
            subtitle: t.country.name + " - " + t.input.make + " " + t.input.model + " " + t.input.year,
            heroStats: [ {
                label: "On-road estimate",
                value: n(t.totals.onRoadUsd, "USD")
            }, {
                label: "Local currency",
                value: n(t.totals.onRoadLocal, t.country.currency)
            }, {
                label: "Rule pack",
                value: t.rulePack.effectiveFrom
            } ],
            sections: [ {
                heading: "Vehicle and customs basis",
                rows: t.breakdowns.customsValueBasis.map(function(t) {
                    return [ t.label, n(t.amountUsd, "USD") ];
                })
            }, {
                heading: "Official charges",
                rows: t.breakdowns.officialTaxes.concat(t.breakdowns.officialFees).map(function(t) {
                    return [ t.label, n(t.amountUsd, "USD") ];
                })
            }, {
                heading: "Practical and registration costs",
                rows: t.breakdowns.practicalCosts.concat(t.breakdowns.inlandDelivery, t.breakdowns.registration).map(function(t) {
                    return [ t.label, n(t.amountUsd, "USD") ];
                })
            } ],
            disclaimer: t.disclaimers.join(" "),
            source: t.sourceMetadata.map(function(t) {
                return t.name + " (" + t.lastVerified + ")";
            }).join("; ")
        }) : window.print();
    }
    function v() {
        a.lastResult || m();
        var t = "On-road estimate: " + n(a.lastResult.totals.onRoadUsd, "USD") + " for " + a.lastResult.country.name + ".";
    ...
    function b() {
        ...
        var t = [];
        try {
            t = JSON.parse(localStorage.getItem("carImportCostQuotes") || "[]");
        } catch (a) {
            t = [];
        }
        t.unshift({
        ...
        var e = r("#carImportSaveLocal");
        e && (e.textContent = "Saved locally");
    }
    function C() {
        a.lastResult || m();
        var t = r("#carImportAiQuestion"), e = r("#carImportAiLog"), o = t && t.value.trim();
        if (o) {
            i("car_import_ai_advisor_opened", {
                country: a.lastResult.country.code
            }), k("user", o), t.value = "";
            var n = a.aiMessages.concat([ {
                role: "user",
                content: o
            } ]);
            fetch("/.netlify/functions/ai-advisor", {
                ...
                body: JSON.stringify({
                    ...
                    context: JSON.stringify({
                        country: a.lastResult.country,
                        input: a.lastResult.input,
                        totals: a.lastResult.totals,
                        warnings: a.lastResult.warnings,
                        rulePack: a.lastResult.rulePack,
                        sourceMetadata: a.lastResult.sourceMetadata,
                        documents: a.lastResult.documents
                    }),
                    messages: n
                })
            }).then(function(t) {
                if (!t.ok) throw new Error("AI unavailable");
                return t.json();
            }).then(function(t) {
                k("assistant", t.answer || t.message || "I could not find a reliable answer from the structured calculation context.");
            }).catch(function() {
                k("assistant", "Based on the calculation context, keep a buffer for FX movement, storage, clearing agent differences, and final customs valuation. I cannot provide an official ruling; verify the rule pack sources and a licensed local agent before paying.");
            }).finally(function() {
    ...
    function S(t, a, r, e) {
        return '<label class="car-import-field ' + o(e || "") + '" for="' + r + '"><span>' + o(t) + "</span><" + a + ' id="' + r + '" name="' + r + '"></' + a + "></label>";
    }
    function T(t, a, r) {
        return '<label class="car-import-field" for="' + a + '"><span>' + o(t) + '</span><input id="' + a + '" name="' + a + '" type="text" placeholder="' + o(r || "") + '"></label>';
    }
    function U(t, a, r) {
        return '<label class="car-import-field" for="' + a + '"><span>' + o(t) + '</span><input id="' + a + '" name="' + a + '" type="number" inputmode="decimal" placeholder="' + o(r || "") + '"></label>';
    }
    function M(t, a, r) {
        return U(t, a, r);
    }
    function w(t, a, r) {
        return '<label class="car-import-field" for="' + a + '"><span>' + o(t) + '</span><select id="' + a + '" name="' + a + '">' + r.map(function(t) {
            return '<option value="' + o(t[0]) + '">' + o(t[1]) + "</option>";
        }).join("") + "</select></label>";
    }
    function D(t, a, r) {
        return '<button class="car-import-tab" type="button" role="tab" aria-selected="' + (r ? "true" : "false") + '" aria-controls="' + a + '">' + o(t) + "</button>";
    }
    function L(t, a, r) {
        return '<div id="' + t + '" class="car-import-tab-panel ' + (a ? "active" : "") + '" role="tabpanel">' + r + "</div>";
    }
    function P(t, a) {
        return '<table class="car-import-table"><thead><tr>' + (a = a || [ "Item", "Rate", "USD", "Local" ]).map(function(t) {
            return "<th>" + o(t) + "</th>";
        }).join("") + '</tr></thead><tbody id="' + t + '"></tbody></table>';
    }
    document.addEventListener("DOMContentLoaded", function() {
        ...
        r("#carImportForm") && s("/data/trade/car-import-cost-core.json").then(function(a) {
            ...
            }), e = s(a.fx && a.fx.fallbackUrl || "/data/forex/latest.json").catch(function() {
                return {
                    rates: {}
                };
            });
            return Promise.all(r.concat([ e ])).then(function(r) {
                var e = r.pop(), o = r, n = function() {
                    try {
                ...
                return n && n.countryRulePacks && (o = o.map(function(t) {
                    return n.countryRulePacks[t.countryCode] || t;
                })), t.mergeData(a, o, e && e.rates || {});
            });
        }).then(function(t) {
            var o, n, s, d;
            a.data = t, function() {
                var t = r("#carImportCountry");
                t && !t.options.length && [ [ "NG", "NG - Nigeria (NGN)" ], [ "KE", "KE - Kenya (KES)" ], [ "GH", "GH - Ghana (GHS)" ], [ "UG", "UG - Uganda (UGX)" ], [ "ZM", "ZM - Zambia (ZMW)" ], [ "TZ", "TZ - Tanzania (TZS)" ] ].forEach(function(a) {
                    t.appendChild(l(a[0], a[1], a[0] === c()));
                });
                var e = r("#carImportSourceMarket");
                e && a.data && !e.options.length && Object.keys(a.data.sourceMarkets || {}).forEach(function(t) {
                    e.appendChild(l(t, a.data.sourceMarkets[t].label, "japan" === t));
                });
            }(), r("#carImportCountry").value = c(), u(), f((o = c(), s = (n = {
                NG: {
                    make: "Toyota",
                    model: "Corolla",
                    year: 2018,
                ...
                i("car_import_source_market_selected", {
                    source_market: r("#carImportSourceMarket").value
                });
            }), e(".car-import-tab").forEach(function(t) {
            ...
            }), e("[data-partner-zone]").forEach(function(t) {
                t.addEventListener("click", function() {
                    i("car_import_outbound_partner_click", {
                        zone: t.getAttribute("data-partner-zone")
                    });
                });
            });
        }).catch(function(t) {
