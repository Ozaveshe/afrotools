...
(function initToolManifest(root, factory) {
  ...
  var MAJOR_TOOL_OVERRIDES = {
    ...
    "cover-letter": major("career-documents", ["write cover letter", "job application letter"], ["Write a cover letter for an NGO program officer role"], [], [INPUTS.targetRole], "browser_local", ["route_only", "prefill", "generate_document", "export"], ["report", "pdf", "json"], "user_input", "employment", ["pro_export"]),
    ...
    "fuel-tracker": major("fuel-prices", ["fuel price", "petrol price", "diesel price"], ["Show current petrol price context for Kenya"], [], [INPUTS.country], "browser_local", ["route_only", "explain", "compare"], ["table", "report"], "mixed", "energy", ["api", "widget"]),
    ...
    "pdf-workspace": major("pdf-tools", ["merge pdf", "split pdf", "compress pdf"], ["Merge these PDFs without uploading them"], [], [INPUTS.documentFile], "browser_local", ["route_only", "export"], ["pdf", "json"], "user_input", "none", ["pro_export"]),
    ...
    "afroplan-floor-planner": major("floor-planning", ["floor plan", "room layout", "house plan"], ["Draft a two-bedroom layout for a narrow plot"], [], [INPUTS.roomSize], "ai_optional", ["route_only", "prefill", "explain", "export"], ["image", "json", "report"], "user_input", "none", ["pro_export", "lead_opt_in"]),
