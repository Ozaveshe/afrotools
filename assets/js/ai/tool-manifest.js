...
(function initToolManifest(root, factory) {
  ...
  var MAJOR_TOOL_OVERRIDES = {
    ...
    "ao-paye": major("salary-tax", ["angola paye", "angola salary tax", "irt inss", "net pay in angola"], ["Calculate monthly salary tax for AOA 1000000 in Angola"], [INPUTS.country, INPUTS.grossPay, INPUTS.payPeriod], [], "browser_local", ["route_only", "prefill", "explain", "export"], ["number", "table", "pdf"], "mixed", "tax", ["pro_export"]),
