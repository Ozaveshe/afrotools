...
(function initAfroToolsAII18n(root, factory) {
  ...
  var TRANSLATIONS = {
    en: {
      ...
      page: {
        title: "AfroTools AI finds the right tool and sets it up.",
        copy: "Tell it the job. It chooses a real AfroTools page, asks only for useful missing details, and helps you leave with a calculator, checklist, brief, or export.",
        inputLabel: "What do you need help with?",
        inputPlaceholder: "Example: How much duty to import a Toyota Axio into Nigeria?",
        submit: "Find my tool",
        trust: "You can use this without signing in. Local routing works without model consent, raw questions are not stored in analytics, and any feature that sends private details to AI must ask first.",
        browseCommon: "Browse common tasks",
        quickTasksTitle: "Try one thing you need today",
      },
      states: {
        emptyTitle: "Start by typing what you want to do.",
        emptyBody: "Try import duty, CVs, scholarships, solar, PAYE, invoices, PDFs, fuel, rent, or floor planning.",
      ...
      result: {
        inputsDetected: "Details found",
        missingInputs: "Details still needed",
        privacyConfidence: "Before you use it",
        ...
        browse: "Browse",
        noInputs: "No details found yet.",
        noMissing: "No extra details needed.",
        addDetailsTitle: "Add details before you open it",
        addDetailsBody: "AfroTools found a tool. Add up to three useful details now, or skip and fill them in later.",
        updatePrefill: "Use these details",
        skipOpen: "Skip and open this tool",
        browseInstead: "Search instead",
        keptLocal: "kept in this browser session",
        choose: "Choose",
        bestMatch: "Best place to start",
        suggestedWorkflow: "Suggested tool",
        matchType: "Matched by",
        prefillStatus: "Details",
        privacyMode: "Privacy",
        notIt: "Not it? Search instead",
      },
      workflowGuide: {
