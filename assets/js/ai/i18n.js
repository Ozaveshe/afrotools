  ...
  var TRANSLATIONS = {
    en: {
      homeHero: {
        ...
        trust: "AfroTools helps you find practical tools. Some tools run in your browser. AI-assisted flows ask before sending private content.",
      },
      page: {
        title: "Ask AfroTools AI",
        copy: "Tell us what you need done. AfroTools will point you to the right calculator, CV builder, document tool, import estimate, solar planner, scholarship finder, or business helper.",
        inputLabel: "What do you need help with?",
        inputPlaceholder: "Example: How much duty to import a Toyota Axio into Nigeria?",
        submit: "Find my tool",
        trust: "You can use this without signing in. We use your words to find the right AfroTools page, and we do not store raw questions in analytics. If a feature wants to send private details to AI, it must ask you first.",
    ...
    fr: {
      ...
      page: {
        ...
        copy: "Dites ce que vous voulez faire. AfroTools vous aide à trouver le bon calculateur, outil document, estimation, planificateur solaire, bourse ou aide business.",
    ...
    sw: {
      ...
      page: {
        ...
        copy: "Eleza unachotaka kufanya. AfroTools itakusaidia kupata kikokotoo, zana ya nyaraka, makadirio, mpangaji wa sola, ufadhili au msaada wa biashara unaofaa.",
