!(function () {
  ...
  function i() {
    const e = location.pathname.split("/").filter(Boolean)[2];
    return e ? `/cars/${e}/` : "/cars/compare/";
  }
  function c(e, t) {
    const o = document.getElementById(e);
    o && null != t && "" !== t && (o.value = t);
  }
  function s(e) {
    r(".car-import-quick-card").forEach(function (t) {
  ...
  function u(t) {
    ...
    o &&
      r &&
      ((r.value = o.countryCode),
      r.dispatchEvent(new Event("change", { bubbles: !0 })),
      window.setTimeout(function () {
        (c("carImportSourceMarket", o.sourceMarket),
          c("carImportInputMode", "make-model-year"),
          c("carImportOutputMode", "practical"),
          c("carImportMake", o.make),
          c("carImportModel", o.model),
          c("carImportYear", o.year),
          c("carImportFirstRegistrationMonth", "1"),
          c("carImportFuelType", o.fuelType),
          c("carImportEngineCc", o.engineCc),
          c("carImportBodyType", o.bodyType),
          c("carImportDriveSide", o.driveSide),
          c("carImportTransmission", "automatic"),
          c("carImportCondition", "used"),
          c("carImportMileage", "65000"),
          c("carImportDownPayment", "25"),
          c("carImportApr", "24"),
          c("carImportFinanceMonths", "36"),
          c("carImportDestinationCity", o.destinationCity),
          s(t),
          (function () {
            const e = a("#carImportForm");
            e &&
  ...
  function l() {
    const e = a("#carImportResults"),
      t = a(".car-import-result-head", e);
    if (!e || e.hidden || !t) return;
    let o = a("#carImportGuideNote");
    o ||
      ((o = document.createElement("div")),
      (o.id = "carImportGuideNote"),
      (o.className = "car-import-guide-note"),
      t.insertAdjacentElement("afterend", o));
    const r = a("#carImportCountry option:checked")
        ? a("#carImportCountry option:checked").textContent
        : "selected market",
  ...
  function p(i) {
    if (!i || "true" === i.dataset.enhanced) return;
    ((i.dataset.enhanced = "true"),
      i.classList.add("car-import-panel-enhanced"));
    const c = a("h2", i),
    ...
    (c &&
      ...
      l &&
        ...
        l.insertAdjacentHTML(
          "afterend",
          [
            `<div class="car-import-proof-grid">${t
              .map(function (e) {
                return [
            ...
            "</div>",
            `<div class="car-import-quick-grid">${Object.values(e)
              .map(function (e) {
                return [
                  `<button type="button" class="car-import-quick-card" data-quick-start="${n(e.countryCode)}">`,
                  `<span class="car-import-quick-eyebrow">${n(e.countryLabel)} · ${n(e.routeLabel)}</span>`,
                  `<strong>${n(e.vehicleLabel)}</strong>`,
            ...
            "</div>",
            `<div class="car-import-chip-row">${o
              .map(function (e) {
                return `<span class="car-import-chip">${n(e)}</span>`;
              })
              .join("")}</div>`,
            "</section>",
          ].join(""),
  ...
  function d() {
    const e = window.setInterval(function () {
      if (
        (function () {
          !(function () {
            const e = a(".car-import-hero-grid > div");
            if (e) {
              if (!a(".car-import-hero-actions", e)) {
                const t = document.createElement("div");
                ((t.className = "car-import-hero-actions"),
                  (t.innerHTML = [
                    '<a href="#carImportApp" class="car-import-hero-button">Start your quote</a>',
                    `<a href="${n(i())}" class="car-import-hero-button secondary">${n(location.pathname.split("/").filter(Boolean)[2] ? "Browse import vs local prices" : "Compare source markets")}</a>`,
                  ].join("")),
                  e.appendChild(t));
              }
              if (!a(".car-import-hero-points", e)) {
                const t = document.createElement("div");
                ((t.className = "car-import-hero-points"),
                  (t.innerHTML = [
