    ...
    injectUpsell() {
      ...
      banner.innerHTML = `
        <div style="max-width:800px;margin:0 auto;padding:32px 24px;text-align:center;">
          ...
          <a href="/pricing/" style="display:inline-block;background:#0071E3;color:#fff;padding:10px 24px;border-radius:8px;font-weight:700;font-size:.85rem;text-decoration:none;">See Plans & Pricing</a>
        </div>
      `;
